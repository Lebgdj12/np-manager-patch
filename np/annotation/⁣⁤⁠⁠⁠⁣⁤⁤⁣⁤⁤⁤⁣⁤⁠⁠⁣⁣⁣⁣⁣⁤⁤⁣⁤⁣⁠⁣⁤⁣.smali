...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0}, Landroid/s/ۦۨۤۤ;->ۥ۟۟ۡ()I
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Landroid/webkit/JsPromptResult;
    ...
    check-cast p0, Landroid/s/ea1$ۥ۟$ۥ۟۟ۢ;

    iget-object v1, p0, Landroid/s/ea1$ۥ۟$ۥ۟۟ۢ;->ۥۡ۟ۥ:Landroid/webkit/JsPromptResult;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;)Ljava/util/Map;
    ...
    check-cast p0, Landroid/s/x$ۥ;

    iget-object v1, p0, Landroid/s/x$ۥ;->ۥ:Ljava/util/Map;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)Landroid/widget/CheckBox;
    ...
    invoke-static {p0}, Landroid/s/e41;->ۥ۟۠(Landroid/s/e41;)Landroid/widget/CheckBox;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/s/t2;
    ...
    invoke-virtual {p0}, Landroid/s/ۦۨۦۢ;->ۥ۟۟۟()Landroid/s/t2;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {p0}, Landroid/s/ۦۨۢ۠;->ۥ۟۟ۤ()Ljava/util/List;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)Ljava/lang/ClassLoader;
    ...
    iget-object v1, p0, Landroid/s/b1;->ۥ:Ljava/lang/ClassLoader;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁤⁤⁠⁤⁤(Ljava/lang/Object;)Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/s/ia1$ۥ۟۟۟;->ۥ:Ljava/util/List;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroid/s/f0;->ۥ۟۟ۡ(Ljava/lang/String;)Z
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)Ljava/io/File;
    ...
    iget-object v1, p0, Landroid/s/r61;->ۥ۟:Ljava/io/File;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Landroid/s/d51;
    .registers 3
    ...
    iget-object v1, p0, Lplayer/normal/np/activity/NPUserInfoActivity$ۥ۟۟;->ۥۡ۟ۦ:Landroid/s/d51;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroid/s/i3;->ۥ۟۟۠(Ljava/util/List;)Z
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁠()Ljava/util/List;
    ...
    sget-object v0, Lplayer/normal/np/activity/AppListActivity;->userApps:Ljava/util/List;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁤⁠⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, Landroid/s/m31;->ۥ۟۠ۤ(Landroid/s/m31;Ljava/lang/String;)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁣⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;I)I
    ...
    check-cast p0, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ;

    invoke-virtual {p0, p1}, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ;->ۥ۟۠ۡ(I)I
