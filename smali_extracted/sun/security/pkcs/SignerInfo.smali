...
.method public constructor <init>(Lsun/security/util/DerInputStream;Z)V
    ...
    invoke-direct {v2, v5, v4}, Lsun/security/util/DerValue;-><init>(B[B)V

    invoke-direct {v1, v2}, Lsun/security/x509/X500Name;-><init>(Lsun/security/util/DerValue;)V

    iput-object v1, p0, Lsun/security/pkcs/SignerInfo;->issuerName:Lsun/security/x509/X500Name;
    ...
    invoke-direct {p2, p1, v1}, Lsun/security/pkcs/PKCS9Attributes;-><init>(Lsun/security/util/DerInputStream;Z)V
...
.method public verify(Lsun/security/pkcs/PKCS7;[B)Lsun/security/pkcs/SignerInfo;
    ...
    move-result v2
    :try_end_18
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_18} :catch_110
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_18} :catch_f4
    ...
    array-length v4, v0
    :try_end_54
    .catch Ljava/io/IOException; {:try_start_1c .. :try_end_54} :catch_110
    .catch Ljava/security/InvalidKeyException; {:try_start_1c .. :try_end_54} :catch_f4
    ...
    move-result v2
    :try_end_75
    .catch Ljava/io/IOException; {:try_start_61 .. :try_end_75} :catch_110
    .catch Ljava/security/InvalidKeyException; {:try_start_61 .. :try_end_75} :catch_f4
    ...
    move-result-object v1
    :try_end_a2
    .catch Ljava/io/IOException; {:try_start_79 .. :try_end_a2} :catch_110
    .catch Ljava/security/InvalidKeyException; {:try_start_79 .. :try_end_a2} :catch_f4
    ...
    :try_end_a9
    .catch Ljava/io/IOException; {:try_start_a4 .. :try_end_a9} :catch_ce
    .catch Ljava/security/InvalidKeyException; {:try_start_a4 .. :try_end_a9} :catch_f4
    ...
    throw p1
    :try_end_f3
    .catch Ljava/io/IOException; {:try_start_a9 .. :try_end_f3} :catch_110
    .catch Ljava/security/InvalidKeyException; {:try_start_a9 .. :try_end_f3} :catch_f4
