...
.method public constructor <init>(Lsun/security/util/ObjectIdentifier;Ljava/lang/Boolean;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    new-instance p2, Lsun/security/x509/DistributionPoint;

    iget-object p3, p1, Lsun/security/util/DerValue;->data:Lsun/security/util/DerInputStream;

    invoke-virtual {p3}, Lsun/security/util/DerInputStream;->getDerValue()Lsun/security/util/DerValue;

    move-result-object p3

    invoke-direct {p2, p3}, Lsun/security/x509/DistributionPoint;-><init>(Lsun/security/util/DerValue;)V

    iget-object p3, p0, Lsun/security/x509/CRLDistributionPointsExtension;->distributionPoints:Ljava/util/List;
