...
.class public Landroid/s/ۦۥۧۤ;
.super Landroid/s/ۦۥۣۧ;
...
# direct methods
.method public static final ۥ۟۟ۡ()Ljava/util/Map;
    .registers 2
...
.method public static final ۥ۟۟ۢ(Ljava/util/Map;)Ljava/util/Map;
    .registers 3
    ...
    .line 2
    :cond_f
    invoke-static {p0}, Landroid/s/ۦۥۣۧ;->ۥ۟۟۠(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final ۥۣ۟۟(Ljava/util/Map;Ljava/lang/Iterable;)V
    .registers 4
    .param p0  # Ljava/util/Map;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final ۥ۟۟ۤ(Ljava/lang/Iterable;)Ljava/util/Map;
    .registers 4
    ...
    invoke-static {v0}, Landroid/s/ۦۥۣۧ;->ۥ۟۟(I)I

    move-result v0

    invoke-direct {v1, v0}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {p0, v1}, Landroid/s/ۦۥۧۤ;->ۥ۟۟ۥ(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Landroid/s/ۦۥۣۧ;->ۥ۟۟۟(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Landroid/s/ۦۥۧۤ;->ۥ۟۟ۥ(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Landroid/s/ۦۥۧۤ;->ۥ۟۟ۢ(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final ۥ۟۟ۥ(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    .registers 3
    .param p0  # Ljava/lang/Iterable;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    invoke-static {p1, p0}, Landroid/s/ۦۥۧۤ;->ۥۣ۟۟(Ljava/util/Map;Ljava/lang/Iterable;)V
