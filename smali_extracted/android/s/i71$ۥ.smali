...
# instance fields
.field public final ۥۡ۟ۥ:Landroid/s/i71;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/i71$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/i71;)V
    .registers 6

    iput-object p1, p0, Landroid/s/i71$ۥ;->ۥۡ۟ۥ:Landroid/s/i71;
    ...
    :sswitch_12
    const-string v0, "B3lJfOqHvmDFVpI63Zd6lm"

    invoke-static {v0}, Lorg/apache/xerces/impl/validation/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁤⁣⁠⁠⁤⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁠⁠⁠()[S
    ...
    :sswitch_5a
    sget-object v4, Landroid/s/i71$ۥ;->short:[S
...
.method public run()V
    ...
    const-string v31, "ۣۢۡ"

    const-string v32, "۟ۢۨ"
    ...
    move-result v15
    :try_end_45
    .catch Ljava/lang/Exception; {:try_start_3d .. :try_end_45} :catch_58
    .catchall {:try_start_3d .. :try_end_45} :catchall_34b
    ...
    invoke-static/range {v20 .. v20}, Lorg/checkerframework/checker/guieffect/qual/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁣⁠⁠⁠(Ljava/lang/Object;)I
    ...
    move-result v13
    :try_end_8a
    .catch Ljava/lang/Exception; {:try_start_82 .. :try_end_8a} :catch_356
    .catchall {:try_start_82 .. :try_end_8a} :catchall_34b
    ...
    :try_start_a4
    invoke-static {}, Landroid/s/i71$ۥ;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁠⁠⁠()[S

    move-result-object v8
    :try_end_a8
    .catch Ljava/lang/Exception; {:try_start_a4 .. :try_end_a8} :catch_356
    .catchall {:try_start_a4 .. :try_end_a8} :catchall_34b
    ...
    invoke-static {v9, v10, v0}, Lplayer/normal/np/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠;->⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_c3
    .catch Ljava/lang/Exception; {:try_start_bc .. :try_end_c3} :catch_356
    .catchall {:try_start_bc .. :try_end_c3} :catchall_34b
    ...
    const-string v0, "mBol0hNKu3zEXufffstpvIXyA"
    ...
    invoke-static/range {v30 .. v30}, Lorg/benf/cfr/reader/entities/constantpool/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁣⁣⁣⁣⁤⁤;->⁣⁤⁣⁠⁣⁤⁠⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;)I
    ...
    invoke-static/range {v27 .. v27}, Lorg/eclipse/jdt/internal/compiler/parser/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤;->⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)I
    ...
    move-result v16
    :try_end_111
    .catch Ljava/lang/Exception; {:try_start_109 .. :try_end_111} :catch_356
    .catchall {:try_start_109 .. :try_end_111} :catchall_34b
    ...
    move-result-object v0
    :try_end_15a
    .catch Ljava/lang/Exception; {:try_start_14f .. :try_end_15a} :catch_356
    .catchall {:try_start_14f .. :try_end_15a} :catchall_34b
    ...
    :goto_179
    invoke-static/range {v19 .. v19}, Lorg/apache/commons/lang3/arch/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁣⁣⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)I
    ...
    :try_start_19b
    invoke-static {v8, v3, v0, v11}, LXI/xo/XI/XI/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠;->⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁤⁤⁠⁤⁠([SIII)Ljava/lang/String;
    ...
    :try_end_1a8
    .catch Ljava/lang/Exception; {:try_start_19b .. :try_end_1a8} :catch_356
    .catchall {:try_start_19b .. :try_end_1a8} :catchall_34b
    ...
    :goto_1bb
    invoke-static/range {v32 .. v32}, Lsjm/xuitls/cache/⁣⁤⁣⁠⁣⁤⁠⁣⁤⁠⁠⁣;->⁣⁠⁠⁤⁠⁣⁤⁠⁤⁣(Ljava/lang/Object;)I
    ...
    :try_start_21e
    invoke-static/range {p0 .. p0}, Lorg/apache/xerces/xs/datatypes/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁣⁤⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁠⁤⁤⁠⁤⁠(Ljava/lang/Object;)Landroid/s/i71;

    move-result-object v0

    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣;->⁠⁠⁣⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Ljava/io/File;
    ...
    move-result-object v0
    :try_end_22a
    .catch Ljava/lang/Exception; {:try_start_21e .. :try_end_22a} :catch_356
    .catchall {:try_start_21e .. :try_end_22a} :catchall_34b
    ...
    move-result v17
    :try_end_24c
    .catch Ljava/lang/Exception; {:try_start_244 .. :try_end_24c} :catch_356
    .catchall {:try_start_244 .. :try_end_24c} :catchall_34b
    ...
    invoke-static {v0}, Lplayer/normal/np/util/apk/fancy/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠⁤⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Landroid/content/Context;
    ...
    :try_end_28c
    .catchall {:try_start_27d .. :try_end_28c} :catchall_34b
    ...
    move-result-object v0
    :try_end_2ab
    .catch Ljava/lang/Exception; {:try_start_29f .. :try_end_2ab} :catch_356
    .catchall {:try_start_29f .. :try_end_2ab} :catchall_34b
    ...
    move-result v14
    :try_end_2f0
    .catch Ljava/lang/Exception; {:try_start_2e8 .. :try_end_2f0} :catch_356
    .catchall {:try_start_2e8 .. :try_end_2f0} :catchall_34b
    ...
    :try_start_330
    invoke-static {v4, v0, v11, v3}, Ljavax/xml/transform/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁤⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣⁣⁣⁣⁣⁤⁤([SIII)Ljava/lang/String;

    move-result-object v0

    invoke-static {v2, v0}, Lorg/eclipse/tm4e/core/registry/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/StringBuilder;
    :try_end_337
    .catch Ljava/lang/Exception; {:try_start_330 .. :try_end_337} :catch_356
    .catchall {:try_start_330 .. :try_end_337} :catchall_34b
    ...
    .sparse-switch
        ...
        0xdc41 -> :sswitch_2e6
        0xdce1 -> :sswitch_2cf
        0x1aa745 -> :sswitch_2b6
        0x1aa746 -> :sswitch_29d
        0x1aa765 -> :sswitch_29c
        0x1aa77c -> :sswitch_27b
        0x1aa7de -> :sswitch_25e
        0x1aa7e0 -> :sswitch_242
        0x1aaee0 -> :sswitch_21c
        0x1aaf01 -> :sswitch_20c
        0x1ab287 -> :sswitch_1fb
        0x1ab2a2 -> :sswitch_1e3
        0x1ab662 -> :sswitch_1d1
        0x1ab6a4 -> :sswitch_1c1
        0x1ab702 -> :sswitch_17f
        0x1ab721 -> :sswitch_169
        0x1aba25 -> :sswitch_14d
        0x1abd85 -> :sswitch_13d
        0x1abda9 -> :sswitch_13d
        0x1abe42 -> :sswitch_20c
        0x1abe5e -> :sswitch_12f
        0x1abe86 -> :sswitch_112
        0x1abea3 -> :sswitch_107
        0x1ac165 -> :sswitch_e9
        0x1ac18b -> :sswitch_cb
        0x1ac1ab -> :sswitch_ba
        0x1ac54b -> :sswitch_a2
