...
.method public constructor <init>(ZLandroid/s/ۦۣ۟ۨ;)V
    ...
    iput-object p2, p0, Landroid/s/ۦۣ۟ۧ;->ۥ۟۟ۥ:Landroid/s/ۦۣ۟ۨ;
    ...
    invoke-virtual {p2, v0, v1, v2}, Landroid/s/ۦۣ۟ۨ;->ۥ۟۟ۢ(Ljava/nio/ByteBuffer;J)J
...
.method public ۥ(JI)Landroid/s/ۦۣ۟ۢ;
    ...
    new-instance v6, Landroid/s/ۦۣ۟ۡ;

    iget-object v1, p0, Landroid/s/ۦۣ۟ۧ;->ۥ۟۟ۥ:Landroid/s/ۦۣ۟ۨ;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/s/ۦۣ۟ۡ;-><init>(Landroid/s/ۦۣ۟ۨ;Landroid/s/ۦۣۣ۟;JI)V
...
.method public ۥ۟(J)Landroid/s/ۦۣ۟ۤ;
    ...
    new-instance v0, Landroid/s/ۦ۟ۤ۟;

    iget-object v1, p0, Landroid/s/ۦۣ۟ۧ;->ۥ۟۟ۥ:Landroid/s/ۦۣ۟ۨ;

    invoke-direct {v0, v1, p0, p1, p2}, Landroid/s/ۦ۟ۤ۟;-><init>(Landroid/s/ۦۣ۟ۨ;Landroid/s/ۦۣۣ۟;J)V
...
.method public ۥ۟۟(I)Landroid/s/ۦۣ۟ۥ;
    ...
    new-instance v0, Landroid/s/ۦ۟ۤۡ;

    iget-object v1, p0, Landroid/s/ۦۣ۟ۧ;->ۥ۟۟ۥ:Landroid/s/ۦۣ۟ۨ;

    invoke-direct {v0, v1, p0, p1}, Landroid/s/ۦ۟ۤۡ;-><init>(Landroid/s/ۦۣ۟ۨ;Landroid/s/ۦۣۣ۟;I)V
