...
.method public static ۥ([Landroid/s/lc1;Z)Ljava/util/List;
    .registers 5
    ...
    :sswitch_21
    new-instance v1, Landroid/s/kc1$ۥ۟;

    invoke-direct {v1, p1}, Landroid/s/kc1$ۥ۟;-><init>(Z)V

    invoke-static {v2, v1}, Lorg/apache/xerces/xpointer/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p0}, Lokhttp3/internal/connection/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁠⁣⁣(Ljava/lang/Object;)Ljava/util/List;
...
.method public static ۥ۟([Landroid/s/lc1;Z)Ljava/util/List;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    :sswitch_1e
    new-instance v1, Landroid/s/kc1$ۥ۟۟;

    invoke-direct {v1, p1}, Landroid/s/kc1$ۥ۟۟;-><init>(Z)V
...
.method public static ۥ۟۟([Landroid/s/lc1;Z)Ljava/util/List;
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    :sswitch_19
    new-instance v1, Landroid/s/kc1$ۥ;

    invoke-direct {v1, p1}, Landroid/s/kc1$ۥ;-><init>(Z)V
...
.method public static ۥ۟۟۟([Landroid/s/lc1;Z)Ljava/util/List;
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    :sswitch_31
    new-instance v1, Landroid/s/kc1$ۥ۟۟۟;

    invoke-direct {v1, p1}, Landroid/s/kc1$ۥ۟۟۟;-><init>(Z)V
