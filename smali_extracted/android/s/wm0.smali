...
.class public Landroid/s/wm0;
.super Landroid/s/xl0;

# interfaces
.implements Landroid/s/tj0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/wm0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public constructor <init>(Lorg/jf/dexlib2/Opcode;IIIIIILorg/jf/dexlib2/iface/reference/Reference;)V
    ...
    iput v0, p0, Landroid/s/wm0;->ۥ۟۟۟:I
    ...
    :goto_12
    iput p3, p0, Landroid/s/wm0;->ۥ۟۟۠:I
    ...
    :goto_1d
    iput p3, p0, Landroid/s/wm0;->ۥ۟۟ۡ:I
    ...
    :goto_28
    iput p3, p0, Landroid/s/wm0;->ۥ۟۟ۢ:I
    ...
    :goto_33
    iput p3, p0, Landroid/s/wm0;->ۥۣ۟۟:I
    ...
    :cond_3c
    iput v0, p0, Landroid/s/wm0;->ۥ۟۟ۤ:I

    .line 8
    iget p1, p1, Lorg/jf/dexlib2/Opcode;->referenceType:I

    invoke-static {p1, p8}, Landroid/s/pn0;->ۥ(ILorg/jf/dexlib2/iface/reference/Reference;)Landroid/s/on0;

    move-result-object p1

    iput-object p1, p0, Landroid/s/wm0;->ۥ۟۟ۥ:Landroid/s/on0;

    return-void
.end method

.method public static ۥ۟ۡۥ(Landroid/s/tj0;)Landroid/s/wm0;
    .registers 11

    .line 1
    instance-of v0, p0, Landroid/s/wm0;

    if-eqz v0, :cond_7

    .line 2
    check-cast p0, Landroid/s/wm0;

    return-object p0

    .line 3
    :cond_7
    new-instance v9, Landroid/s/wm0;
    ...
    invoke-direct/range {v0 .. v8}, Landroid/s/wm0;-><init>(Lorg/jf/dexlib2/Opcode;IIIIIILorg/jf/dexlib2/iface/reference/Reference;)V
...
.method public ۥ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/wm0;->ۥ۟۟۠:I
...
.method public ۥ۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/wm0;->ۥ۟۟۟:I
...
.method public ۥ۟۟۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/wm0;->ۥ۟۟ۤ:I
...
.method public ۥۣ۟۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/wm0;->ۥ۟۟ۡ:I
...
.method public ۥ۟۠۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/wm0;->ۥۣ۟۟:I
...
.method public ۥ۟۠ۡ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/wm0;->ۥ۟۟ۢ:I
...
.method public bridge synthetic ۥ۟۠ۢ()Lorg/jf/dexlib2/iface/reference/Reference;
    ...
    .line 1
    invoke-virtual {p0}, Landroid/s/wm0;->ۥ۟ۡۤ()Landroid/s/on0;
...
.method public ۥ۟ۡۡ()Lorg/jf/dexlib2/Format;
    ...
    .line 1
    sget-object v0, Landroid/s/wm0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public ۥ۟ۡۤ()Landroid/s/on0;
    ...
    .line 1
    iget-object v0, p0, Landroid/s/wm0;->ۥ۟۟ۥ:Landroid/s/on0;
