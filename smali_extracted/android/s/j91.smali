...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/j91;->short:[S
...
.method public static ۥ(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v23, "ۦۧ۟"

    const-string v24, "ۥۤۦ"

    const-string v25, "۠ۧۦ"

    const-string v26, "ۣۤۥ"
    ...
    const-string v33, "ۨۢ۟"

    const-string v34, "ۡۦۡ"

    const-string v35, "ۢ۟۠"

    const/16 v36, 0x1

    const-string v37, "ۨۤۢ"

    sparse-switch v0, :sswitch_data_468
    ...
    :sswitch_7a
    :try_start_7a
    invoke-static {}, Landroid/s/j91;->⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁠⁠⁣⁣⁤()[S

    move-result-object v14
    :try_end_7e
    .catch Ljava/lang/Exception; {:try_start_7a .. :try_end_7e} :catch_153
    ...
    array-length v0, v8
    :try_end_a8
    .catch Ljava/lang/Exception; {:try_start_a7 .. :try_end_a8} :catch_153
    ...
    invoke-static {v0}, Lorg/apache/xerces/xpointer/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤(C)Ljava/lang/String;

    move-result-object v0

    invoke-static {v12, v0}, Lorg/eclipse/tm4e/core/registry/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/StringBuilder;
    :try_end_d6
    .catch Ljava/lang/Exception; {:try_start_cd .. :try_end_d6} :catch_153
    ...
    move-result-object v0
    :try_end_118
    .catch Ljava/lang/Exception; {:try_start_114 .. :try_end_118} :catch_153
    ...
    :sswitch_11c
    invoke-static {}, Lorg/apache/xerces/util/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁠⁤⁤⁠⁤⁤()Landroid/s/ۦۧ۠۟;

    move-result-object v0

    invoke-static {v3, v0}, Lorg/checkerframework/checker/fenum/qual/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁤⁣⁠⁤⁤⁤⁠⁤⁠;->⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static/range {p0 .. p0}, Lorg/checkerframework/checker/builder/qual/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁣⁣;->⁤⁠⁤⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lorg/intellij/lang/annotations/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁣⁤⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)[C
    ...
    :sswitch_17c
    new-instance v0, Landroid/s/ۦۧ۟ۨ;

    invoke-direct {v0}, Landroid/s/ۦۧ۟ۨ;-><init>()V

    invoke-static {}, Lorg/jaxen/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁠⁤⁣⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁤⁠⁠⁣()Landroid/s/ۦۧ۟ۧ;

    move-result-object v3

    invoke-static {v0, v3}, Lorg/apache/batik/css/parser/⁤⁠⁤⁠⁤⁠⁤⁤;->⁤⁠⁤⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {}, Lorg/dom4j/rule/pattern/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁤⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁤⁠⁤⁣()Landroid/s/ۦۧ۠;

    move-result-object v3

    invoke-static {v0, v3}, Lorg/apache/commons/lang3/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁤⁤⁣⁠⁠⁤⁣⁠⁤⁤;->⁣⁠⁠⁤⁠⁣⁤⁠⁤⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :try_end_1e2
    .catch Ljava/lang/Exception; {:try_start_1e0 .. :try_end_1e2} :catch_1f8

    :try_start_1e2
    invoke-static {v2, v0}, Lorg/eclipse/tm4e/core/registry/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/StringBuilder;
    :try_end_1e5
    .catch Ljava/lang/Exception; {:try_start_1e2 .. :try_end_1e5} :catch_22b
    ...
    move-result v19
    :try_end_21a
    .catch Ljava/lang/Exception; {:try_start_212 .. :try_end_21a} :catch_22b
    ...
    :try_start_24f
    invoke-static {v14, v9, v0, v6}, Lorg/objectweb/asm/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠⁣⁣⁣⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁠⁣⁣([SIII)Ljava/lang/String;

    move-result-object v0

    invoke-static {v13, v0}, Lplayer/normal/np/fragMent/⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0
    :try_end_257
    .catch Ljava/lang/Exception; {:try_start_24f .. :try_end_257} :catch_2ae
    ...
    move-result-object v0
    :try_end_27c
    .catch Ljava/lang/Exception; {:try_start_278 .. :try_end_27c} :catch_2ae
    ...
    move-result-object v0
    :try_end_29a
    .catch Ljava/lang/Exception; {:try_start_294 .. :try_end_29a} :catch_2ae
    ...
    move-result v20
    :try_end_2f3
    .catch Ljava/lang/Exception; {:try_start_2eb .. :try_end_2f3} :catch_448
    ...
    :try_end_30f
    .catch Ljava/lang/Exception; {:try_start_30c .. :try_end_30f} :catch_448
    ...
    invoke-static/range {v31 .. v31}, Lorg/benf/cfr/reader/bytecode/analysis/structured/statement/placeholder/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)I
    ...
    :try_end_36a
    .catch Ljava/lang/Exception; {:try_start_365 .. :try_end_36a} :catch_448
    ...
    invoke-static {v0, v3}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/op4rewriters/transformers/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁤⁣⁤⁤⁤⁠⁣⁤⁣⁤⁣;->⁠⁣⁤⁣⁤⁣⁠⁣⁤⁣⁤⁣(CLjava/lang/Object;)[Ljava/lang/String;

    move-result-object v16
    :try_end_394
    .catch Ljava/lang/Exception; {:try_start_38e .. :try_end_394} :catch_448
    ...
    :cond_3ee
    :goto_3ee
    invoke-static/range {v30 .. v30}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁣⁣⁠⁠⁣⁣⁤⁠⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁣(Ljava/lang/Object;)I
    ...
    :goto_3fc
    invoke-static/range {v33 .. v33}, Lorg/apache/xerces/stax/⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)I
    ...
    move-result-object v0
    :try_end_40a
    .catch Ljava/lang/Exception; {:try_start_406 .. :try_end_40a} :catch_448
    ...
    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V
    :try_end_42b
    .catch Ljava/lang/Exception; {:try_start_426 .. :try_end_42b} :catch_448
    ...
    .sparse-switch
        0xdc46 -> :sswitch_421
        0xdc7b -> :sswitch_414
        0x1aa708 -> :sswitch_401
        0x1aa724 -> :sswitch_3f5
        0x1aa760 -> :sswitch_3f4
        0x1aa7fa -> :sswitch_3e1
        0x1aab9e -> :sswitch_3d7
        0x1aabbf -> :sswitch_3c1
        0x1aabe0 -> :sswitch_3ad
        0x1aaefd -> :sswitch_389
        0x1aaf5c -> :sswitch_360
        0x1ab243 -> :sswitch_345
        0x1ab302 -> :sswitch_323
        0x1ab31d -> :sswitch_307
        0x1ab626 -> :sswitch_2e6
        0x1ab648 -> :sswitch_2cb
        0x1ab664 -> :sswitch_2b2
        0x1ab688 -> :sswitch_290
        0x1ab6bf -> :sswitch_274
        0x1aba46 -> :sswitch_230
        0x1aba9e -> :sswitch_210
        0x1abae0 -> :sswitch_1fd
        0x1abdca -> :sswitch_1dd
        0x1abde6 -> :sswitch_1aa
        0x1abe06 -> :sswitch_414
        0x1abe27 -> :sswitch_17c
        0x1ac147 -> :sswitch_168
        0x1ac16a -> :sswitch_158
        0x1ac1c6 -> :sswitch_148
        0x1ac1c8 -> :sswitch_142
        0x1ac23e -> :sswitch_11c
        0x1ac569 -> :sswitch_114
...
.method public static ⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁠⁠⁣⁣⁤()[S
    ...
    :sswitch_a3
    sget-object v3, Landroid/s/j91;->short:[S
