...
.class public Landroid/s/b71$ۥ۟;
...
# instance fields
.field public final ۥۡ۟ۥ:Landroid/s/b71;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/b71$ۥ۟;->short:[S
...
.method public constructor <init>(Landroid/s/b71;)V
    .registers 7

    iput-object p1, p0, Landroid/s/b71$ۥ۟;->ۥۡ۟ۥ:Landroid/s/b71;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁣⁤⁤⁣⁠()[S
    ...
    :sswitch_41
    sget-object v3, Landroid/s/b71$ۥ۟;->short:[S
...
.method public run()V
    ...
    const-string v17, "۟ۧۥ"

    const-string v18, "ۤ۠ۧ"

    const/16 v19, 0x1

    const-string v20, "۠ۧۨ"
    ...
    :try_start_55
    invoke-static {v7, v3, v0, v11}, Lorg/bouncycastle/pqc/jcajce/provider/gmss/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁠⁤⁣⁠⁤⁣⁣⁤⁠⁠⁣([SIII)Ljava/lang/String;
    ...
    :try_end_65
    .catch Ljava/lang/Exception; {:try_start_55 .. :try_end_65} :catch_1fd
    .catchall {:try_start_55 .. :try_end_65} :catchall_1e4
    ...
    move-result v0
    :try_end_7e
    .catch Ljava/lang/Exception; {:try_start_7a .. :try_end_7e} :catch_1fd
    .catchall {:try_start_7a .. :try_end_7e} :catchall_1e4
    ...
    :sswitch_85
    :try_start_85
    invoke-static/range {p0 .. p0}, Lorg/jaxen/function/ext/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Landroid/s/b71;
    ...
    :try_end_94
    .catchall {:try_start_85 .. :try_end_94} :catchall_1e4
    ...
    invoke-static {v0}, Lorg/benf/cfr/reader/bytecode/analysis/structured/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁣⁣⁣⁣⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁣⁤⁠⁠⁣(Ljava/lang/Object;)Ljava/io/File;
    ...
    invoke-static {}, Landroid/s/b71$ۥ۟;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁣⁤⁤⁣⁠()[S

    move-result-object v0
    :try_end_b9
    .catch Ljava/lang/Exception; {:try_start_a6 .. :try_end_b9} :catch_1fd
    .catchall {:try_start_a6 .. :try_end_b9} :catchall_1e4
    ...
    move-result v9
    :try_end_11a
    .catch Ljava/lang/Exception; {:try_start_112 .. :try_end_11a} :catch_1fd
    .catchall {:try_start_112 .. :try_end_11a} :catchall_1e4
    ...
    invoke-static {v14}, Lorg/benf/cfr/reader/bytecode/analysis/parse/literal/⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁣⁤⁠⁠⁣;->⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v0, v4}, Lsun/security/action/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁣⁣⁤⁣⁠⁣⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)Ljava/io/File;
    :try_end_187
    .catch Ljava/lang/Exception; {:try_start_17c .. :try_end_187} :catch_1fd
    .catchall {:try_start_17c .. :try_end_187} :catchall_1e4
    ...
    move-result v10
    :try_end_1a3
    .catch Ljava/lang/Exception; {:try_start_19b .. :try_end_1a3} :catch_1fd
    .catchall {:try_start_19b .. :try_end_1a3} :catchall_1e4
    ...
    :sswitch_1b7
    :try_start_1b7
    invoke-static {v4}, Lorg/checkerframework/checker/propkey/qual/⁠⁤⁣⁠⁤⁣⁠⁣⁤⁣⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Z
    :try_end_1ba
    .catch Ljava/lang/Exception; {:try_start_1b7 .. :try_end_1ba} :catch_1fd
    .catchall {:try_start_1b7 .. :try_end_1ba} :catchall_1e4
    ...
    :try_end_1d3
    .catch Ljava/lang/Exception; {:try_start_1ce .. :try_end_1d3} :catch_1fd
    .catchall {:try_start_1ce .. :try_end_1d3} :catchall_1e4
    ...
    :goto_1de
    invoke-static {v15}, Lorg/apache/xerces/impl/xpath/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁤⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤⁤⁤⁠⁤⁣(Ljava/lang/Object;)I
    ...
    invoke-static {v12}, Lorg/dom4j/tree/⁤⁠⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁤⁣⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    .sparse-switch
        0xdc02 -> :sswitch_231
        0x1aa726 -> :sswitch_215
        0x1aa7c1 -> :sswitch_1ce
        0x1aa7f9 -> :sswitch_1b7
        0x1aa7fc -> :sswitch_19b
        0x1aa7fd -> :sswitch_17c
        0x1aaae8 -> :sswitch_165
        0x1aab3f -> :sswitch_144
        0x1aabc1 -> :sswitch_12d
        0x1aabd8 -> :sswitch_124
        0x1aabdb -> :sswitch_112
        0x1aaea6 -> :sswitch_f7
        0x1aaebf -> :sswitch_db
        0x1aaec4 -> :sswitch_124
        0x1ab287 -> :sswitch_cd
        0x1ab623 -> :sswitch_cc
        0x1ab69f -> :sswitch_c8
        0x1ab6bd -> :sswitch_a6
