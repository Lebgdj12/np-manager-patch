...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Landroid/s/kr;

    invoke-direct {v0}, Landroid/s/kr;-><init>()V

    sput-object v0, Landroid/s/jr;->ۥ:Landroid/s/ir;
...
.method public static ۥ(Ljava/lang/String;)[B
    ...
    :try_start_5
    sget-object v1, Landroid/s/jr;->ۥ:Landroid/s/ir;

    invoke-interface {v1, p0, v0}, Landroid/s/ir;->ۥ۟(Ljava/lang/String;Ljava/io/OutputStream;)I
    :try_end_a
...
.method public static ۥ۟([B)[B
    ...
    invoke-static {p0, v1, v0}, Landroid/s/jr;->ۥ۟۟([BII)[B
...
.method public static ۥ۟۟([BII)[B
    ...
    invoke-interface {v1, p0, p1, p2, v0}, Landroid/s/ir;->ۥ([BIILjava/io/OutputStream;)I
    :try_end_a
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_a} :catch_f
