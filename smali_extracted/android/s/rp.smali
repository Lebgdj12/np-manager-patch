...
# direct methods
.method public constructor <init>(Landroid/s/ci;IILandroid/s/yq;Landroid/s/br;Landroid/s/ar;Landroid/s/xq;[Landroid/s/br;)V
    .registers 9

    invoke-direct {p0}, Landroid/s/bi;-><init>()V

    iput-object p1, p0, Landroid/s/rp;->ۥۡ۟ۥ:Landroid/s/ci;

    iput p2, p0, Landroid/s/rp;->ۥۡ۟ۦ:I

    iput p3, p0, Landroid/s/rp;->ۥۡ۟ۧ:I
...
.method public ۥ۟۟()Landroid/s/gi;
    ...
    iget-object v1, p0, Landroid/s/rp;->ۥۡ۟ۥ:Landroid/s/ci;

    invoke-virtual {v0, v1}, Landroid/s/vh;->ۥ(Landroid/s/uh;)V

    new-instance v1, Landroid/s/zh;

    iget v2, p0, Landroid/s/rp;->ۥۡ۟ۦ:I
    ...
    iget v2, p0, Landroid/s/rp;->ۥۡ۟ۧ:I
    ...
    iget-object v2, p0, Landroid/s/rp;->ۥۡ۟ۨ:[B
    ...
    iget-object v2, p0, Landroid/s/rp;->ۥۡ۠:[B
    ...
    iget-object v2, p0, Landroid/s/rp;->ۥۡ۠۟:[B
    ...
    iget-object v2, p0, Landroid/s/rp;->ۥۡ۠۠:[B
    ...
    :goto_4e
    iget-object v3, p0, Landroid/s/rp;->ۥۡ۠ۡ:[[B
