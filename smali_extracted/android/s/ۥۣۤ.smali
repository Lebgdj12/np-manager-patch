...
.class public final Landroid/s/ۥۣۤ;
...
.method public static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Landroid/s/ۥۣۤ$ۥ;

    invoke-direct {v0}, Landroid/s/ۥۣۤ$ۥ;-><init>()V

    sput-object v0, Landroid/s/ۥۣۤ;->ۥ:Lcom/google/gson/TypeAdapterFactory;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/s/ۥۣۤ;->ۥ۟:Ljava/text/DateFormat;

    return-void
.end method

.method public synthetic constructor <init>(Landroid/s/ۥۣۤ$ۥ;)V
    .registers 2

    .line 1
    invoke-direct {p0}, Landroid/s/ۥۣۤ;-><init>()V
...
.method public bridge synthetic read(Landroid/s/ۥۣۣۤ;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroid/s/ۥۣۤ;->ۥ(Landroid/s/ۥۣۣۤ;)Ljava/sql/Date;
...
.method public bridge synthetic write(Landroid/s/ۥۣۤۤ;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/s/ۥۣۤ;->ۥ۟(Landroid/s/ۥۣۤۤ;Ljava/sql/Date;)V

    return-void
.end method

.method public ۥ(Landroid/s/ۥۣۣۤ;)Ljava/sql/Date;
    .registers 7
    ...
    .line 5
    :try_start_12
    iget-object v1, p0, Landroid/s/ۥۣۤ;->ۥ۟:Ljava/text/DateFormat;
...
.method public ۥ۟(Landroid/s/ۥۣۤۤ;Ljava/sql/Date;)V
    .registers 4
    ...
    .line 3
    :try_start_7
    iget-object v0, p0, Landroid/s/ۥۣۤ;->ۥ۟:Ljava/text/DateFormat;
