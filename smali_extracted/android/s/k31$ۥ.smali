...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/k31;->ۥ(Landroid/app/Activity;Ljava/io/File;Lplayer/normal/np/adapter/FileAdapter;)V
.end annotation
...
.field public final ۥۡ۟ۦ:Lplayer/normal/np/adapter/FileAdapter;

.field public final ۥۡ۟ۧ:Landroid/app/Activity;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/k31$ۥ;->short:[S
...
.method public constructor <init>(Ljava/io/File;Lplayer/normal/np/adapter/FileAdapter;Landroid/app/Activity;)V
    .registers 7

    iput-object p1, p0, Landroid/s/k31$ۥ;->ۥۡ۟ۥ:Ljava/io/File;

    iput-object p2, p0, Landroid/s/k31$ۥ;->ۥۡ۟ۦ:Lplayer/normal/np/adapter/FileAdapter;

    iput-object p3, p0, Landroid/s/k31$ۥ;->ۥۡ۟ۧ:Landroid/app/Activity;
...
.method public static ⁠⁠⁠⁣⁣⁠⁣⁠⁠⁤⁠⁣()[S
    ...
    :sswitch_54
    sget-object v4, Landroid/s/k31$ۥ;->short:[S
...
.method public run()V
    ...
    const-string v18, "ۣ۠ۦ"

    const-string v19, "ۧۡۥ"

    const-string v20, "ۣ۟۟"

    const-string v21, "ۨۦ۠"

    const-string v22, "ۥۥ۠"

    const-string v23, "ۣۤۨ"

    const-string v24, "ۤۡۡ"
    ...
    :sswitch_3a
    :try_start_3a
    invoke-static/range {p0 .. p0}, Lorg/apache/xerces/dom/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠⁤⁠⁤⁤;->⁣⁠⁠⁤⁠⁠⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Lplayer/normal/np/adapter/FileAdapter;
    ...
    :try_end_49
    .catch Ljava/lang/Exception; {:try_start_3a .. :try_end_49} :catch_2a2
    .catchall {:try_start_3a .. :try_end_49} :catchall_29c
    ...
    :sswitch_7a
    :try_start_7a
    invoke-static/range {p0 .. p0}, Lorg/eclipse/tm4e/core/internal/grammar/parser/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁣⁤⁤⁠⁤⁠(Ljava/lang/Object;)Ljava/io/File;
    ...
    :try_end_82
    .catch Ljava/lang/Exception; {:try_start_7a .. :try_end_82} :catch_2a2
    .catchall {:try_start_7a .. :try_end_82} :catchall_29c
    ...
    invoke-static {}, Landroid/s/k31$ۥ;->⁠⁠⁠⁣⁣⁠⁣⁠⁠⁤⁠⁣()[S

    move-result-object v4
    :try_end_9b
    .catch Ljava/lang/Exception; {:try_start_90 .. :try_end_9b} :catch_2a2
    .catchall {:try_start_90 .. :try_end_9b} :catchall_29c
    ...
    :try_end_b9
    .catch Ljava/lang/Exception; {:try_start_ad .. :try_end_b9} :catch_2a2
    .catchall {:try_start_ad .. :try_end_b9} :catchall_29c
    ...
    move-result v13
    :try_end_c9
    .catch Ljava/lang/Exception; {:try_start_c1 .. :try_end_c9} :catch_2a2
    .catchall {:try_start_c1 .. :try_end_c9} :catchall_29c
    ...
    :sswitch_f7
    :try_start_f7
    invoke-static/range {p0 .. p0}, Lorg/eclipse/tm4e/languageconfiguration/internal/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁣⁣⁣⁣⁣⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁠(Ljava/lang/Object;)Landroid/app/Activity;
    ...
    :try_end_102
    .catchall {:try_start_f7 .. :try_end_102} :catchall_29c
    ...
    :cond_110
    invoke-static/range {v31 .. v31}, Lorg/dom4j/dtd/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁠⁠⁣⁤⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)I
    ...
    :try_end_179
    .catch Ljava/lang/Exception; {:try_start_175 .. :try_end_179} :catch_2a2
    .catchall {:try_start_175 .. :try_end_179} :catchall_29c
    ...
    invoke-static {v0}, Ljavax/xml/stream/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁠⁤⁣⁣⁤⁤⁣⁤⁤⁤;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁤⁠⁤⁠(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-static {v0, v6}, Lnp/x2a/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤⁣⁤⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_1bc
    .catch Ljava/lang/Exception; {:try_start_1a1 .. :try_end_1bc} :catch_2a2
    .catchall {:try_start_1a1 .. :try_end_1bc} :catchall_29c
    ...
    invoke-static {v8, v0, v9, v3}, Lorg/apache/batik/util/resources/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁠⁤⁣⁠⁤⁣⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁣⁠⁣⁣(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
    :try_end_1f9
    .catch Ljava/lang/Exception; {:try_start_1ee .. :try_end_1f9} :catch_2a2
    .catchall {:try_start_1ee .. :try_end_1f9} :catchall_29c
    ...
    :cond_206
    invoke-static/range {v29 .. v29}, Landroid/myview/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁣⁤⁠⁤⁣;->⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)I
    ...
    :goto_22e
    invoke-static/range {v30 .. v30}, Lplayer/normal/np/base/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁠⁤⁠⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    :goto_256
    invoke-static/range {v31 .. v31}, Lorg/eclipse/tm4e/core/internal/parser/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁤⁠⁤⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)I
    ...
    invoke-static {v2, v0}, Lorg/eclipse/tm4e/core/registry/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/StringBuilder;
    :try_end_262
    .catch Ljava/lang/Exception; {:try_start_25b .. :try_end_262} :catch_2a2
    .catchall {:try_start_25b .. :try_end_262} :catchall_29c
    ...
    invoke-static/range {v24 .. v24}, Lorg/checkerframework/checker/units/qual/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁣⁠⁠⁤⁠⁣;->⁠⁠⁠⁣⁣⁣⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)I
    ...
    :goto_27f
    invoke-static/range {v26 .. v26}, Ljavax/xml/stream/events/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁤⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)I
    ...
    move-result v14
    :try_end_28c
    .catch Ljava/lang/Exception; {:try_start_284 .. :try_end_28c} :catch_2a2
    .catchall {:try_start_284 .. :try_end_28c} :catchall_29c
    ...
    :try_start_2c5
    invoke-static {v4, v1, v0, v3}, Lorg/benf/cfr/reader/util/getopt/⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠⁣⁤⁠⁠⁤;->⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁤⁤⁠⁤⁠([SIII)Ljava/lang/String;
    ...
    :try_end_2d0
    .catch Ljava/lang/Exception; {:try_start_2c5 .. :try_end_2d0} :catch_317
    .catchall {:try_start_2c5 .. :try_end_2d0} :catchall_303
    ...
    :try_end_2f0
    .catch Ljava/lang/Exception; {:try_start_2eb .. :try_end_2f0} :catch_317
    .catchall {:try_start_2eb .. :try_end_2f0} :catchall_303
    ...
    :goto_2f7
    invoke-static/range {v18 .. v18}, Lorg/benf/cfr/reader/bytecode/analysis/parse/literal/⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁣⁤⁠⁠⁣;->⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    .sparse-switch
        0xdbff -> :sswitch_2e8
        0xdc61 -> :sswitch_2a9
        0x1aa703 -> :sswitch_284
        0x1aa726 -> :sswitch_270
        0x1aa77c -> :sswitch_25b
        0x1aa7bf -> :sswitch_233
        0x1aa81c -> :sswitch_22c
        0x1aaac8 -> :sswitch_21c
        0x1aab02 -> :sswitch_20b
        0x1aab43 -> :sswitch_1e3
        0x1aaf1f -> :sswitch_1d1
        0x1aaf63 -> :sswitch_1a1
        0x1ab266 -> :sswitch_188
        0x1ab343 -> :sswitch_175
        0x1ab35b -> :sswitch_15b
        0x1ab6c1 -> :sswitch_147
        0x1ab9ea -> :sswitch_22c
        0x1aba04 -> :sswitch_132
        0x1aba0a -> :sswitch_122
        0x1aba49 -> :sswitch_116
        0x1abac5 -> :sswitch_f7
        0x1abdea -> :sswitch_e7
        0x1abe01 -> :sswitch_20b
        0x1abe28 -> :sswitch_d9
        0x1abe40 -> :sswitch_c1
        0x1ac1c9 -> :sswitch_b6
        0x1ac507 -> :sswitch_ad
