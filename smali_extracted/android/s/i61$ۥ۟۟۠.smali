...
.class public Landroid/s/i61$ۥ۟۟۠;
...
.field public final ۥ۟۟:Landroid/s/i61;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/i61$ۥ۟۟۠;->short:[S
...
.method public constructor <init>(Landroid/s/i61;Ljava/io/File;Ljava/util/List;)V
    .registers 6

    iput-object p1, p0, Landroid/s/i61$ۥ۟۟۠;->ۥ۟۟:Landroid/s/i61;

    iput-object p2, p0, Landroid/s/i61$ۥ۟۟۠;->ۥ:Ljava/io/File;

    iput-object p3, p0, Landroid/s/i61$ۥ۟۟۠;->ۥ۟:Ljava/util/List;
    ...
    :sswitch_3f
    const-string p2, "gaSxZwgyoENUmlTHNcOJmOEqYz"

    invoke-static {p2}, Lorg/eclipse/jdt/internal/compiler/flow/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁠⁣⁣(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣()[S
    ...
    :sswitch_53
    sget-object v4, Landroid/s/i61$ۥ۟۟۠;->short:[S
...
.method public ۥ(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0}, Lorg/apache/commons/io/output/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁣⁤⁤⁣⁤⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Landroid/s/i61;

    move-result-object v1

    const/4 v3, 0x1

    invoke-static {v1, v3}, Lokhttp3/internal/tls/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁤⁠⁤⁣;->⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;Z)Z
...
.method public ۥ۟([B)V
    ...
    const-string v20, "ۣۥ۠"

    const-string v21, "ۦۨۧ"

    const-string v22, "ۣ۟ۧ"
    ...
    const-string v26, "ۣ۠ۨ"

    const/16 v27, 0x3

    const/16 v28, 0x4

    const-string v29, "ۡۤۡ"

    const/16 v30, 0x2

    const-string v31, "ۨۡۨ"

    const-string v32, "ۢۨۤ"

    const/4 v4, 0x1

    sparse-switch v0, :sswitch_data_328
    ...
    invoke-static {v1, v0}, Lnp/x2a/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤⁣⁤⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_47
    .catch Ljava/lang/Exception; {:try_start_40 .. :try_end_47} :catch_ea
    ...
    invoke-static/range {v20 .. v20}, Lorg/dom4j/datatype/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    :sswitch_5b
    invoke-static {}, Landroid/s/i61$ۥ۟۟۠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣()[S
    ...
    move-result v15
    :try_end_a2
    .catch Ljava/lang/Exception; {:try_start_9a .. :try_end_a2} :catch_ea
    ...
    :try_end_b2
    .catch Ljava/lang/Exception; {:try_start_b0 .. :try_end_b2} :catch_ea

    xor-int/lit8 v4, v15, -0x1

    and-int/lit16 v4, v4, 0xd47
    ...
    :try_start_da
    invoke-static {v12, v4, v15, v1}, Ldifflib/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁤⁣⁤⁠⁠⁣;->⁤⁠⁤⁠⁣⁣⁣⁣⁤⁤([SIII)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v11, v1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
    :try_end_e1
    .catch Ljava/lang/Exception; {:try_start_da .. :try_end_e1} :catch_225
    ...
    :try_end_10c
    .catch Ljava/lang/Exception; {:try_start_108 .. :try_end_10c} :catch_225
    ...
    invoke-static/range {p0 .. p0}, Lorg/apache/commons/io/output/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁣⁤⁤⁣⁤⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Landroid/s/i61;

    move-result-object v0

    invoke-static {v0, v4}, Landroid/file/system/⁣⁣⁣⁣⁣⁠⁠⁣⁣⁣⁠⁠⁤⁠⁠;->⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;Z)Z
    ...
    invoke-static {v0}, Lokio/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁤⁣⁣⁣⁣⁤⁤;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Landroid/content/Context;
    ...
    :try_start_17b
    invoke-static/range {p0 .. p0}, Lorg/apache/xerces/impl/dv/dtd/⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁠⁤⁣⁠⁤⁣;->⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    invoke-static {v0, v10}, Lorg/eclipse/tm4e/languageconfiguration/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)Z
    :try_end_182
    .catch Ljava/lang/Exception; {:try_start_17b .. :try_end_182} :catch_225
    ...
    invoke-static {v9, v4, v0, v1}, Lplayer/normal/np/widget/⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁣⁣⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁣⁤⁠⁤⁤([SIII)Ljava/lang/String;
    ...
    invoke-static {v0}, Landroid/s/i61$ۥ۟۟۠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)I
    ...
    :try_end_21d
    .catch Ljava/lang/Exception; {:try_start_219 .. :try_end_21d} :catch_225

    :goto_21d
    const-string v31, "ۦۣۢ"
    ...
    :try_end_22e
    .catch Ljava/lang/Exception; {:try_start_22c .. :try_end_22e} :catch_2b9
    ...
    move-result v16
    :try_end_234
    .catch Ljava/lang/Exception; {:try_start_22e .. :try_end_234} :catch_225
    ...
    invoke-static/range {v31 .. v31}, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    const v13, 0x7f0bae74

    if-gtz v0, :cond_28f

    invoke-static {}, Lorg/jaxen/function/ext/⁠⁤⁣⁠⁤⁣⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁠⁠⁠⁣⁣⁤()I

    invoke-static/range {v32 .. v32}, Lnp/pth/lib2/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁤⁠⁤⁤(Ljava/lang/Object;)I
    ...
    move-result v17
    :try_end_2ac
    .catch Ljava/lang/Exception; {:try_start_2a4 .. :try_end_2ac} :catch_2b9
    ...
    invoke-static {v0, v4}, Lokhttp3/internal/tls/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁤⁠⁤⁣;->⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;Z)Z
    ...
    .sparse-switch
        0xdcbe -> :sswitch_2fc
        0x1aa7fb -> :sswitch_2db
        0x1aab3f -> :sswitch_2a1
        0x1aaea2 -> :sswitch_296
        0x1aaede -> :sswitch_273
        0x1aaf1e -> :sswitch_272
        0x1ab2be -> :sswitch_245
        0x1ab2e0 -> :sswitch_229
        0x1ab35e -> :sswitch_217
        0x1ab62b -> :sswitch_1e8
        0x1ab642 -> :sswitch_1be
        0x1ab664 -> :sswitch_18a
        0x1ab666 -> :sswitch_184
        0x1ab67f -> :sswitch_179
        0x1ab687 -> :sswitch_178
        0x1ab6be -> :sswitch_15e
        0x1aba09 -> :sswitch_13c
        0x1abda8 -> :sswitch_123
        0x1ac169 -> :sswitch_296
        0x1ac1a7 -> :sswitch_106
        0x1ac21f -> :sswitch_f6
        0x1ac225 -> :sswitch_ef
        0x1ac265 -> :sswitch_b0
        0x1ac526 -> :sswitch_9a
