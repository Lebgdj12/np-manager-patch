...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Landroid/s/un;->ۥ:[B

    new-array v1, v0, [B

    fill-array-data v1, :array_d6

    sput-object v1, Landroid/s/un;->ۥ۟:[B
    ...
    sput-object v1, Landroid/s/un;->ۥ۟۟:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_19a

    sput-object v1, Landroid/s/un;->ۥ۟۟۟:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_39e

    sput-object v1, Landroid/s/un;->ۥ۟۟۠:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_5a2

    sput-object v1, Landroid/s/un;->ۥ۟۟ۡ:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_7a6

    sput-object v1, Landroid/s/un;->ۥ۟۟ۢ:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_9aa

    sput-object v1, Landroid/s/un;->ۥۣ۟۟:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_bae

    sput-object v1, Landroid/s/un;->ۥ۟۟ۤ:[I

    new-array v1, v0, [I

    fill-array-data v1, :array_db2

    sput-object v1, Landroid/s/un;->ۥ۟۟ۥ:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_fb6

    sput-object v0, Landroid/s/un;->ۥ۟۟ۦ:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/s/un;->ۥ۟۟ۨ:[[I
...
.method public static ۥۣ۟۟(I)I
    ...
    invoke-static {p0}, Landroid/s/un;->ۥ۟۟۟(I)I

    move-result v0

    invoke-static {v0}, Landroid/s/un;->ۥ۟۟۟(I)I

    move-result v1

    invoke-static {v1}, Landroid/s/un;->ۥ۟۟۟(I)I
    ...
    invoke-static {v0, v3}, Landroid/s/un;->ۥ۟۟ۥ(II)I
    ...
    invoke-static {v1, v2}, Landroid/s/un;->ۥ۟۟ۥ(II)I
    ...
    invoke-static {p0, v1}, Landroid/s/un;->ۥ۟۟ۥ(II)I
...
.method public static ۥ۟۟ۦ(I)I
    .registers 4

    sget-object v0, Landroid/s/un;->ۥ:[B
...
.method public ۥ(ZLandroid/s/sn;)V
    ...
    instance-of v0, p2, Landroid/s/eo;

    if-eqz v0, :cond_13

    check-cast p2, Landroid/s/eo;

    invoke-virtual {p2}, Landroid/s/eo;->ۥ()[B

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Landroid/s/un;->ۥ۟۟ۢ([BZ)[[I

    move-result-object p2

    iput-object p2, p0, Landroid/s/un;->ۥ۟۟ۨ:[[I

    iput-boolean p1, p0, Landroid/s/un;->ۥ۟۠ۢ:Z
...
.method public ۥ۟۟([BI[BI)I
    ...
    iget-object v0, p0, Landroid/s/un;->ۥ۟۟ۨ:[[I
    ...
    iget-boolean v0, p0, Landroid/s/un;->ۥ۟۠ۢ:Z

    invoke-virtual {p0, p1, p2}, Landroid/s/un;->ۥ۟۟ۧ([BI)V

    iget-object p1, p0, Landroid/s/un;->ۥ۟۟ۨ:[[I

    if-eqz v0, :cond_1b

    invoke-virtual {p0, p1}, Landroid/s/un;->ۥ۟۟ۡ([[I)V

    goto :goto_1e

    :cond_1b
    invoke-virtual {p0, p1}, Landroid/s/un;->ۥ۟۟۠([[I)V

    :goto_1e
    invoke-virtual {p0, p3, p4}, Landroid/s/un;->ۥ۟۟ۤ([BI)V
...
.method public final ۥ۟۟۠([[I)V
    ...
    iget v1, v0, Landroid/s/un;->ۥ۟۠:I

    iget v2, v0, Landroid/s/un;->ۥ۟۟ۧ:I
    ...
    iput v1, v0, Landroid/s/un;->ۥ۟۠:I

    iget v1, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iput v1, v0, Landroid/s/un;->ۥ۟۠۟:I

    iget v1, v0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    iput v1, v0, Landroid/s/un;->ۥ۟۠۠:I

    iget v1, v0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    iput v1, v0, Landroid/s/un;->ۥ۟۠ۡ:I

    sub-int/2addr v2, v5

    :goto_2d
    sget-object v1, Landroid/s/un;->ۥۣ۟۟:[I

    iget v3, v0, Landroid/s/un;->ۥ۟۠:I

    if-le v2, v5, :cond_141

    and-int/lit16 v8, v3, 0xff

    aget v8, v1, v8

    sget-object v9, Landroid/s/un;->ۥ۟۟ۤ:[I

    iget v10, v0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    sget-object v11, Landroid/s/un;->ۥ۟۟ۥ:[I

    iget v12, v0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    sget-object v13, Landroid/s/un;->ۥ۟۟ۦ:[I

    iget v14, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iput v3, v0, Landroid/s/un;->ۥ۟۠:I
    ...
    iput v3, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iput v3, v0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    sget-object v5, Landroid/s/un;->ۥ۟۟ۤ:[I

    iget v8, v0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    sget-object v9, Landroid/s/un;->ۥ۟۟ۥ:[I

    iget v10, v0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    sget-object v11, Landroid/s/un;->ۥ۟۟ۦ:[I

    iget v12, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    sget-object v2, Landroid/s/un;->ۥ۟:[B
...
.method public final ۥ۟۟ۡ([[I)V
    ...
    :goto_2b
    iget v3, v0, Landroid/s/un;->ۥ۟۟ۧ:I

    sub-int/2addr v3, v4

    if-ge v1, v3, :cond_143

    sget-object v3, Landroid/s/un;->ۥ۟۟۟:[I

    iget v7, v0, Landroid/s/un;->ۥ۟۠:I

    and-int/lit16 v8, v7, 0xff

    aget v8, v3, v8

    sget-object v9, Landroid/s/un;->ۥ۟۟۠:[I

    iget v10, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    sget-object v11, Landroid/s/un;->ۥ۟۟ۡ:[I
    ...
    sget-object v13, Landroid/s/un;->ۥ۟۟ۢ:[I

    iget v14, v0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    iput v7, v0, Landroid/s/un;->ۥ۟۠:I
    ...
    iput v7, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iput v7, v0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    :cond_143
    sget-object v2, Landroid/s/un;->ۥ۟۟۟:[I
    ...
    sget-object v7, Landroid/s/un;->ۥ۟۟۠:[I

    iget v8, v0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    sget-object v9, Landroid/s/un;->ۥ۟۟ۡ:[I
    ...
    sget-object v11, Landroid/s/un;->ۥ۟۟ۢ:[I

    iget v12, v0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    sget-object v2, Landroid/s/un;->ۥ:[B
    ...
    iput v5, v0, Landroid/s/un;->ۥ۟۠۠:I
...
.method public final ۥ۟۟ۢ([BZ)[[I
    ...
    iput v6, v0, Landroid/s/un;->ۥ۟۟ۧ:I
    ...
    :cond_58
    iget v1, v0, Landroid/s/un;->ۥ۟۟ۧ:I
    ...
    invoke-static {v9, v4}, Landroid/s/un;->ۥ۟۟ۥ(II)I

    move-result v9

    invoke-static {v9}, Landroid/s/un;->ۥ۟۟ۦ(I)I

    move-result v9

    sget-object v11, Landroid/s/un;->ۥ۟۟:[I
    ...
    invoke-static {v4}, Landroid/s/un;->ۥۣ۟۟(I)I
...
.method public final ۥ۟۟ۤ([BI)V
    .registers 6

    add-int/lit8 v0, p2, 0x1

    iget v1, p0, Landroid/s/un;->ۥ۟۠:I
    ...
    iget v1, p0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iget v1, p0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    iget v1, p0, Landroid/s/un;->ۥ۟۠ۡ:I
...
.method public final ۥ۟۟ۧ([BI)V
    ...
    iput p2, p0, Landroid/s/un;->ۥ۟۠:I
    ...
    iput v0, p0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iput p2, p0, Landroid/s/un;->ۥ۟۠۟:I
    ...
    iput v0, p0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    iput p2, p0, Landroid/s/un;->ۥ۟۠۠:I
    ...
    iput v0, p0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    iput p2, p0, Landroid/s/un;->ۥ۟۠ۡ:I
    ...
    iput p1, p0, Landroid/s/un;->ۥ۟۠ۡ:I
