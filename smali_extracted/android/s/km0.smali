...
.class public Landroid/s/km0;
.super Landroid/s/xl0;

# interfaces
.implements Landroid/s/hj0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/km0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public constructor <init>(Lorg/jf/dexlib2/Opcode;III)V
    ...
    iput p1, p0, Landroid/s/km0;->ۥ۟۟۟:I
    ...
    iput p1, p0, Landroid/s/km0;->ۥ۟۟۠:I

    .line 4
    invoke-static {p4}, Landroid/s/np0;->ۥ۟۟۠(I)I

    move-result p1

    iput p1, p0, Landroid/s/km0;->ۥ۟۟ۡ:I

    return-void
.end method

.method public static ۥ۟ۡۤ(Landroid/s/hj0;)Landroid/s/km0;
    .registers 5

    .line 1
    instance-of v0, p0, Landroid/s/km0;

    if-eqz v0, :cond_7

    .line 2
    check-cast p0, Landroid/s/km0;

    return-object p0

    .line 3
    :cond_7
    new-instance v0, Landroid/s/km0;
    ...
    invoke-direct {v0, v1, v2, v3, p0}, Landroid/s/km0;-><init>(Lorg/jf/dexlib2/Opcode;III)V
...
.method public ۥ۟۟ۤ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/km0;->ۥ۟۟ۡ:I
...
.method public ۥ۟۠ۥ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/km0;->ۥ۟۟۠:I
...
.method public ۥ۟۠ۧ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/km0;->ۥ۟۟۟:I
...
.method public ۥ۟ۡۡ()Lorg/jf/dexlib2/Format;
    ...
    .line 1
    sget-object v0, Landroid/s/km0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
