...
.method public static ۥ(Ljava/util/List;Z)Ljava/util/List;
    ...
    new-instance v1, Landroid/s/wa1$ۥ۟;

    invoke-direct {v1, p1}, Landroid/s/wa1$ۥ۟;-><init>(Z)V

    invoke-static {p0, v1}, Lorg/apache/xerces/xpointer/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public static ۥ۟(Ljava/util/List;Z)Ljava/util/List;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Landroid/s/wa1$ۥ۟۟;

    invoke-direct {v1, p1}, Landroid/s/wa1$ۥ۟۟;-><init>(Z)V
...
.method public static ۥ۟۟(Ljava/util/List;Z)Ljava/util/List;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Landroid/s/wa1$ۥ;

    invoke-direct {v1, p1}, Landroid/s/wa1$ۥ;-><init>(Z)V
...
.method public static ۥ۟۟۟(Ljava/util/List;Z)Ljava/util/List;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Landroid/s/wa1$ۥ۟۟۟;

    invoke-direct {v1, p1}, Landroid/s/wa1$ۥ۟۟۟;-><init>(Z)V
