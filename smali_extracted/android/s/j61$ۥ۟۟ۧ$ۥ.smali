...
.class public Landroid/s/j61$ۥ۟۟ۧ$ۥ;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/j61$ۥ۟۟ۧ;->ۥ۟۟(Lcom/alibaba/fastjson/JSONObject;)V
.end annotation
...
# instance fields
.field public final ۥۡ۟ۥ:Landroid/s/j61$ۥ۟۟ۧ;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/j61$ۥ۟۟ۧ$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/j61$ۥ۟۟ۧ;)V
    .registers 5

    iput-object p1, p0, Landroid/s/j61$ۥ۟۟ۧ$ۥ;->ۥۡ۟ۥ:Landroid/s/j61$ۥ۟۟ۧ;
    ...
    :sswitch_4e
    const-string v0, "3Dg5waQqe6CA81"
...
.method public static ⁤⁠⁤⁤⁤⁠⁤⁣()[S
    ...
    :sswitch_37
    sget-object v3, Landroid/s/j61$ۥ۟۟ۧ$ۥ;->short:[S
...
.method public run()V
    ...
    :goto_10
    const-string v13, "۟ۨ۠"

    const-string v14, "ۦۧۡ"
    ...
    :sswitch_3d
    invoke-static/range {p0 .. p0}, Lorg/benf/cfr/reader/bytecode/analysis/structured/expression/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁠⁠⁠⁣⁣⁠;->⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Landroid/s/j61$ۥ۟۟ۧ;

    move-result-object v0

    invoke-static {v0}, Lorg/benf/cfr/reader/bytecode/analysis/parse/lvalue/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁠(Ljava/lang/Object;)Landroid/s/j61;
    ...
    invoke-static {v13}, Lorg/benf/cfr/reader/bytecode/analysis/parse/lvalue/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁠(Ljava/lang/Object;)Landroid/s/j61;

    move-result-object v13

    invoke-static {v13}, Lorg/eclipse/jdt/internal/compiler/parser/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁤⁤⁣⁠⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/content/Context;

    move-result-object v13

    invoke-static {v13, v3}, Lnp/apkzlib/zip/compress/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁤⁠⁤⁠(Ljava/lang/Object;I)Ljava/lang/String;
    ...
    :sswitch_6c
    :try_start_6c
    invoke-static {}, Landroid/s/j61$ۥ۟۟ۧ$ۥ;->⁤⁠⁤⁤⁤⁠⁤⁣()[S

    move-result-object v9
    :try_end_70
    .catch Ljava/lang/Exception; {:try_start_6c .. :try_end_70} :catch_1bf
    .catchall {:try_start_6c .. :try_end_70} :catchall_1bb
    ...
    move-result v12
    :try_end_91
    .catch Ljava/lang/Exception; {:try_start_89 .. :try_end_91} :catch_1bf
    .catchall {:try_start_89 .. :try_end_91} :catchall_1bb
    ...
    :try_end_af
    .catch Ljava/lang/Exception; {:try_start_9f .. :try_end_af} :catch_1bf
    .catchall {:try_start_9f .. :try_end_af} :catchall_1bb
    ...
    :try_end_d7
    .catchall {:try_start_c4 .. :try_end_d7} :catchall_1bb
    ...
    :try_start_fd
    invoke-static {v9, v13, v0, v3}, Lorg/eclipse/tm4e/languageconfiguration/internal/utils/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁤([SIII)Ljava/lang/String;
    ...
    invoke-static {v5, v6, v7, v0}, Lorg/apache/batik/util/resources/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁠⁤⁣⁠⁤⁣⁤⁠⁤⁠;->⁠⁣⁤⁣⁤⁠⁠⁣⁣⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_108
    .catch Ljava/lang/Exception; {:try_start_fd .. :try_end_108} :catch_1bf
    .catchall {:try_start_fd .. :try_end_108} :catchall_1bb
    ...
    :try_end_117
    .catchall {:try_start_114 .. :try_end_117} :catchall_1bb
    ...
    :try_end_177
    .catch Ljava/lang/Exception; {:try_start_167 .. :try_end_177} :catch_1bf
    .catchall {:try_start_167 .. :try_end_177} :catchall_1bb
    ...
    :try_end_1a8
    .catch Ljava/lang/Exception; {:try_start_19c .. :try_end_1a8} :catch_1bf
    .catchall {:try_start_19c .. :try_end_1a8} :catchall_1bb
    ...
    :try_end_1f7
    .catch Ljava/lang/Exception; {:try_start_1f5 .. :try_end_1f7} :catch_2b8
    .catchall {:try_start_1f5 .. :try_end_1f7} :catchall_2ae
    ...
    move-result v11
    :try_end_1fd
    .catch Ljava/lang/Exception; {:try_start_1f7 .. :try_end_1fd} :catch_1bf
    .catchall {:try_start_1f7 .. :try_end_1fd} :catchall_1bb
    ...
    :try_start_28d
    new-instance v0, Landroid/s/hb1;

    invoke-direct {v0}, Landroid/s/hb1;-><init>()V
    :try_end_292
    .catch Ljava/lang/Exception; {:try_start_28d .. :try_end_292} :catch_2b8
    .catchall {:try_start_28d .. :try_end_292} :catchall_2ae
    ...
    .sparse-switch
        ...
        0xdc06 -> :sswitch_27b
        0xdc62 -> :sswitch_265
        0x1aa75c -> :sswitch_264
        0x1aa784 -> :sswitch_241
        0x1aa79f -> :sswitch_211
        0x1aa817 -> :sswitch_1f4
        0x1aaea7 -> :sswitch_1db
        0x1aaec3 -> :sswitch_1c4
        0x1ab244 -> :sswitch_19c
        0x1ab245 -> :sswitch_18b
        0x1ab266 -> :sswitch_265
        0x1ab649 -> :sswitch_167
        0x1ab722 -> :sswitch_153
        0x1aba21 -> :sswitch_142
        0x1aba24 -> :sswitch_127
        0x1aba80 -> :sswitch_114
        0x1abaa6 -> :sswitch_e6
        0x1abadd -> :sswitch_c4
        0x1abe20 -> :sswitch_9f
        0x1abe61 -> :sswitch_89
