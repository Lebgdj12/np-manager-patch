...
.class public Landroid/s/y61$ۥۣ۟۟;
...
.method public constructor <init>(Landroid/s/y61;)V
    ...
    iput-object p1, p0, Landroid/s/y61$ۥۣ۟۟;->ۥۡ۟ۥ:Landroid/s/y61;
    ...
    :sswitch_15
    const-string v0, "4jhv"

    invoke-static {v0}, Ln/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁤⁣⁠⁣⁤⁠⁤⁠⁤⁣(Ljava/lang/String;)Ljava/lang/String;
...
.method public run()V
    ...
    invoke-static {v11}, Lorg/bouncycastle/util/test/⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠⁠⁠⁣(Ljava/lang/Object;)I
    ...
    :sswitch_59
    :try_start_59
    invoke-static/range {p0 .. p0}, Lnplus/n/p/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁤⁣⁤⁠⁠⁣(Ljava/lang/Object;)Landroid/s/y61;
    ...
    :try_end_68
    .catchall {:try_start_59 .. :try_end_68} :catchall_f5
    ...
    invoke-static {v8}, Lorg/jaxen/function/xslt/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁠⁠⁤⁣⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)Landroid/content/Context;

    move-result-object v8

    invoke-static {v8}, Lnp/guard/flat/structure/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁣⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Landroid/os/Looper;

    move-result-object v8

    invoke-direct {v0, v8}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V
    :try_end_c9
    .catch Ljava/io/IOException; {:try_start_b8 .. :try_end_c9} :catch_f9
    .catchall {:try_start_b8 .. :try_end_c9} :catchall_f5
    ...
    :sswitch_dc
    :try_start_dc
    new-instance v0, Landroid/s/y61$ۥۣ۟۟$ۥ;
    :try_end_de
    .catch Ljava/io/IOException; {:try_start_dc .. :try_end_de} :catch_f9
    .catchall {:try_start_dc .. :try_end_de} :catchall_f5

    move-object/from16 v10, p0

    :try_start_e0
    invoke-direct {v0, v10, v5}, Landroid/s/y61$ۥۣ۟۟$ۥ;-><init>(Landroid/s/y61$ۥۣ۟۟;Landroid/s/a6;)V
    :try_end_e3
    .catch Ljava/io/IOException; {:try_start_e0 .. :try_end_e3} :catch_169
    .catchall {:try_start_e0 .. :try_end_e3} :catchall_153
    ...
    invoke-static {v8}, Lorg/bouncycastle/util/io/pem/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Lplayer/normal/np/adapter/FileAdapter;
    ...
    invoke-direct {v0, v8}, Landroid/s/a6;-><init>(Ljava/lang/String;)V
    :try_end_120
    .catch Ljava/io/IOException; {:try_start_10f .. :try_end_120} :catch_169
    .catchall {:try_start_10f .. :try_end_120} :catchall_153
    ...
    :try_end_142
    .catch Ljava/io/IOException; {:try_start_13f .. :try_end_142} :catch_169
    .catchall {:try_start_13f .. :try_end_142} :catchall_153
    ...
    .sparse-switch
        0xdc27 -> :sswitch_192
        0x1aab40 -> :sswitch_17f
        0x1aab7f -> :sswitch_13d
        0x1aabda -> :sswitch_139
        0x1aaf40 -> :sswitch_10d
        0x1aaf44 -> :sswitch_fe
        0x1ab247 -> :sswitch_dc
        0x1ab248 -> :sswitch_b8
        0x1ab284 -> :sswitch_a6
        ...
        0x1ac547 -> :sswitch_32
        0x1ac5c3 -> :sswitch_23
        0x1ac601 -> :sswitch_192
        0x1ac607 -> :sswitch_17f
    .end sparse-switch
.end method
