...
# instance fields
.field public ۥ۟۟ۡ:Ljava/math/BigInteger;
...
.method public constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    iput-object p2, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۡ:Ljava/math/BigInteger;
    ...
    iput-object p1, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
...
.method public static ۥۣ۟۟(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
    .registers 13
    ...
    sget-object v2, Landroid/s/kp;->ۥ۟:Ljava/math/BigInteger;

    sget-object v3, Landroid/s/kp;->ۥ۟۟:Ljava/math/BigInteger;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_4
    instance-of v1, p1, Landroid/s/mp$ۥ۟;
    ...
    :cond_a
    check-cast p1, Landroid/s/mp$ۥ۟;

    iget-object v1, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;

    iget-object v3, p1, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
    ...
    iget-object v1, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۡ:Ljava/math/BigInteger;

    iget-object p1, p1, Landroid/s/mp$ۥ۟;->ۥ۟۟ۡ:Ljava/math/BigInteger;
...
.method public hashCode()I
    ...
    iget-object v0, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
...
.method public ۥ(Landroid/s/mp;)Landroid/s/mp;
    ...
    iget-object v2, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۡ:Ljava/math/BigInteger;
    ...
    iget-object v2, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
...
.method public ۥ۟۟()Landroid/s/mp;
    ...
    invoke-direct {v0, v1, v2}, Landroid/s/mp$ۥ۟;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public ۥ۟۟۠()Landroid/s/mp;
    ...
    sget-object v5, Landroid/s/kp;->ۥ۟:Ljava/math/BigInteger;

    invoke-virtual {v4, v5}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v4

    iget-object v5, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
    ...
    iget-object v7, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۡ:Ljava/math/BigInteger;

    iget-object v8, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
    ...
    iget-object v10, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
    ...
    iget-object v11, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
    ...
    invoke-static {v10, v9, v7, v5}, Landroid/s/mp$ۥ۟;->ۥۣ۟۟(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
    ...
    iget-object v12, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
    ...
    new-instance v1, Landroid/s/mp$ۥ۟;

    iget-object v2, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;

    invoke-direct {v1, v2, v0}, Landroid/s/mp$ۥ۟;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object v1

    :cond_ca
    sget-object v9, Landroid/s/kp;->ۥ۟:Ljava/math/BigInteger;
...
.method public ۥ۟۟ۡ()Landroid/s/mp;
    ...
    iget-object v3, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۢ:Ljava/math/BigInteger;
...
.method public ۥ۟۟ۢ()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Landroid/s/mp$ۥ۟;->ۥ۟۟ۡ:Ljava/math/BigInteger;
