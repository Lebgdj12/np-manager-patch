...
.field public ۥۡ۟ۥ:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lplayer/normal/np/widget/MenuDialog$ۥ۟۟۠;",
            ">;"
        }
    .end annotation
.end field

.field public ۥۡ۟ۦ:Landroid/view/LayoutInflater;

.field public ۥۡ۟ۧ:Landroid/content/Context;

.field public ۥۡ۟ۨ:Landroid/s/p31$ۥ۟۟۟;

.field public ۥۡ۠:Landroid/s/p31$ۥ۟۟;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/p31;->short:[S
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object p2, p0, Landroid/s/p31;->ۥۡ۟ۥ:Ljava/util/List;
    ...
    :sswitch_28
    invoke-static {p1}, Lorg/benf/cfr/reader/bytecode/analysis/stack/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;)Landroid/view/LayoutInflater;

    move-result-object v1

    iput-object v1, p0, Landroid/s/p31;->ۥۡ۟ۦ:Landroid/view/LayoutInflater;
    ...
    :sswitch_79
    iput-object p1, p0, Landroid/s/p31;->ۥۡ۟ۧ:Landroid/content/Context;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁠⁣⁤⁠⁠⁣()[S
    ...
    :sswitch_6b
    sget-object v4, Landroid/s/p31;->short:[S
...
.method public getCount()I
    ...
    invoke-static {p0}, Lorg/benf/cfr/reader/util/getopt/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁣⁣⁠⁠⁤⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠(Ljava/lang/Object;)Ljava/util/List;
...
.method public bridge synthetic getItem(I)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lorg/apache/xerces/dom3/as/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁣⁠⁤⁣⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁠⁣⁣(Ljava/lang/Object;I)Lplayer/normal/np/widget/MenuDialog$ۥ۟۟۠;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    const-string v30, "۠ۦۢ"

    const-string v31, "ۣۣۢ"

    const-string v32, "۟ۡ"

    const-string v33, "ۥۣۢ"

    const-string v34, "ۦۢۦ"
    ...
    const-string v38, "۟ۤۦ"

    const/16 v39, 0x1

    const/16 v40, 0x2

    sparse-switch v3, :sswitch_data_4b4
    ...
    :sswitch_7d
    invoke-static {}, Landroid/s/p31;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁠⁣⁤⁠⁠⁣()[S
    ...
    invoke-static {v4, v3}, Lorg/jaxen/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤⁤⁠⁤⁤(Ljava/lang/Object;I)Landroid/view/View;
    ...
    iput-object v3, v11, Landroid/s/p31$ۥ۟۟۠;->ۥ۟۟:Landroid/widget/ImageView;

    invoke-static {v4, v11}, Lokhttp3/internal/connection/⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁠;->⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁤⁤⁠⁤⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v4}, Landroid/s/p31;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v5, v4, v6}, Lorg/eclipse/tm4e/core/internal/grammar/parser/⁤⁤⁠⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁠⁤⁤⁠⁤⁠(Ljava/lang/Object;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-static/range {p2 .. p2}, Lnp/apkzlib/zip/compress/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v23

    move-object/from16 v26, v23

    check-cast v26, Landroid/s/p31$ۥ۟۟۠;

    const-string v23, "ۥۣۤ"
    ...
    :cond_1e5
    invoke-static/range {v32 .. v32}, Lorg/apache/xerces/impl/xpath/regex/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁣⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)I
    ...
    new-instance v3, Landroid/s/p31$ۥ۟۟۠;

    invoke-direct {v3}, Landroid/s/p31$ۥ۟۟۠;-><init>()V

    invoke-static/range {p0 .. p0}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁣⁣⁣⁣⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)Landroid/view/LayoutInflater;
    ...
    invoke-static/range {v29 .. v29}, Landroid/s/p31;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v4, v6}, Lorg/jaxen/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤⁤⁠⁤⁤(Ljava/lang/Object;I)Landroid/view/View;

    move-result-object v6

    check-cast v6, Landroid/widget/TextView;

    iput-object v6, v3, Landroid/s/p31$ۥ۟۟۠;->ۥ:Landroid/widget/TextView;
    ...
    const v19, 0x7f097807

    move-object/from16 v31, v38

    :goto_298
    invoke-static/range {v31 .. v31}, Lsjm/xuitls/common/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁤⁠⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁠⁠⁣⁣(Ljava/lang/Object;)I
    ...
    invoke-static {v6}, Landroid/s/p31;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤⁠⁠⁠(Ljava/lang/Object;)I

    move-result v6

    const v20, -0x7f13cabb

    and-int v20, v20, v6

    xor-int/lit8 v6, v6, -0x1

    const v29, 0x7f13caba
    ...
    iput-object v6, v3, Landroid/s/p31$ۥ۟۟۠;->ۥ۟:Landroid/widget/TextView;
    ...
    new-instance v3, Landroid/s/p31$ۥ;

    invoke-direct {v3, v0, v1}, Landroid/s/p31$ۥ;-><init>(Landroid/s/p31;I)V

    invoke-static {v2, v3}, Lokhttp3/internal/io/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁤⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁠⁣⁣(Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance v3, Landroid/s/p31$ۥ۟;

    invoke-direct {v3, v0, v1}, Landroid/s/p31$ۥ۟;-><init>(Landroid/s/p31;I)V

    invoke-static {v2, v3}, Lnp/autoSign/fragment/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁣⁤⁠⁤⁤;->⁤⁤⁠⁤⁤⁤⁠⁤⁠⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p1}, Lorg/apache/xerces/dom3/as/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁣⁠⁤⁣⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁠⁣⁣(Ljava/lang/Object;I)Lplayer/normal/np/widget/MenuDialog$ۥ۟۟۠;

    move-result-object v12

    invoke-static {v11}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁠⁣⁤⁠⁠⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;)Landroid/widget/TextView;

    move-result-object v6

    invoke-static {v12}, Lorg/checkerframework/checker/propkey/qual/⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁣;->⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)Lcom/alibaba/fastjson/JSONObject;
    ...
    invoke-static {v3}, Landroid/s/p31;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v1, v6, v3, v0}, Ljavax/xml/stream/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠;->⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁠⁠⁠([SIII)Ljava/lang/String;

    move-result-object v0

    invoke-static {v15, v0}, Lorg/benf/cfr/reader/bytecode/analysis/structured/expression/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v14, v0}, Lorg/apache/xerces/impl/validation/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠⁠⁣⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v11}, Lorg/bouncycastle/util/test/⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁤⁤⁣⁤⁤⁤⁤⁤⁠⁤⁣(Ljava/lang/Object;)Landroid/widget/ImageView;

    move-result-object v0

    invoke-static/range {p0 .. p0}, Lokhttp3/internal/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-static {v3, v6}, Lorg/antlr/runtime/⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    invoke-static {v0, v3}, Lorg/eclipse/tm4e/languageconfiguration/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤⁣⁣⁣⁣⁤⁤;->⁠⁣⁤⁣⁤⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :goto_43f
    invoke-static/range {v29 .. v29}, Lorg/benf/cfr/reader/bytecode/analysis/parse/lvalue/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁤⁠⁤⁠;->⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v8, v6, v0, v3}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁤⁠⁤⁠([SIII)Ljava/lang/String;
    ...
    invoke-static {v3, v0}, Lorg/apache/xerces/impl/validation/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠⁠⁣⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v11}, Lokio/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁤⁣⁣⁣⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)Landroid/widget/TextView;
    ...
    .sparse-switch
        0xdbe2 -> :sswitch_454
        0xdca3 -> :sswitch_3df
        0x1aa7a1 -> :sswitch_399
        0x1aa7be -> :sswitch_36b
        0x1aa7c2 -> :sswitch_340
        0x1aaac9 -> :sswitch_313
        0x1aaae4 -> :sswitch_2d3
        0x1aab82 -> :sswitch_2a6
        0x1aab9c -> :sswitch_2a3
        0x1aabb8 -> :sswitch_28b
        0x1aaf7a -> :sswitch_25d
        0x1aaf9e -> :sswitch_228
        0x1aafa1 -> :sswitch_1f0
        0x1ab2c2 -> :sswitch_1bc
        0x1abaa5 -> :sswitch_1b4
        0x1abde6 -> :sswitch_194
        0x1abe24 -> :sswitch_171
        0x1ac1aa -> :sswitch_12f
        0x1ac52b -> :sswitch_11f
        0x1ac52c -> :sswitch_10f
        0x1ac5a2 -> :sswitch_fe
        0x1ac5aa -> :sswitch_b7
        0x1ac606 -> :sswitch_7d
        0x1ac608 -> :sswitch_6b
        0x1ac90e -> :sswitch_66
        0x1ac9a3 -> :sswitch_10f
    .end sparse-switch
.end method

.method public setOnItemClickListener(Landroid/s/p31$ۥ۟۟;)V
    .registers 5
    ...
    iput-object p1, p0, Landroid/s/p31;->ۥۡ۠:Landroid/s/p31$ۥ۟۟;
...
.method public setOnItemLongClickListener(Landroid/s/p31$ۥ۟۟۟;)V
    .registers 7
    ...
    :sswitch_25
    const-string v1, "XVIosfKrHedcmKeBIFcL"
    ...
    iput-object p1, p0, Landroid/s/p31;->ۥۡ۟ۨ:Landroid/s/p31$ۥ۟۟۟;
...
.method public ۥ(I)Lplayer/normal/np/widget/MenuDialog$ۥ۟۟۠;
    .registers 6
    ...
    invoke-static {p0}, Lplayer/normal/np/holder/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁣⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    :sswitch_4f
    invoke-static {v3, p1}, Ldifflib/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁤⁣⁤⁠⁠⁣;->⁤⁤⁠⁤⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lplayer/normal/np/widget/MenuDialog$ۥ۟۟۠;
