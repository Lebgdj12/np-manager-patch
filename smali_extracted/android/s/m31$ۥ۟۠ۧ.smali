...
.class public Landroid/s/m31$ۥ۟۠ۧ;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/m31;->ۥۣ۟ۤ(Ljava/io/InputStream;)V
.end annotation
...
.method public constructor <init>(Landroid/s/m31;Ljava/io/InputStream;)V
    .registers 6

    iput-object p1, p0, Landroid/s/m31$ۥ۟۠ۧ;->ۥۡ۟ۦ:Landroid/s/m31;

    iput-object p2, p0, Landroid/s/m31$ۥ۟۠ۧ;->ۥۡ۟ۥ:Ljava/io/InputStream;
    ...
    invoke-static {p2}, Lsun/security/pkcs/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁠⁠⁠⁠⁣⁣⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁣⁤⁠⁠⁣(Ljava/lang/Object;)I
    ...
    :sswitch_65
    const-string p2, "uOqIM6LCLurtmd22GijCa"
...
.method public run()V
    ...
    :try_end_86
    .catch Ljava/io/IOException; {:try_start_83 .. :try_end_86} :catch_b1
    .catchall {:try_start_83 .. :try_end_86} :catchall_ac
    ...
    :sswitch_98
    :try_start_98
    new-instance v0, Landroid/s/m31$ۥ۟۠ۧ$ۥ;
    :try_end_9a
    .catch Ljava/io/IOException; {:try_start_98 .. :try_end_9a} :catch_b1
    .catchall {:try_start_98 .. :try_end_9a} :catchall_ac

    move-object/from16 v15, p0

    :try_start_9c
    invoke-direct {v0, v15, v8}, Landroid/s/m31$ۥ۟۠ۧ$ۥ;-><init>(Landroid/s/m31$ۥ۟۠ۧ;Lio/github/rosemoe/sora/text/Content;)V
    :try_end_9f
    .catch Ljava/io/IOException; {:try_start_9c .. :try_end_9f} :catch_174
    .catchall {:try_start_9c .. :try_end_9f} :catchall_159
    ...
    invoke-static/range {p0 .. p0}, Ljavax/xml/transform/stax/⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Ljava/io/InputStream;

    move-result-object v11

    invoke-static/range {p0 .. p0}, Lorg/apache/commons/logging/⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁤⁠⁤⁣(Ljava/lang/Object;)Landroid/s/m31;

    move-result-object v12

    invoke-static {v12}, Lorg/slf4j/event/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤;->⁤⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v12

    invoke-direct {v0, v11, v12}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/lang/String;)V
    :try_end_f8
    .catch Ljava/io/IOException; {:try_start_e7 .. :try_end_f8} :catch_174
    .catchall {:try_start_e7 .. :try_end_f8} :catchall_159
    ...
    :try_start_113
    invoke-static {v3}, Lorg/apache/xerces/impl/xpath/regex/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁣⁤⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Lio/github/rosemoe/sora/text/Content;

    move-result-object v8
    :try_end_117
    .catch Ljava/io/IOException; {:try_start_113 .. :try_end_117} :catch_174
    ...
    :try_end_133
    .catchall {:try_start_130 .. :try_end_133} :catchall_159
    ...
    :try_end_151
    .catch Ljava/io/IOException; {:try_start_149 .. :try_end_151} :catch_174
    .catchall {:try_start_149 .. :try_end_151} :catchall_159
    ...
    const-string v0, "zN3aXwcNIQtLz2Wlrt62gh"
    ...
    .sparse-switch
        0xdc25 -> :sswitch_20a
        0x1aa720 -> :sswitch_1f6
        0x1aa761 -> :sswitch_1e0
        0x1aabbb -> :sswitch_1cb
        0x1aabbe -> :sswitch_1b5
        0x1aae82 -> :sswitch_1ad
        0x1ab663 -> :sswitch_18f
        0x1ab6ff -> :sswitch_147
        0x1aba08 -> :sswitch_12e
        0x1aba24 -> :sswitch_111
        0x1aba5f -> :sswitch_e5
        0x1abea1 -> :sswitch_d4
        0x1ac16e -> :sswitch_b6
        0x1ac1c3 -> :sswitch_1f6
        0x1ac1e9 -> :sswitch_20a
        0x1ac245 -> :sswitch_98
        0x1ac50c -> :sswitch_83
        0x1ac58c -> :sswitch_74
        0x1ac5a5 -> :sswitch_5b
