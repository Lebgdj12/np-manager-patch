...
.class public Landroid/s/m31$ۥ۟ۡۢ;
...
.method public constructor <init>(Landroid/s/m31;)V
    ...
    iput-object p1, p0, Landroid/s/m31$ۥ۟ۡۢ;->ۥۡ۟ۥ:Landroid/s/m31;
...
.method public run()V
    ...
    const-string v14, "ۣ۟ۤ"

    const-string v15, "ۤۥۡ"

    const-string v16, "ۢۢۢ"

    const-string v17, "ۥۡۢ"
    ...
    :sswitch_2a
    :try_start_2a
    invoke-static/range {p0 .. p0}, Lorg/benf/cfr/reader/util/lambda/⁣⁣⁣⁣⁤⁤⁠⁤⁣⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/s/m31;
    ...
    invoke-static {v2}, Lplayer/normal/np/activity/⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣⁣⁣⁣⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Ljava/io/File;

    move-result-object v0
    :try_end_49
    .catch Ljava/lang/Exception; {:try_start_2a .. :try_end_49} :catch_e1
    .catch Ljava/lang/Error; {:try_start_2a .. :try_end_49} :catch_dc
    .catchall {:try_start_2a .. :try_end_49} :catchall_fe
    ...
    :try_start_81
    invoke-static {v7, v8, v0, v3, v15}, Lsun/security/x509/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁠⁠⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;IZZ)V
    :try_end_84
    .catch Ljava/lang/Exception; {:try_start_81 .. :try_end_84} :catch_e1
    .catch Ljava/lang/Error; {:try_start_81 .. :try_end_84} :catch_dc
    .catchall {:try_start_81 .. :try_end_84} :catchall_fe
    ...
    :try_end_c0
    .catchall {:try_start_b1 .. :try_end_c0} :catchall_fe
    ...
    :try_start_c4
    invoke-static {}, Lorg/objectweb/asm/tree/analysis/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁣()Ljava/io/File;

    move-result-object v11
    :try_end_c8
    .catch Ljava/lang/Exception; {:try_start_c4 .. :try_end_c8} :catch_e1
    .catch Ljava/lang/Error; {:try_start_c4 .. :try_end_c8} :catch_dc
    .catchall {:try_start_c4 .. :try_end_c8} :catchall_fe
    ...
    :try_start_e7
    instance-of v0, v6, Lplayer/normal/np/exception/Java2ClassException;
    :try_end_e9
    .catchall {:try_start_e7 .. :try_end_e9} :catchall_fe
    ...
    :try_end_120
    .catch Ljava/lang/Exception; {:try_start_11c .. :try_end_120} :catch_214
    .catch Ljava/lang/Error; {:try_start_11c .. :try_end_120} :catch_1fb
    .catchall {:try_start_11c .. :try_end_120} :catchall_1e2
    ...
    :try_end_131
    .catch Ljava/lang/Exception; {:try_start_129 .. :try_end_131} :catch_214
    .catch Ljava/lang/Error; {:try_start_129 .. :try_end_131} :catch_1fb
    .catchall {:try_start_129 .. :try_end_131} :catchall_1e2
    ...
    :try_start_146
    invoke-static {}, Lokhttp3/internal/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠()Ljava/io/File;

    move-result-object v0

    invoke-static {v0}, Lorg/w3c/dom/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣(Ljava/lang/Object;)Z
    :try_end_14d
    .catch Ljava/lang/Exception; {:try_start_146 .. :try_end_14d} :catch_214
    .catch Ljava/lang/Error; {:try_start_146 .. :try_end_14d} :catch_1fb
    .catchall {:try_start_146 .. :try_end_14d} :catchall_1e2
    ...
    invoke-static {v6}, Lorg/apache/wml/dom/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁣⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v3}, Lorg/checkerframework/framework/qual/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠;->⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_1be
    .catchall {:try_start_1af .. :try_end_1be} :catchall_1e2
    ...
    :goto_1ca
    invoke-static {v13}, Lsun/security/action/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁣⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)I
    ...
    move-result v9
    :try_end_1da
    .catch Ljava/lang/Exception; {:try_start_1d1 .. :try_end_1da} :catch_214
    .catch Ljava/lang/Error; {:try_start_1d1 .. :try_end_1da} :catch_1fb
    .catchall {:try_start_1d1 .. :try_end_1da} :catchall_1e2
    ...
    .sparse-switch
        0xdbe8 -> :sswitch_228
        0x1aa79a -> :sswitch_1d0
        0x1aa79e -> :sswitch_1ae
        0x1aa7c0 -> :sswitch_197
        0x1aa7db -> :sswitch_185
        0x1aab05 -> :sswitch_176
        0x1aabd7 -> :sswitch_161
        0x1aae81 -> :sswitch_145
        0x1aaf1d -> :sswitch_228
        0x1ab246 -> :sswitch_228
        0x1ab2a2 -> :sswitch_144
        0x1ab71d -> :sswitch_13d
        0x1aba80 -> :sswitch_128
        0x1abd87 -> :sswitch_11b
        0x1abdc6 -> :sswitch_103
        0x1abde2 -> :sswitch_e6
        0x1abe45 -> :sswitch_c3
        0x1ac1a4 -> :sswitch_b0
        0x1ac1a7 -> :sswitch_a9
