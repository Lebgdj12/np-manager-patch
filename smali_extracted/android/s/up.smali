...
.method public constructor <init>(Landroid/s/ci;IILandroid/s/xq;)V
    ...
    iput-object p1, p0, Landroid/s/up;->ۥۡ۟ۥ:Landroid/s/ci;

    iput p2, p0, Landroid/s/up;->ۥۡ۟ۦ:I

    iput p3, p0, Landroid/s/up;->ۥۡ۟ۧ:I
...
.method public ۥ۟۟()Landroid/s/gi;
    ...
    iget-object v1, p0, Landroid/s/up;->ۥۡ۟ۥ:Landroid/s/ci;

    invoke-virtual {v0, v1}, Landroid/s/vh;->ۥ(Landroid/s/uh;)V

    new-instance v1, Landroid/s/zh;

    iget v2, p0, Landroid/s/up;->ۥۡ۟ۦ:I
    ...
    iget v2, p0, Landroid/s/up;->ۥۡ۟ۧ:I
    ...
    iget-object v2, p0, Landroid/s/up;->ۥۡ۟ۨ:[B
