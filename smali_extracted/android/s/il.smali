...
.field public static ۥ۟۟۟:Landroid/s/jl;

.field public static ۥ۟۟۠:Landroid/s/jl;

.field public static ۥ۟۟ۡ:Landroid/s/jl;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/il;->ۥ:Ljava/util/Hashtable;

    new-instance v1, Ljava/util/Hashtable;

    invoke-direct {v1}, Ljava/util/Hashtable;-><init>()V

    sput-object v1, Landroid/s/il;->ۥ۟:Ljava/util/Hashtable;

    new-instance v2, Ljava/util/Hashtable;

    invoke-direct {v2}, Ljava/util/Hashtable;-><init>()V

    sput-object v2, Landroid/s/il;->ۥ۟۟:Ljava/util/Hashtable;

    new-instance v2, Landroid/s/jl;
    ...
    invoke-direct {v2, v6, v3, v4, v5}, Landroid/s/jl;-><init>(ILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    sput-object v2, Landroid/s/il;->ۥ۟۟۟:Landroid/s/jl;
    ...
    sput-object v2, Landroid/s/il;->ۥ۟۟۠:Landroid/s/jl;
    ...
    sput-object v2, Landroid/s/il;->ۥ۟۟ۡ:Landroid/s/jl;

    sget-object v2, Landroid/s/gl;->ۥ۟۟ۦ:Landroid/s/ci;

    sget-object v3, Landroid/s/il;->ۥ۟۟۟:Landroid/s/jl;

    invoke-virtual {v1, v2, v3}, Ljava/util/Hashtable;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v3, Landroid/s/gl;->ۥ۟۟ۧ:Landroid/s/ci;

    sget-object v4, Landroid/s/il;->ۥ۟۟۠:Landroid/s/jl;

    invoke-virtual {v1, v3, v4}, Ljava/util/Hashtable;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v4, Landroid/s/gl;->ۥ۟۠۟:Landroid/s/ci;

    sget-object v5, Landroid/s/il;->ۥ۟۟ۡ:Landroid/s/jl;
...
.method public static ۥ(Landroid/s/ci;)Landroid/s/jl;
    .registers 2

    sget-object v0, Landroid/s/il;->ۥ۟:Ljava/util/Hashtable;

    invoke-virtual {v0, p0}, Ljava/util/Hashtable;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/s/jl;

    return-object p0
.end method

.method public static ۥ۟(Ljava/lang/String;)Landroid/s/ci;
    .registers 2

    sget-object v0, Landroid/s/il;->ۥ:Ljava/util/Hashtable;
