...
.method public constructor <init>(Landroid/s/hi;)V
    ...
    iput-object v0, p0, Landroid/s/cl;->ۥۡ۟ۥ:Landroid/s/ci;
    ...
    iput-object p1, p0, Landroid/s/cl;->ۥۡ۟ۦ:Landroid/s/uh;

    return-void
.end method

.method public static ۥ۟۟ۡ(Ljava/lang/Object;)Landroid/s/cl;
    .registers 4

    if-eqz p0, :cond_32

    instance-of v0, p0, Landroid/s/cl;
    ...
    new-instance v0, Landroid/s/cl;

    check-cast p0, Landroid/s/hi;

    invoke-direct {v0, p0}, Landroid/s/cl;-><init>(Landroid/s/hi;)V
...
.method public ۥ۟۟()Landroid/s/gi;
    ...
    iget-object v1, p0, Landroid/s/cl;->ۥۡ۟ۥ:Landroid/s/ci;

    invoke-virtual {v0, v1}, Landroid/s/vh;->ۥ(Landroid/s/uh;)V

    iget-object v1, p0, Landroid/s/cl;->ۥۡ۟ۦ:Landroid/s/uh;
