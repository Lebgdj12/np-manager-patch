...
.class public Landroid/s/ee1$ۥ۟;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/ee1;->ۥ۟۟ۢ(Landroid/content/Context;Ljava/io/File;Lplayer/normal/np/verify/enums/FileMethodEnum;)V
.end annotation
...
.field public final ۥ۟۟:Lplayer/normal/np/verify/enums/FileMethodEnum;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/ee1$ۥ۟;->short:[S
...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;Lplayer/normal/np/verify/enums/FileMethodEnum;)V
    .registers 5

    iput-object p1, p0, Landroid/s/ee1$ۥ۟;->ۥ:Landroid/content/Context;

    iput-object p2, p0, Landroid/s/ee1$ۥ۟;->ۥ۟:Ljava/io/File;

    iput-object p3, p0, Landroid/s/ee1$ۥ۟;->ۥ۟۟:Lplayer/normal/np/verify/enums/FileMethodEnum;
    ...
    :sswitch_16
    const-string p2, "O3EXKdWH8n3GwWDfmJOnIyEqsUr"
    ...
    invoke-static {p2}, Lorg/apache/xerces/jaxp/validation/⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤;->⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣⁤⁠⁤⁣(Ljava/lang/Object;)I
    ...
    :sswitch_50
    sget-object p2, Lorg/apache/wml/dom/⁠⁣⁤⁣⁤⁠⁣⁠⁠⁤⁠⁠⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠⁣⁠⁠⁤⁠⁣:[S
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁠⁣()[S
    ...
    :sswitch_18
    sget-object v3, Landroid/s/ee1$ۥ۟;->short:[S
...
.method public synthetic ۥ()V
    ...
    :sswitch_2a
    const-string v1, "SJ2Pn5LpAPgCw"

    invoke-static {v1}, Lorg/apache/xerces/impl/dtd/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁠⁣⁣(Ljava/lang/String;)Ljava/lang/String;
...
.method public ۥ۟۟(Lcom/alibaba/fastjson/JSONObject;)V
    ...
    :sswitch_92
    new-instance v1, Landroid/s/ee1$ۥ۟$ۥ;

    move-object/from16 v11, p0

    invoke-direct {v1, v11, v7}, Landroid/s/ee1$ۥ۟$ۥ;-><init>(Landroid/s/ee1$ۥ۟;Landroid/s/ee1;)V

    invoke-static {v7, v4, v1}, Lsun/security/action/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁣⁣⁤⁣⁠⁣⁤⁤;->⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁠⁣⁤⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v5, v3, v1, v13}, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠;->⁤⁠⁤⁣⁠⁠⁣([SIII)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lj$/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)Lplayer/normal/np/verify/enums/FileMethodEnum;

    move-result-object v1

    invoke-static {v1}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁠;->⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {}, Landroid/s/ee1$ۥ۟;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁠⁣()[S
    ...
    new-instance v7, Landroid/s/ee1;

    invoke-static/range {p0 .. p0}, Lorg/xml/sax/ext/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁠⁠⁣⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁣⁤⁠⁠⁤(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-direct {v7, v1, v12}, Landroid/s/ee1;-><init>(Landroid/content/Context;Ljava/io/File;)V
    ...
    const-string v1, "kYiOSarB0CTjNoXvfp9Fj55"
    ...
    :cond_1b0
    :goto_1b0
    invoke-static {v14}, Lorg/apache/xerces/dom3/as/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁣⁠⁤⁣⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)I
    ...
    .sparse-switch
        0xdc41 -> :sswitch_198
        0x1aa723 -> :sswitch_16d
        0x1aa75f -> :sswitch_156
        0x1aab02 -> :sswitch_13b
        0x1aab40 -> :sswitch_138
        0x1aabdb -> :sswitch_125
        0x1ab269 -> :sswitch_113
        0x1ab285 -> :sswitch_f6
        0x1ab9c8 -> :sswitch_da
        0x1ab9e7 -> :sswitch_aa
        0x1aba25 -> :sswitch_92
