...
.method public static ۥ۟(Ljava/lang/String;Landroid/s/ۦۧ۟ۨ;)Ljava/lang/String;
    .registers 7

    sget-object v0, Landroid/s/ۦۧ۠;->ۥ۟۟:Landroid/s/ۦۧ۠;

    invoke-virtual {p1}, Landroid/s/ۦۧ۟ۨ;->ۥ۟()Landroid/s/ۦۧ۠;

    move-result-object v1

    if-ne v0, v1, :cond_21

    sget-object v1, Landroid/s/ۦۧ۠۟;->ۥ۟:Landroid/s/ۦۧ۠۟;

    invoke-virtual {p1}, Landroid/s/ۦۧ۟ۨ;->ۥ۟۟()Landroid/s/ۦۧ۠۟;

    move-result-object v2

    if-eq v1, v2, :cond_19

    sget-object v1, Landroid/s/ۦۧ۠۟;->ۥ:Landroid/s/ۦۧ۠۟;
    ...
    :cond_21
    :goto_21
    sget-object v1, Landroid/s/ۦۧ۠;->ۥ۟:Landroid/s/ۦۧ۠;
    ...
    invoke-static {p0}, Landroid/s/ۦۧ۟ۥ;->ۥ(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    :cond_44
    :goto_44
    sget-object v0, Landroid/s/ۦۧ۠۟;->ۥ۟:Landroid/s/ۦۧ۠۟;
    ...
    :cond_51
    sget-object v0, Landroid/s/ۦۧ۠۟;->ۥ۟۟:Landroid/s/ۦۧ۠۟;
    ...
    :cond_5f
    :goto_5f
    sget-object v0, Landroid/s/ۦۧ۟ۧ;->ۥ:Landroid/s/ۦۧ۟ۧ;

    invoke-virtual {p1}, Landroid/s/ۦۧ۟ۨ;->ۥ()Landroid/s/ۦۧ۟ۧ;
