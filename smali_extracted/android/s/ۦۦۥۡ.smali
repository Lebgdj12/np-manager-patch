...
.class public Landroid/s/ۦۦۥۡ;
.super Landroid/s/ۦۦۥ۠;
...
.method public static final ۥ۟۟۟(II)Landroid/s/ۦۦۤۥ;
    .registers 4
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 1
    sget-object v0, Landroid/s/ۦۦۤۥ;->ۥۡ۟ۥ:Landroid/s/ۦۦۤۥ$ۥ;

    const/4 v1, -0x1

    invoke-virtual {v0, p0, p1, v1}, Landroid/s/ۦۦۤۥ$ۥ;->ۥ(III)Landroid/s/ۦۦۤۥ;
...
.method public static final ۥ۟۟۠(II)Landroid/s/ۦۦۤۧ;
    .registers 3
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    .line 1
    sget-object p0, Landroid/s/ۦۦۤۧ;->ۥۡ۠:Landroid/s/ۦۦۤۧ$ۥ;

    invoke-virtual {p0}, Landroid/s/ۦۦۤۧ$ۥ;->ۥ()Landroid/s/ۦۦۤۧ;
    ...
    invoke-direct {v0, p0, p1}, Landroid/s/ۦۦۤۧ;-><init>(II)V
