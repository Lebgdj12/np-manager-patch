...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/ym0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public constructor <init>(Lorg/jf/dexlib2/Opcode;IIIIIII)V
    ...
    iput p1, p0, Landroid/s/ym0;->ۥ۟۟۟:I
    ...
    :goto_12
    iput p3, p0, Landroid/s/ym0;->ۥ۟۟۠:I
    ...
    :goto_1d
    iput p3, p0, Landroid/s/ym0;->ۥ۟۟ۡ:I
    ...
    :goto_28
    iput p3, p0, Landroid/s/ym0;->ۥ۟۟ۢ:I
    ...
    :goto_33
    iput p3, p0, Landroid/s/ym0;->ۥۣ۟۟:I
    ...
    :cond_3c
    iput p1, p0, Landroid/s/ym0;->ۥ۟۟ۤ:I

    .line 8
    invoke-static {p8}, Landroid/s/np0;->ۥ۟۠ۥ(I)I

    move-result p1

    iput p1, p0, Landroid/s/ym0;->ۥ۟۟ۥ:I

    return-void
.end method

.method public static ۥ۟ۡۤ(Landroid/s/vj0;)Landroid/s/ym0;
    .registers 11

    .line 1
    instance-of v0, p0, Landroid/s/ym0;

    if-eqz v0, :cond_7

    .line 2
    check-cast p0, Landroid/s/ym0;

    return-object p0

    .line 3
    :cond_7
    new-instance v9, Landroid/s/ym0;
    ...
    .line 11
    invoke-interface {p0}, Landroid/s/si0;->ۥ۟۠ۨ()I

    move-result v8

    move-object v0, v9

    invoke-direct/range {v0 .. v8}, Landroid/s/ym0;-><init>(Lorg/jf/dexlib2/Opcode;IIIIIII)V
...
.method public ۥ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥ۟۟۠:I
...
.method public ۥ۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥ۟۟۟:I
...
.method public ۥ۟۟۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥ۟۟ۤ:I
...
.method public ۥۣ۟۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥ۟۟ۡ:I
...
.method public ۥ۟۠۟()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥۣ۟۟:I
...
.method public ۥ۟۠ۡ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥ۟۟ۢ:I
...
.method public ۥ۟۠ۨ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/ym0;->ۥ۟۟ۥ:I
...
.method public ۥ۟ۡۡ()Lorg/jf/dexlib2/Format;
    ...
    .line 1
    sget-object v0, Landroid/s/ym0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
