...
.class public Landroid/s/e71$ۥۣ۟۟;
...
.method public constructor <init>(Landroid/s/e71;)V
    ...
    iput-object p1, p0, Landroid/s/e71$ۥۣ۟۟;->ۥۡ۟ۥ:Landroid/s/e71;
    ...
    :sswitch_14
    const-string v0, "XfS8cssshzIdsVHDBu1o"
...
.method public run()V
    ...
    :try_end_7e
    .catchall {:try_start_6f .. :try_end_7e} :catchall_b7
    ...
    :sswitch_98
    :try_start_98
    new-instance v0, Landroid/s/e71$ۥۣ۟۟$ۥ;
    :try_end_9a
    .catch Ljava/io/IOException; {:try_start_98 .. :try_end_9a} :catch_bf
    .catch Ljava/lang/Exception; {:try_start_98 .. :try_end_9a} :catch_bb
    .catchall {:try_start_98 .. :try_end_9a} :catchall_b7

    move-object/from16 v15, p0

    :try_start_9c
    invoke-direct {v0, v15}, Landroid/s/e71$ۥۣ۟۟$ۥ;-><init>(Landroid/s/e71$ۥۣ۟۟;)V
    :try_end_9f
    .catch Ljava/io/IOException; {:try_start_9c .. :try_end_9f} :catch_12f
    .catch Ljava/lang/Exception; {:try_start_9c .. :try_end_9f} :catch_121
    .catchall {:try_start_9c .. :try_end_9f} :catchall_11e
    ...
    :try_start_d5
    invoke-static {v2, v3}, Lorg/bouncycastle/pqc/jcajce/provider/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁤⁣⁠⁤⁣⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    :try_end_d8
    .catch Ljava/io/IOException; {:try_start_d5 .. :try_end_d8} :catch_12f
    .catch Ljava/lang/Exception; {:try_start_d5 .. :try_end_d8} :catch_121
    .catchall {:try_start_d5 .. :try_end_d8} :catchall_11e
    ...
    :try_end_10c
    .catch Ljava/io/IOException; {:try_start_100 .. :try_end_10c} :catch_12f
    .catch Ljava/lang/Exception; {:try_start_100 .. :try_end_10c} :catch_121
    .catchall {:try_start_100 .. :try_end_10c} :catchall_11e
    ...
    :try_end_13f
    .catchall {:try_start_130 .. :try_end_13f} :catchall_11e
    ...
    :cond_1bb
    const-string v13, "ۦۣۦ"

    :goto_1bd
    invoke-static {v13}, Lorg/joni/constants/internal/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁣⁣⁣⁣⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁠⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)I
    ...
    .sparse-switch
        ...
        0xdc01 -> :sswitch_19a
        0xdc06 -> :sswitch_186
        0x1aa725 -> :sswitch_16e
        0x1aaba2 -> :sswitch_168
        0x1aabb9 -> :sswitch_16e
        0x1ab288 -> :sswitch_fe
        0x1ab2e5 -> :sswitch_eb
        0x1ab9e4 -> :sswitch_d3
        0x1ab9ea -> :sswitch_16e
        0x1aba04 -> :sswitch_c4
        0x1aba9f -> :sswitch_98
        0x1ababc -> :sswitch_97
        0x1ac14f -> :sswitch_eb
