...
.field public static final ۥ۟:Landroid/s/n3$ۥ۟;

.field public static final ۥ۟۟:Landroid/s/n3$ۥ۟;

.field public static final ۥ۟۟۟:Landroid/s/n3$ۥ۟;

.field public static final ۥ۟۟۠:Landroid/s/n3$ۥ۟;
...
.method public static constructor <clinit>()V
    ...
    const-string v17, "ۣۧ۟"

    const-string v18, "ۢۧۥ"

    const-string v19, "۠ۦۡ"
    ...
    const-string v28, "۠ۦۨ"

    const/16 v29, 0x7

    const-string v30, "ۢۧۤ"
    ...
    sparse-switch v1, :sswitch_data_378
    ...
    :sswitch_5c
    new-instance v1, Landroid/s/n3$ۥ۟;
    ...
    invoke-static {v7, v5, v3, v13}, Lorg/apache/xmlgraphics/image/loader/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁠⁣⁣⁣⁤⁣⁠⁣⁤⁤([SIII)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v1, v3}, Landroid/s/n3$ۥ۟;-><init>(Ljava/lang/String;)V
    ...
    const-string v19, "ۣۣۦ"

    goto :goto_9c

    :cond_9a
    const-string v19, "ۡۤ۠"
    ...
    invoke-static {}, Landroid/s/n3$ۥ۟;->⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤()[S
    ...
    invoke-static/range {v24 .. v24}, Lokhttp3/internal/ws/⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v6, v3, v13, v7}, Lorg/apache/xerces/impl/xpath/regex/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁠⁣⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁣⁣⁣⁣⁤⁤([SIII)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v1, v3}, Landroid/s/n3$ۥ۟;-><init>(Ljava/lang/String;)V

    sput-object v1, Landroid/s/n3$ۥ۟;->ۥ۟۟:Landroid/s/n3$ۥ۟;
    ...
    invoke-static/range {v21 .. v21}, Lorg/eclipse/jdt/internal/compiler/flow/⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁣⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁠⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)I
    ...
    fill-array-data v1, :array_3ea

    sput-object v1, Landroid/s/n3$ۥ۟;->short:[S
    ...
    sput-object v5, Landroid/s/n3$ۥ۟;->ۥ۟۟۠:Landroid/s/n3$ۥ۟;
    ...
    sput-object v5, Landroid/s/n3$ۥ۟;->ۥ۟۟۟:Landroid/s/n3$ۥ۟;
    ...
    invoke-static {v4, v13, v3, v7}, Lorg/eclipse/tm4e/languageconfiguration/internal/utils/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤;->⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁠⁣⁤⁣⁤⁣([SIII)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v1, v3}, Landroid/s/n3$ۥ۟;-><init>(Ljava/lang/String;)V

    sput-object v1, Landroid/s/n3$ۥ۟;->ۥ۟:Landroid/s/n3$ۥ۟;
    ...
    invoke-static/range {v30 .. v30}, Lorg/eclipse/tm4e/languageconfiguration/internal/supports/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    .sparse-switch
        0xdce1 -> :sswitch_376
        0x1aa7a1 -> :sswitch_357
        0x1aaac7 -> :sswitch_333
        0x1aab7b -> :sswitch_328
        0x1aab9b -> :sswitch_306
        0x1aaba2 -> :sswitch_2ef
        0x1aabbe -> :sswitch_2d5
        0x1aaec6 -> :sswitch_2b8
        0x1aaf00 -> :sswitch_281
        0x1aaf1d -> :sswitch_275
        0x1ab324 -> :sswitch_259
        0x1ab33f -> :sswitch_23a
        0x1ab340 -> :sswitch_218
        0x1ab686 -> :sswitch_207
        0x1ab6fb -> :sswitch_1ed
        0x1aba61 -> :sswitch_1d0
        0x1abde3 -> :sswitch_1b6
        0x1abdeb -> :sswitch_19d
        0x1abe04 -> :sswitch_18e
        0x1abe7d -> :sswitch_171
        0x1abe81 -> :sswitch_153
        0x1ac149 -> :sswitch_145
        0x1ac221 -> :sswitch_f8
        0x1ac526 -> :sswitch_d8
        0x1ac58b -> :sswitch_b8
        0x1ac8e8 -> :sswitch_9e
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Landroid/s/n3;-><init>(Ljava/lang/String;)V
...
.method public static ۥ(Ljava/lang/String;)Landroid/s/n3$ۥ۟;
    .registers 9
    ...
    :sswitch_11
    invoke-static {v4}, Lorg/benf/cfr/reader/bytecode/analysis/loc/⁤⁤⁠⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁣⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, v1}, LXI/XI/XI/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :sswitch_20
    invoke-static {}, Lorg/bouncycastle/jcajce/provider/asymmetric/gost/⁣⁤⁣⁠⁣⁤⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁠()Landroid/s/n3$ۥ۟;
    ...
    :sswitch_32
    invoke-static {}, Lplayer/normal/np/base/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁤⁤⁠⁤⁠()Landroid/s/n3$ۥ۟;
    ...
    invoke-static {}, Lorg/jaxen/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠()Landroid/s/n3$ۥ۟;
...
.method public static ⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤()[S
    ...
    :sswitch_6e
    sget-object v4, Landroid/s/n3$ۥ۟;->short:[S
