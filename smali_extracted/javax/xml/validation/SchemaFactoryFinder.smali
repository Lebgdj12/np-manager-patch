...
.class public final Ljavax/xml/validation/SchemaFactoryFinder;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ljavax/xml/validation/SchemaFactoryFinder;->cacheProps:Ljava/util/Properties;

    const/4 v0, 0x1

    sput-boolean v0, Ljavax/xml/validation/SchemaFactoryFinder;->firstTime:Z
    ...
    :goto_1d
    sput-boolean v0, Ljavax/xml/validation/SchemaFactoryFinder;->debug:Z
    :try_end_1f
    ...
    :goto_22
    sget-object v0, Ljavax/xml/validation/SchemaFactoryFinder;->class$javax$xml$validation$SchemaFactory:Ljava/lang/Class;

    if-nez v0, :cond_2e

    const-string v0, "javax.xml.validation.SchemaFactory"

    invoke-static {v0}, Ljavax/xml/validation/SchemaFactoryFinder;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Ljavax/xml/validation/SchemaFactoryFinder;->class$javax$xml$validation$SchemaFactory:Ljava/lang/Class;

    :cond_2e
    sput-object v0, Ljavax/xml/validation/SchemaFactoryFinder;->SERVICE_CLASS:Ljava/lang/Class;
    ...
    sput-object v0, Ljavax/xml/validation/SchemaFactoryFinder;->SERVICE_ID:Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/ClassLoader;)V
    ...
    sget-boolean p1, Ljavax/xml/validation/SchemaFactoryFinder;->debug:Z
...
.method private _newFactory(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;
    ...
    sget-object v1, Ljavax/xml/validation/SchemaFactoryFinder;->SERVICE_CLASS:Ljava/lang/Class;
    ...
    :cond_37
    invoke-static {v0}, Ljavax/xml/validation/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-boolean v2, Ljavax/xml/validation/SchemaFactoryFinder;->debug:Z
    ...
    invoke-static {v1}, Ljavax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V
    :try_end_70
    .catch Ljava/lang/VirtualMachineError; {:try_start_1a .. :try_end_70} :catch_1c0
    .catch Ljava/lang/ThreadDeath; {:try_start_1a .. :try_end_70} :catch_1be
    ...
    invoke-static {v1}, Ljavax/xml/validation/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_b6
    sget-boolean v2, Ljavax/xml/validation/SchemaFactoryFinder;->firstTime:Z

    if-eqz v2, :cond_f5

    sget-object v2, Ljavax/xml/validation/SchemaFactoryFinder;->cacheProps:Ljava/util/Properties;
    ...
    :try_start_bd
    sget-boolean v3, Ljavax/xml/validation/SchemaFactoryFinder;->firstTime:Z
    ...
    invoke-static {v3}, Ljavax/xml/validation/SecuritySupport;->doesFileExist(Ljava/io/File;)Z
    ...
    :cond_e7
    sget-object v1, Ljavax/xml/validation/SchemaFactoryFinder;->cacheProps:Ljava/util/Properties;

    invoke-static {v3}, Ljavax/xml/validation/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    invoke-virtual {p0, v0}, Ljavax/xml/validation/SchemaFactoryFinder;->createInstance(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;
    ...
    :cond_129
    invoke-direct {p0}, Ljavax/xml/validation/SchemaFactoryFinder;->createServiceFileIterator()Ljava/util/Iterator;
    ...
    :cond_144
    const-string v0, "http://www.w3.org/XML/XMLSchema/v1.1"
    ...
    const-string p1, "attempting to use the platform default XML Schema 1.1 validator"

    invoke-static {p1}, Ljavax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V

    :cond_155
    const-string p1, "org.apache.xerces.jaxp.validation.XMLSchema11Factory"

    :goto_157
    invoke-virtual {p0, p1}, Ljavax/xml/validation/SchemaFactoryFinder;->createInstance(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;
    ...
    const-string p1, "attempting to use the platform default XML Schema 1.0 validator"

    invoke-static {p1}, Ljavax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V

    :cond_170
    const-string p1, "org.apache.xerces.jaxp.validation.XMLSchemaFactory"
    ...
    invoke-static {v1}, Ljavax/xml/validation/SecuritySupport;->getURLInputStream(Ljava/net/URL;)Ljava/io/InputStream;

    move-result-object v3

    invoke-direct {p0, p1, v2, v3}, Ljavax/xml/validation/SchemaFactoryFinder;->loadFromServicesFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Ljavax/xml/validation/SchemaFactory;

    move-result-object v1
    :try_end_19d
    .catch Ljava/io/IOException; {:try_start_191 .. :try_end_19d} :catch_1a0
...
.method private createServiceFileIterator()Ljava/util/Iterator;
    ...
    new-instance v0, Ljavax/xml/validation/SchemaFactoryFinder$1;

    invoke-direct {v0, p0}, Ljavax/xml/validation/SchemaFactoryFinder$1;-><init>(Ljavax/xml/validation/SchemaFactoryFinder;)V

    return-object v0

    :cond_a
    :try_start_a
    sget-object v1, Ljavax/xml/validation/SchemaFactoryFinder;->SERVICE_ID:Ljava/lang/String;

    invoke-static {v0, v1}, Ljavax/xml/validation/SecuritySupport;->getResources(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/util/Enumeration;
...
.method private loadFromServicesFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Ljavax/xml/validation/SchemaFactory;
    ...
    invoke-static {p2}, Ljavax/xml/validation/SchemaFactoryFinder;->debugPrintln(Ljava/lang/String;)V
    ...
    :cond_51
    :try_start_51
    invoke-virtual {p0, p3}, Ljavax/xml/validation/SchemaFactoryFinder;->createInstance(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;

    move-result-object p3

    invoke-virtual {p3, p1}, Ljavax/xml/validation/SchemaFactory;->isSchemaLanguageSupported(Ljava/lang/String;)Z
...
.method private static which(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Ljavax/xml/validation/SchemaFactoryFinder;->which(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/String;
...
.method private static which(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/String;
    ...
    :cond_1f
    invoke-static {p1, p0}, Ljavax/xml/validation/SecuritySupport;->getResourceAsURL(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/net/URL;
...
# virtual methods
.method public createInstance(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;
    .registers 5
    ...
    instance-of v1, v0, Ljavax/xml/validation/SchemaFactory;
