...
.class public Lokhttp3/internal/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁠⁠⁤⁣⁠⁤⁣;
...
.method public static ⁠⁠⁠⁣⁣⁣⁤⁤⁠⁤⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-static {p0}, Landroid/s/q61;->ۥ۟۟۟(Landroid/s/q61;)Landroid/content/Context;
...
.method public static ⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁣⁤⁠⁤⁠(Ljava/lang/Object;)Ljava/util/List;
    ...
    check-cast p0, Landroid/s/ۦۨۧۧ$ۥ;

    iget-object v1, p0, Landroid/s/ۦۨۧۧ$ۥ;->ۥ۟:Ljava/util/List;
...
.method public static ⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁠⁣⁣(Ljava/lang/Object;)Ljava/lang/String;
    ...
    check-cast p0, Lorg/dom4j/QName;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁣(Ljava/lang/Object;)Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/s/b;->ۥ۟:Ljava/util/List;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;II)V
    ...
    check-cast p0, Landroid/s/r4;

    check-cast p1, [B

    invoke-interface {p0, p1, p2, p3}, Landroid/s/r4;->ۥ([BII)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Ljava/util/Map;
    ...
    iget-object v1, p0, Landroid/s/g;->ۥ۟ۡۦ:Ljava/util/Map;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁤⁠⁤⁣(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1}, Lnp/obscuring/NPDexEditor;->ۥ۟۟ۨ(I)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)Lplayer/normal/np/activity/NPMeasureActivity;
    ...
    check-cast p0, Lplayer/normal/np/activity/NPMeasureActivity$ۥ۟;

    iget-object v1, p0, Lplayer/normal/np/activity/NPMeasureActivity$ۥ۟;->ۥ:Lplayer/normal/np/activity/NPMeasureActivity;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁤⁤⁣⁠⁠⁠⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    check-cast p0, Landroid/s/x41;

    invoke-static {p0}, Landroid/s/x41;->ۥ۟۠(Landroid/s/x41;)Landroid/content/Context;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0}, Landroid/s/ۦۨۥۨ;->ۥ۟۟ۡ()I
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁣⁤⁠⁤⁠(Ljava/lang/Object;)[B
    ...
    invoke-static {p0}, Lnp/signVerifier/SignReader;->ۥ۟۟ۦ(Ljava/io/File;)[B
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    check-cast p1, Landroid/s/y31;

    invoke-static {p0, p1}, Landroid/s/we1;->ۥ۟۟ۨ(Landroid/app/Activity;Landroid/s/y31;)V
...
.method public static ⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Landroid/content/SharedPreferences;
    .registers 2
...
.method public static ⁣⁤⁠⁠⁠⁤⁤⁠⁤⁣⁤⁠⁤⁣(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/s/m5;->ۥ:Ljava/lang/String;
...
.method public static ⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, Landroid/s/ja1;->ۥ۟(Landroid/s/c6;Ljava/util/List;)V
...
.method public static ⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Landroid/s/fa1;
    ...
    invoke-static {p0}, Landroid/s/fa1;->ۥ(Ljava/lang/String;)Landroid/s/fa1;
