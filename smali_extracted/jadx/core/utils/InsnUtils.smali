...
.class public Ljadx/core/utils/InsnUtils;
...
.method public static synthetic $SWITCH_TABLE$jadx$core$dex$instructions$InsnType()[I
    ...
    .line 1
    sget-object v0, Ljadx/core/utils/InsnUtils;->$SWITCH_TABLE$jadx$core$dex$instructions$InsnType:[I
    ...
    :catch_1a9
    sput-object v0, Ljadx/core/utils/InsnUtils;->$SWITCH_TABLE$jadx$core$dex$instructions$InsnType:[I
...
.method public static constructor <clinit>()V
    ...
    .line 1
    const-class v0, Ljadx/core/utils/InsnUtils;

    invoke-static {v0}, Landroid/s/iz0;->ۥ۟۟ۤ(Ljava/lang/Class;)Landroid/s/hz0;

    move-result-object v0

    sput-object v0, Ljadx/core/utils/InsnUtils;->LOG:Landroid/s/hz0;
...
.method public static formatOffset(I)Ljava/lang/String;
    .registers 3
...
.method public static getArg(Landroid/s/gi0;I)I
    .registers 4
    ...
    const-string v1, "Wrong argument number: "
    ...
    .line 4
    :cond_30
    instance-of p1, p0, Landroid/s/oi0;

    if-eqz p1, :cond_3b

    .line 5
    check-cast p0, Landroid/s/oi0;
    ...
    .line 7
    :cond_42
    instance-of p1, p0, Landroid/s/pi0;
    ...
    .line 10
    :cond_54
    instance-of p1, p0, Landroid/s/ji0;
...
.method public static getConstValueByInsn(Ljadx/core/dex/nodes/DexNode;Ljadx/core/dex/nodes/InsnNode;)Ljava/lang/Object;
    .registers 5
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation

    .line 1
    invoke-static {}, Ljadx/core/utils/InsnUtils;->$SWITCH_TABLE$jadx$core$dex$instructions$InsnType()[I
    ...
    invoke-virtual {v0, p1}, Ljadx/core/dex/nodes/RootNode;->deepResolveField(Ljadx/core/dex/info/FieldInfo;)Ljadx/core/dex/nodes/FieldNode;
    ...
    .line 4
    sget-object v0, Ljadx/core/utils/InsnUtils;->LOG:Landroid/s/hz0;

    const-string v1, "Field {} not found in dex {}"

    invoke-interface {v0, v1, p1, p0}, Landroid/s/hz0;->warn(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

    return-object v2

    .line 5
    :cond_37
    sget-object p0, Ljadx/core/dex/attributes/AType;->FIELD_INIT:Ljadx/core/dex/attributes/AType;

    invoke-virtual {v0, p0}, Ljadx/core/dex/attributes/AttrNode;->get(Ljadx/core/dex/attributes/AType;)Ljadx/core/dex/attributes/IAttribute;

    move-result-object p0

    check-cast p0, Ljadx/core/dex/nodes/parser/FieldInitAttr;

    if-eqz p0, :cond_45

    .line 6
    invoke-virtual {p0}, Ljadx/core/dex/nodes/parser/FieldInitAttr;->getValue()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Ljadx/core/dex/instructions/ConstClassNode;->getClsType()Ljadx/core/dex/instructions/args/ArgType;
    ...
    invoke-virtual {p1}, Ljadx/core/dex/instructions/ConstStringNode;->getString()Ljava/lang/String;
...
.method public static indexToString(Ljava/lang/Object;)Ljava/lang/String;
    .registers 3
...
.method public static insnTypeToString(Ljadx/core/dex/instructions/InsnType;)Ljava/lang/String;
    .registers 2
