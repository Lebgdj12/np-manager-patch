...
.class public Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ;
.super Landroid/s/xo0;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ;->ۥ۟۟ۥ(Landroid/s/fp0;)Landroid/s/cp0;
.end annotation
...
.method public constructor <init>(Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ;Landroid/s/fp0;)V
    ...
    iput-object p1, p0, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ;->ۥ۟:Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ;

    invoke-direct {p0, p2}, Landroid/s/xo0;-><init>(Landroid/s/fp0;)V
    ...
    :sswitch_12
    sget-object p2, Lsun1/security/x509/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣⁠⁠⁣:[S
...
.method public bridge synthetic ۥ(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lorg/eclipse/tm4e/core/internal/types/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁤⁣⁤⁤⁣⁤⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁠⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)Landroid/s/gi0;
...
.method public ۥ۟(Landroid/s/gi0;)Landroid/s/gi0;
    ...
    :sswitch_f
    invoke-super {p0, p1}, Landroid/s/xo0;->ۥ۟(Landroid/s/gi0;)Landroid/s/gi0;
    ...
    invoke-static {p1}, Lorg/benf/cfr/reader/entities/classfilehelpers/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁣⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Lorg/jf/dexlib2/Opcode;

    move-result-object v2

    invoke-static {v2}, Lorg/jf/util/jcommander/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠;->⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁣⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Lorg/jf/dexlib2/Format;
    ...
    :sswitch_36
    new-instance v0, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ$ۥ;

    check-cast p1, Landroid/s/cj0;

    invoke-direct {v0, p0, p1}, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ$ۥ;-><init>(Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ;Landroid/s/cj0;)V
    ...
    instance-of v1, p1, Landroid/s/ki0;
    ...
    :sswitch_a2
    new-instance v0, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ$ۥ۟;

    check-cast p1, Landroid/s/pj0;

    invoke-direct {v0, p0, p1}, Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ$ۥ۟;-><init>(Lplayer/normal/np/util/apk/fancy/DexEditor$ۥ$ۥ۟۟ۡ;Landroid/s/pj0;)V
