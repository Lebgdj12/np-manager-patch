...
.class public Lplayer/normal/np/activity/ToolboxActivity$ۥ۟۟ۡ;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lplayer/normal/np/activity/ToolboxActivity$ۥ۟۟ۡ;->short:[S
...
.method public constructor <init>(Lplayer/normal/np/activity/ToolboxActivity;)V
    ...
    iput-object p1, p0, Lplayer/normal/np/activity/ToolboxActivity$ۥ۟۟ۡ;->ۥۡ۟ۥ:Lplayer/normal/np/activity/ToolboxActivity;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠()[S
    ...
    :sswitch_24
    sget-object v3, Lplayer/normal/np/activity/ToolboxActivity$ۥ۟۟ۡ;->short:[S
...
.method public onClick(Landroid/view/View;)V
    ...
    const-string v20, "ۣۧۨ"

    const-string v21, "ۥۣۨ"

    const-string v22, "ۦۣ۟"

    const-string v23, "۟۠ۢ"

    const-string v24, "ۢۢ۠"

    const-string v25, "ۥۧۥ"

    const-string v26, "ۣ۟۠"
    ...
    move-result v3
    :try_end_41
    .catch Ljava/lang/Exception; {:try_start_3d .. :try_end_41} :catch_ce
    .catchall {:try_start_3d .. :try_end_41} :catchall_c7
    ...
    :try_end_5f
    .catch Ljava/lang/Exception; {:try_start_48 .. :try_end_5f} :catch_ce
    .catchall {:try_start_48 .. :try_end_5f} :catchall_c7
    ...
    :try_end_72
    .catch Ljava/lang/Exception; {:try_start_6f .. :try_end_72} :catch_ce
    .catchall {:try_start_6f .. :try_end_72} :catchall_c7
    ...
    .catchall {:try_start_84 .. :try_end_8b} :catchall_c7
    ...
    :try_end_b9
    .catch Ljava/lang/Exception; {:try_start_b2 .. :try_end_b9} :catch_ce
    .catchall {:try_start_b2 .. :try_end_b9} :catchall_c7
    ...
    :try_start_e7
    invoke-static {v7, v3, v12, v0}, Lorg/apache/commons/lang3/arch/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁠⁤⁠⁤⁠([SIII)Ljava/lang/String;

    move-result-object v0

    invoke-static {v2, v0}, Lorg/eclipse/tm4e/core/registry/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-static/range {p0 .. p0}, Lorg/eclipse/tm4e/core/internal/parser/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁤⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤⁣⁤⁠⁠⁠(Ljava/lang/Object;)Lplayer/normal/np/activity/ToolboxActivity;

    move-result-object v5
    :try_end_f2
    .catch Ljava/lang/Exception; {:try_start_e7 .. :try_end_f2} :catch_366
    .catchall {:try_start_e7 .. :try_end_f2} :catchall_350
    ...
    :try_end_175
    .catch Ljava/lang/Exception; {:try_start_16a .. :try_end_175} :catch_366
    .catchall {:try_start_16a .. :try_end_175} :catchall_350
    ...
    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V
    :try_end_1cc
    .catch Ljava/lang/Exception; {:try_start_1c7 .. :try_end_1cc} :catch_366
    .catchall {:try_start_1c7 .. :try_end_1cc} :catchall_350
    ...
    invoke-static {v0}, Lplayer/normal/np/activity/ToolboxActivity$ۥ۟۟ۡ;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)I

    move-result v15
    :try_end_1ed
    .catch Ljava/lang/Exception; {:try_start_1e5 .. :try_end_1ed} :catch_366
    .catchall {:try_start_1e5 .. :try_end_1ed} :catchall_350
    ...
    move-result v18
    :try_end_207
    .catch Ljava/lang/Exception; {:try_start_1ff .. :try_end_207} :catch_366
    .catchall {:try_start_1ff .. :try_end_207} :catchall_350
    ...
    :try_end_234
    .catch Ljava/lang/Exception; {:try_start_230 .. :try_end_234} :catch_366
    .catchall {:try_start_230 .. :try_end_234} :catchall_350
    ...
    :try_start_269
    invoke-static {v5, v0}, Lorg/antlr/runtime/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁣⁣⁤⁠⁠⁤(Ljava/lang/Object;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {v2, v0}, Lorg/eclipse/tm4e/core/registry/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/StringBuilder;
    :try_end_270
    .catch Ljava/lang/Exception; {:try_start_269 .. :try_end_270} :catch_366
    .catchall {:try_start_269 .. :try_end_270} :catchall_350
    ...
    :try_end_2b2
    .catchall {:try_start_2a7 .. :try_end_2b2} :catchall_350
    ...
    move-result-object v0
    :try_end_2d6
    .catch Ljava/lang/Exception; {:try_start_2c7 .. :try_end_2d6} :catch_366
    .catchall {:try_start_2c7 .. :try_end_2d6} :catchall_350
    ...
    invoke-static {}, Lplayer/normal/np/activity/ToolboxActivity$ۥ۟۟ۡ;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠()[S

    move-result-object v7
    :try_end_316
    .catch Ljava/lang/Exception; {:try_start_30b .. :try_end_316} :catch_366
    .catchall {:try_start_30b .. :try_end_316} :catchall_350
    ...
    move-result v16
    :try_end_339
    .catch Ljava/lang/Exception; {:try_start_32f .. :try_end_339} :catch_366
    .catchall {:try_start_32f .. :try_end_339} :catchall_350

    invoke-static {}, Ljavax/xml/namespace/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠;->⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁠⁣⁣()I

    move-result v0

    const-string v26, "ۥۧۡ"
    ...
    :cond_34a
    :goto_34a
    invoke-static/range {v26 .. v26}, Lorg/benf/cfr/reader/bytecode/analysis/parse/lvalue/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁤⁠⁤⁠;->⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    .sparse-switch
        ...
        0xdc81 -> :sswitch_2ec
        0xdc9f -> :sswitch_2c4
        0x1aa6ff -> :sswitch_2a4
        0x1aa71f -> :sswitch_28a
        0x1aa721 -> :sswitch_280
        0x1aa726 -> :sswitch_25f
        0x1aa7fa -> :sswitch_25e
        0x1aab7d -> :sswitch_23f
        0x1aab9b -> :sswitch_22d
        0x1aaea6 -> :sswitch_213
        0x1aaf01 -> :sswitch_1fc
        0x1aaf61 -> :sswitch_1e2
        0x1ab283 -> :sswitch_1c4
        0x1ab2a0 -> :sswitch_1a1
        0x1ab302 -> :sswitch_18c
        0x1ab604 -> :sswitch_167
        0x1ab62a -> :sswitch_158
        0x1ab6bd -> :sswitch_137
        0x1abe09 -> :sswitch_11d
        0x1abe63 -> :sswitch_107
        0x1abe7f -> :sswitch_d6
        0x1abe83 -> :sswitch_d5
        0x1abea0 -> :sswitch_b2
        0x1ac18a -> :sswitch_9e
        ...
        0x1ac508 -> :sswitch_6a
        0x1ac622 -> :sswitch_4f
        0x1ac946 -> :sswitch_158
        0x1ac9a4 -> :sswitch_48
        0x1ac9e6 -> :sswitch_3d
        0x1ac9e7 -> :sswitch_107
    .end sparse-switch
.end method
