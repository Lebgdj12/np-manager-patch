...
.method public static ⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Landroid/s/y0;->ۥ۟۠ۨ(Landroid/s/jh0;)Ljava/lang/String;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lplayer/normal/np/fragMent/PdfRendererBasicFragment;->ۥ۟۠۟(Landroid/content/Context;)V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁠⁠⁠(Ljava/lang/Object;)Ljava/util/Map;
    ...
    iget-object v1, p0, Landroid/s/ۦۨۥۤ;->ۥ۟:Ljava/util/Map;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁠⁤⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Landroid/s/p;->ۥ۟۟۟(I)Ljava/lang/String;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Landroid/app/Activity;
    ...
    iget-object v1, p0, Landroid/s/ea1;->ۥ:Landroid/app/Activity;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)Landroid/widget/TextView;
    ...
    invoke-static {p0}, Landroid/s/b41;->ۥ۟۠ۥ(Landroid/s/b41;)Landroid/widget/TextView;
...
.method public static ⁣⁣⁤⁤⁣⁠⁤⁤⁠⁤⁤(Ljava/lang/Object;)Landroid/s/ۦۧۨۥ;
    .registers 2
    ...
    invoke-static/range {p0 .. p0}, Landroid/s/ۦۧۨۥ;->ۥ۟(Ljava/io/InputStream;)Landroid/s/ۦۧۨۥ;
...
.method public static ⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁠⁣⁣(Ljava/lang/Object;)Landroid/widget/CheckBox;
    ...
    iget-object v1, p0, Landroid/s/o51;->ۥ۟۟ۤ:Landroid/widget/CheckBox;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    check-cast p0, Landroid/s/p31$ۥ۟۟۟;

    check-cast p2, Landroid/view/View;

    invoke-interface {p0, p1, p2}, Landroid/s/p31$ۥ۟۟۟;->ۥ(ILandroid/view/View;)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁠⁣⁣(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Landroid/s/oh0;
    ...
    check-cast p2, Landroid/s/oh0;

    invoke-virtual {p0, p1, p2}, Landroid/s/x3;->ۥ۟۠ۨ(Ljava/lang/String;Landroid/s/oh0;)Landroid/s/oh0;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroid/s/i5;->ۥ۟۟ۧ(Ljava/lang/String;)Z
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Landroid/s/r0;->ۥ۟۟ۡ()V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁠⁣⁣(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Landroid/s/l41;->ۥ۟۠ۢ(Ljava/util/List;)Ljava/util/List;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣⁠⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)Landroid/s/jh0;
    ...
    invoke-static {p0, p1}, Landroid/s/a7;->ۥ(Landroid/s/jh0;Ljava/lang/String;)Landroid/s/jh0;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠⁣⁤⁠⁠⁣(Ljava/lang/Object;)Landroid/widget/Button;
    ...
    check-cast p0, Lplayer/normal/np/fragMent/DialogFileTranscoding;

    iget-object v1, p0, Lplayer/normal/np/fragMent/DialogFileTranscoding;->ۥ۟۟ۡ:Landroid/widget/Button;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/widget/EditText;
    ...
    iget-object v1, p0, Landroid/s/j61$ۥ۟ۡ۠;->ۥۡ۟ۥ:Landroid/widget/EditText;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁤⁠⁤⁣⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)S
    ...
    iget-short v1, p0, Landroid/s/ۦۨ۟۠;->ۥ۟۠ۦ:S
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Landroid/s/ۦۨۦۢ;->ۥۣ۟۟(Ljava/io/File;Landroid/s/t2;)Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Landroid/widget/Button;
    ...
    iget-object v1, p0, Lplayer/normal/np/fragMent/DialogPdf;->ۥ۟۟ۨ:Landroid/widget/Button;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁤⁠⁠⁣(Ljava/lang/Object;)F
    ...
    iget v1, p0, Lplayer/normal/np/fragMent/NPMeasureView;->ۥۡ۠ۨ:F
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁤⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Landroid/s/j61;
    ...
    check-cast p0, Landroid/s/j61$ۥ۟۟ۥ;

    iget-object v1, p0, Landroid/s/j61$ۥ۟۟ۥ;->ۥ:Landroid/s/j61;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    iget-object v1, p0, Landroid/s/we1$ۥ۟۟۠;->ۥۡ۟ۥ:Landroid/content/Context;
...
.method public static ⁤⁠⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁣()Lorg/jf/dexlib2/AccessFlags;
    ...
    sget-object v0, Lorg/jf/dexlib2/AccessFlags;->ENUM:Lorg/jf/dexlib2/AccessFlags;
...
.method public static ⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    iget v1, p0, Landroid/s/p41;->ۥ۟۠۠:I
...
.method public static ⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁤⁤⁠⁤⁤(Ljava/lang/Object;)Lplayer/normal/np/fragMent/NPMeasureView;
    ...
    invoke-static {p0}, Lplayer/normal/np/service/NPMeasureService;->ۥ۟(Lplayer/normal/np/service/NPMeasureService;)Lplayer/normal/np/fragMent/NPMeasureView;
