...
# interfaces
.implements Landroid/s/ۦۦۣ۟;
.implements Landroid/s/ۦۦۥۦ;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/CallableReference;->getOwner()Landroid/s/ۦۦۥۥ;

    move-result-object v1

    invoke-virtual {p1}, Lkotlin/jvm/internal/CallableReference;->getOwner()Landroid/s/ۦۦۥۥ;
    ...
    .line 4
    :cond_52
    instance-of v0, p1, Landroid/s/ۦۦۥۦ;
...
.method public isExternal()Z
    ...
    .line 1
    invoke-virtual {p0}, Lkotlin/jvm/internal/FunctionReference;->ۥ۟۟()Landroid/s/ۦۦۥۦ;

    move-result-object v0

    invoke-interface {v0}, Landroid/s/ۦۦۥۦ;->isExternal()Z
...
.method public isInfix()Z
    ...
    invoke-interface {v0}, Landroid/s/ۦۦۥۦ;->isInfix()Z
...
.method public isInline()Z
    ...
    invoke-interface {v0}, Landroid/s/ۦۦۥۦ;->isInline()Z
...
.method public isOperator()Z
    ...
    invoke-interface {v0}, Landroid/s/ۦۦۥۦ;->isOperator()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Landroid/s/ۦۦۥۦ;->isSuspend()Z
...
.method public ۥ()Landroid/s/ۦۦۥۣ;
    ...
    .line 1
    invoke-static {p0}, Landroid/s/ۦۦۣۣ;->ۥ(Lkotlin/jvm/internal/FunctionReference;)Landroid/s/ۦۦۥۦ;
...
.method public bridge synthetic ۥ۟()Landroid/s/ۦۦۥۣ;
    .registers 2
...
.method public ۥ۟۟()Landroid/s/ۦۦۥۦ;
    .registers 2
    .annotation build Lkotlin/SinceKotlin;
        version = "1.1"
    .end annotation
    ...
    .line 1
    invoke-super {p0}, Lkotlin/jvm/internal/CallableReference;->ۥ۟()Landroid/s/ۦۦۥۣ;

    move-result-object v0

    check-cast v0, Landroid/s/ۦۦۥۦ;
