...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;

    const-string v3, "ISOLATED_STABLE_IDS"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;->ISOLATED_STABLE_IDS:Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;

    .line 3
    new-instance v3, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;

    const-string v5, "SHARED_STABLE_IDS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;->SHARED_STABLE_IDS:Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;

    const/4 v5, 0x3

    new-array v5, v5, [Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;
    ...
    .line 4
    sput-object v5, Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;->$VALUES:[Landroidx/recyclerview/widget/MergeAdapter$Config$StableIdMode;
