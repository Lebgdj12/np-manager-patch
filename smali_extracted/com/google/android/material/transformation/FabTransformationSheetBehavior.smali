...
# virtual methods
.method public onCreateMotionSpec(Landroid/content/Context;Z)Lcom/google/android/material/transformation/FabTransformationBehavior$ۥ۟۟۠;
    .registers 5
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 3
    :goto_7
    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$ۥ۟۟۠;

    invoke-direct {v0}, Lcom/google/android/material/transformation/FabTransformationBehavior$ۥ۟۟۠;-><init>()V

    .line 4
    invoke-static {p1, p2}, Landroid/s/ۥۡۥۦ;->ۥ۟۟۟(Landroid/content/Context;I)Landroid/s/ۥۡۥۦ;

    move-result-object p1

    iput-object p1, v0, Lcom/google/android/material/transformation/FabTransformationBehavior$ۥ۟۟۠;->ۥ:Landroid/s/ۥۡۥۦ;

    .line 5
    new-instance p1, Landroid/s/ۥۡۥۨ;

    const/16 p2, 0x11

    const/4 v1, 0x0

    invoke-direct {p1, p2, v1, v1}, Landroid/s/ۥۡۥۨ;-><init>(IFF)V

    iput-object p1, v0, Lcom/google/android/material/transformation/FabTransformationBehavior$ۥ۟۟۠;->ۥ۟:Landroid/s/ۥۡۥۨ;
