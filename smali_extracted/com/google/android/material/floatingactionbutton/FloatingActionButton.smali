...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟;,
        Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟۟;,
        Lcom/google/android/material/floatingactionbutton/FloatingActionButton$BaseBehavior;,
        Lcom/google/android/material/floatingactionbutton/FloatingActionButton$Behavior;,
        Lcom/google/android/material/floatingactionbutton/FloatingActionButton$Size;,
        Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;
    }
.end annotation
...
.field private final expandableWidgetHelper:Landroid/s/ۥۡۨۢ;
...
.field private impl:Landroid/s/ۥۡۨۦ;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, p3, v6}, Landroid/s/ۥۢۤۦ;->ۥ۟۟(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    .line 10
    invoke-static {p1, v0, v1}, Landroid/s/ۥۢۡۡ;->ۥ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 13
    invoke-static {v1, v3}, Landroid/s/ۥۢ۠;->ۥ۟۟ۤ(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 29
    invoke-static {p1, v0, v5}, Landroid/s/ۥۡۥۦ;->ۥ۟۟(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/s/ۥۡۥۦ;
    ...
    .line 31
    invoke-static {p1, v0, v8}, Landroid/s/ۥۡۥۦ;->ۥ۟۟(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/s/ۥۡۥۦ;

    move-result-object v8

    .line 32
    sget-object v9, Landroid/s/ۥۢۢۨ;->ۥ:Landroid/s/ۥۢۢ۟;

    .line 33
    invoke-static {p1, p2, p3, v6, v9}, Landroid/s/ۥۢۢۨ;->ۥ۟۟ۢ(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/s/ۥۢۢ۟;)Landroid/s/ۥۢۢۨ$ۥ۟;
    ...
    .line 41
    new-instance p2, Landroid/s/ۥۡۨۢ;

    invoke-direct {p2, p0}, Landroid/s/ۥۡۨۢ;-><init>(Landroid/s/ۥۡۨۡ;)V

    iput-object p2, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->expandableWidgetHelper:Landroid/s/ۥۡۨۢ;

    .line 42
    invoke-direct {p0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->getImpl()Landroid/s/ۥۡۨۦ;

    move-result-object p2

    invoke-virtual {p2, p1}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۤ(Landroid/s/ۥۢۢۨ;)V
    ...
    .line 44
    invoke-virtual {p1, p2, p3, v0, v7}, Landroid/s/ۥۡۨۦ;->ۥ۟۠ۨ(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    invoke-virtual {p1, v4}, Landroid/s/ۥۡۨۦ;->ۥۣ۟۠(I)V
    ...
    invoke-virtual {p1, v1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۥ(F)V
    ...
    invoke-virtual {p1, v3}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۨ(F)V
    ...
    invoke-virtual {p1, v2}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۡ(F)V
    ...
    invoke-virtual {p1, p2}, Landroid/s/ۥۡۨۦ;->ۥۣ۟۟(I)V
    ...
    invoke-virtual {p1, v5}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۥ(Landroid/s/ۥۡۥۦ;)V
    ...
    invoke-virtual {p1, v8}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۧ(Landroid/s/ۥۡۥۦ;)V
    ...
    invoke-virtual {p1, v6}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۦ(Z)V
...
.method private createImpl()Landroid/s/ۥۡۨۦ;
    .registers 3
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 2
    new-instance v0, Landroid/s/ۥۡۨۧ;

    new-instance v1, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟;

    invoke-direct {v1, p0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;)V

    invoke-direct {v0, p0, v1}, Landroid/s/ۥۡۨۧ;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;Landroid/s/ۥۢۡۧ;)V

    return-object v0

    .line 3
    :cond_11
    new-instance v0, Landroid/s/ۥۡۨۦ;

    new-instance v1, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟;

    invoke-direct {v1, p0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;)V

    invoke-direct {v0, p0, v1}, Landroid/s/ۥۡۨۦ;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;Landroid/s/ۥۢۡۧ;)V

    return-object v0
.end method

.method private getImpl()Landroid/s/ۥۡۨۦ;
    .registers 2

    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->impl:Landroid/s/ۥۡۨۦ;

    if-nez v0, :cond_a

    .line 2
    invoke-direct {p0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->createImpl()Landroid/s/ۥۡۨۦ;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->impl:Landroid/s/ۥۡۨۦ;
...
.method private wrapOnVisibilityChangedListener(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)Landroid/s/ۥۡۨۦ$ۥ۟۟ۥ;
    .registers 3
    .param p1  # Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/Nullable;
    ...
    .line 1
    :cond_4
    new-instance v0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ;

    invoke-direct {v0, p0, p1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)V
...
.method public addOnHideAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟۟۟(Landroid/animation/Animator$AnimatorListener;)V
...
.method public addOnShowAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟۟۠(Landroid/animation/Animator$AnimatorListener;)V

    return-void
.end method

.method public addTransformationCallback(Landroid/s/ۥۡۦ;)V
    .registers 4
    .param p1  # Landroid/s/ۥۡۦ;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    new-instance v1, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟۟;

    invoke-direct {v1, p0, p1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟۟۟;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;Landroid/s/ۥۡۦ;)V

    invoke-virtual {v0, v1}, Landroid/s/ۥۡۨۦ;->ۥ۟۟ۡ(Landroid/s/ۥۡۨۦ$ۥ۟۟ۤ;)V
...
.method public drawableStateChanged()V
    ...
    invoke-virtual {v0, v1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡۤ([I)V
...
.method public getCompatElevation()F
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠()F
...
.method public getCompatHoveredFocusedTranslationZ()F
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠ۡ()F
...
.method public getCompatPressedTranslationZ()F
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠ۤ()F
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۟ۦ()Landroid/graphics/drawable/Drawable;
...
.method public getExpandedComponentIdHint()I
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->expandableWidgetHelper:Landroid/s/ۥۡۨۢ;

    invoke-virtual {v0}, Landroid/s/ۥۡۨۢ;->ۥ۟()I
...
.method public getHideMotionSpec()Landroid/s/ۥۡۥۦ;
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠۠()Landroid/s/ۥۡۥۦ;
...
.method public getShapeAppearanceModel()Landroid/s/ۥۢۢۨ;
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠ۥ()Landroid/s/ۥۢۢۨ;
...
.method public getShowMotionSpec()Landroid/s/ۥۡۥۦ;
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠ۦ()Landroid/s/ۥۡۥۦ;
...
.method public hide()V
    ...
    .line 1
    invoke-virtual {p0, v0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->hide(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)V

    return-void
.end method

.method public hide(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)V
    .registers 3
    .param p1  # Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 2
    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->hide(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;Z)V

    return-void
.end method

.method public hide(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;Z)V
    .registers 4
    .param p1  # Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct {p0, p1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->wrapOnVisibilityChangedListener(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)Landroid/s/ۥۡۨۦ$ۥ۟۟ۥ;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Landroid/s/ۥۡۨۦ;->ۥ۟۠ۧ(Landroid/s/ۥۡۨۦ$ۥ۟۟ۥ;Z)V
...
.method public isExpanded()Z
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۢ;->ۥ۟۟()Z
...
.method public isOrWillBeHidden()Z
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡ()Z
...
.method public isOrWillBeShown()Z
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡ۟()Z
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡ۠()V
...
.method public onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡۡ()V
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۡ()V
...
.method public onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۤۡ()V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 7
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۢ;->ۥ۟۟۟(Landroid/os/Bundle;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->expandableWidgetHelper:Landroid/s/ۥۡۨۢ;

    .line 5
    invoke-virtual {v2}, Landroid/s/ۥۡۨۢ;->ۥ۟۟۠()Landroid/os/Bundle;
...
.method public removeOnHideAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢ۟(Landroid/animation/Animator$AnimatorListener;)V
...
.method public removeOnShowAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢ۠(Landroid/animation/Animator$AnimatorListener;)V

    return-void
.end method

.method public removeTransformationCallback(Landroid/s/ۥۡۦ;)V
    .registers 4
    .param p1  # Landroid/s/ۥۡۦ;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, v1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۡ(Landroid/s/ۥۡۨۦ$ۥ۟۟ۤ;)V
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۢ(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۤ(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCompatElevation(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۥ(F)V
...
.method public setCompatHoveredFocusedTranslationZ(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۨ(F)V
...
.method public setCompatPressedTranslationZ(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۡ(F)V
...
.method public setEnsureMinTouchTargetSize(Z)V
    ...
    invoke-virtual {v0}, Landroid/s/ۥۡۨۦ;->ۥ۟۠۟()Z
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۦ(Z)V
...
.method public setExpanded(Z)Z
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۢ;->ۥ۟۟ۡ(Z)Z
...
.method public setExpandedComponentIdHint(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۢ;->ۥ۟۟ۢ(I)V
...
.method public setHideMotionSpec(Landroid/s/ۥۡۥۦ;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢۧ(Landroid/s/ۥۡۥۦ;)V
...
.method public setHideMotionSpecResource(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->setHideMotionSpec(Landroid/s/ۥۡۥۦ;)V
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۤ۠()V
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1, v0}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۢ(Landroid/content/res/ColorStateList;)V
...
.method public setScaleX(F)V
    ...
    invoke-virtual {p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡۨ()V
...
.method public setShadowPaddingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥۣۣ۟(Z)V
...
.method public setShapeAppearanceModel(Landroid/s/ۥۢۢۨ;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۤ(Landroid/s/ۥۢۢۨ;)V
...
.method public setShowMotionSpec(Landroid/s/ۥۡۥۦ;)V
    ...
    invoke-virtual {v0, p1}, Landroid/s/ۥۡۨۦ;->ۥۣ۟ۥ(Landroid/s/ۥۡۥۦ;)V
...
.method public setShowMotionSpecResource(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->setShowMotionSpec(Landroid/s/ۥۡۥۦ;)V
...
.method public setTranslationX(F)V
    ...
    invoke-virtual {p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۢ()V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-virtual {p1}, Landroid/s/ۥۡۨۦ;->ۥ۟ۡۢ()V
...
.method public show()V
    ...
    .line 1
    invoke-virtual {p0, v0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->show(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)V

    return-void
.end method

.method public show(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;)V
    .registers 3
    .param p1  # Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 2
    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->show(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;Z)V

    return-void
.end method

.method public show(Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;Z)V
    .registers 4
    .param p1  # Lcom/google/android/material/floatingactionbutton/FloatingActionButton$ۥ۟;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2}, Landroid/s/ۥۡۨۦ;->ۥ۟ۤ(Landroid/s/ۥۡۨۦ$ۥ۟۟ۥ;Z)V
