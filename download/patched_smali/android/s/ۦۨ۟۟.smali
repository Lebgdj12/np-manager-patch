...
.method public constructor <init>(Landroid/s/ۦۨ۟۟;)V
    ...
    invoke-static {p1}, Lorg/jf/smali/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)S

    move-result v1

    iput-short v1, p0, Landroid/s/ۦۨ۟۟;->ۥ۟۟:S
    ...
    iput-short v1, p0, Landroid/s/ۦۨ۟۟;->ۥ:S
    ...
    iput v1, p0, Landroid/s/ۦۨ۟۟;->ۥ۟:I
...
.method public constructor <init>(SSI)V
    ...
    :sswitch_15
    iput-short p2, p0, Landroid/s/ۦۨ۟۟;->ۥ:S
    ...
    :sswitch_2f
    const-string v1, "ikGqolwn2AYOkt"
    ...
    :sswitch_4c
    iput p3, p0, Landroid/s/ۦۨ۟۟;->ۥ۟:I
    ...
    iput-short p1, p0, Landroid/s/ۦۨ۟۟;->ۥ۟۟:S
...
.method public static ۥ۟(Landroid/s/r1;)Landroid/s/ۦۨ۟۟;
    .registers 7
    ...
    :sswitch_10
    :try_start_10
    invoke-static {p0}, Lorg/apache/xerces/parsers/⁤⁤⁠⁤⁤⁠⁣⁣⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁣⁤⁠⁤⁠(Ljava/lang/Object;)S

    move-result v3
    :try_end_14
    .catch Ljava/io/EOFException; {:try_start_10 .. :try_end_14} :catch_15

    goto :goto_37

    :catch_15
    new-instance p0, Landroid/s/ۦۨ۟۟;

    const/4 v0, -0x1

    invoke-direct {p0, v0, v2, v2}, Landroid/s/ۦۨ۟۟;-><init>(SSI)V
    ...
    :sswitch_53
    new-instance v0, Landroid/s/ۦۨ۟۟;
    ...
    invoke-direct {v0, v3, v1, p0}, Landroid/s/ۦۨ۟۟;-><init>(SSI)V
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/config/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)Landroid/s/ۦۨ۟۟;
...
.method public ۥ()Landroid/s/ۦۨ۟۟;
    .registers 2

    new-instance v0, Landroid/s/ۦۨ۟۟;

    invoke-direct {v0, p0}, Landroid/s/ۦۨ۟۟;-><init>(Landroid/s/ۦۨ۟۟;)V
