...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/m31;->ۥ۟ۥۨ(Ljava/lang/String;)V
.end annotation
...
.method public constructor <init>(Landroid/s/m31;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Landroid/s/m31$ۥ;->ۥۡ۟ۦ:Landroid/s/m31;

    iput-object p2, p0, Landroid/s/m31$ۥ;->ۥۡ۟ۥ:Ljava/lang/String;
    ...
    :sswitch_16
    const-string p2, "ftMJq0O"

    invoke-static {p2}, Lorg/apache/commons/lang3/text/translate/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁣⁠⁠⁣⁤⁠⁤⁤(Ljava/lang/String;)Ljava/lang/String;
...
.method public run()V
    ...
    const-string v12, "ۣ۟ۡ"

    const-string v13, "ۡۦ"

    const-string v14, "ۢ۟ۧ"

    const-string v15, "۟ۤۢ"

    const-string v16, "ۧۦۨ"

    const-string v17, "ۢۦۣ"

    const-string v18, "ۦ۟ۤ"

    const-string v19, "۟ۧۦ"

    const-string v20, "۠ۢۥ"
    ...
    :sswitch_28
    invoke-static/range {p0 .. p0}, Lorg/jaxen/util/⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁠⁣⁣(Ljava/lang/Object;)Landroid/s/m31;
    ...
    move-result-object v0
    :try_end_7a
    .catch Ljava/lang/Exception; {:try_start_76 .. :try_end_7a} :catch_1df
    .catchall {:try_start_76 .. :try_end_7a} :catchall_1c6
    ...
    move-result-object v0
    :try_end_cd
    .catchall {:try_start_c9 .. :try_end_cd} :catchall_1c6
    ...
    invoke-static {v0}, Lorg/benf/cfr/reader/relationship/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁠⁠⁠⁣⁣⁤;->⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Ljava/util/Map;
    ...
    :try_end_118
    .catch Ljava/lang/Exception; {:try_start_106 .. :try_end_118} :catch_1df
    .catchall {:try_start_106 .. :try_end_118} :catchall_1c6
    ...
    invoke-static {v3, v0, v4, v11}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/op4rewriters/checker/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁠⁣⁤⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁤⁣⁤⁠⁠⁣(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :sswitch_17f
    :try_start_17f
    invoke-static {v2}, Lplayer/normal/np/util/apk/lspatch/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁣⁣⁠⁠⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Lio/github/rosemoe/sora/widget/CodeEditor;
    ...
    invoke-static {v0}, Lorg/apache/xmlgraphics/ps/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁣;->⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Ljava/util/Map;

    move-result-object v0

    iput-object v0, v2, Landroid/s/m31;->ۥ۟ۢۦ:Ljava/util/Map;
    :try_end_191
    .catch Ljava/lang/Exception; {:try_start_17f .. :try_end_191} :catch_1df
    .catchall {:try_start_17f .. :try_end_191} :catchall_1c6
    ...
    :sswitch_1a6
    :try_start_1a6
    invoke-static {v2}, Lorg/benf/cfr/reader/relationship/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁠⁠⁠⁣⁣⁤;->⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Ljava/util/Map;

    move-result-object v0
    :try_end_1aa
    .catch Ljava/lang/Exception; {:try_start_1a6 .. :try_end_1aa} :catch_1df
    .catchall {:try_start_1a6 .. :try_end_1aa} :catchall_1c6
    ...
    .sparse-switch
        ...
        0xdcdc -> :sswitch_17f
        0xdcf8 -> :sswitch_170
        0x1aa79d -> :sswitch_147
        0x1aa7fe -> :sswitch_12c
        0x1aab23 -> :sswitch_106
        0x1aab7d -> :sswitch_170
        0x1aabd8 -> :sswitch_f6
        0x1aaec1 -> :sswitch_e6
        0x1aaec4 -> :sswitch_d2
        0x1aaf9b -> :sswitch_1b2
        0x1ab24a -> :sswitch_c9
        0x1ab282 -> :sswitch_c8
        0x1ab31f -> :sswitch_c7
        0x1ab605 -> :sswitch_b8
