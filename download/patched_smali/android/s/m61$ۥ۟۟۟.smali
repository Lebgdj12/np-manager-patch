...
.class public Landroid/s/m61$ۥ۟۟۟;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/m61$ۥ۟۟۟;->short:[S
...
.method public constructor <init>(Landroid/s/m61;)V
    ...
    iput-object p1, p0, Landroid/s/m61$ۥ۟۟۟;->ۥۡ۟ۥ:Landroid/s/m61;
    ...
    :sswitch_45
    const-string v0, "U5UK9I1McKvA2vq6bgLGhReUO0DpG"
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁣()[S
    ...
    :sswitch_72
    sget-object v3, Landroid/s/m61$ۥ۟۟۟;->short:[S
...
.method public run()V
    ...
    const-string v20, "ۤۨۦ"

    const-string v21, "ۨۢ۟"

    const-string v22, "ۡۡۦ"

    const/16 v23, 0x2

    const/16 v24, 0x1

    const-string v25, "ۤ۠ۦ"
    ...
    :sswitch_34
    invoke-static/range {p0 .. p0}, Lorg/eclipse/jdt/internal/compiler/parser/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁤⁤⁣⁠⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/s/m61;
    ...
    :try_end_61
    .catchall {:try_start_52 .. :try_end_61} :catchall_d6
    ...
    invoke-static/range {v18 .. v18}, Lorg/apache/xmlgraphics/image/loader/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠⁤⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    :try_end_b1
    .catch Ljava/lang/Exception; {:try_start_ad .. :try_end_b1} :catch_e0
    .catchall {:try_start_ad .. :try_end_b1} :catchall_d6
    ...
    move-result v0
    :try_end_cf
    .catch Ljava/lang/Exception; {:try_start_c7 .. :try_end_cf} :catch_e0
    .catchall {:try_start_c7 .. :try_end_cf} :catchall_d6
    ...
    :try_end_e9
    .catch Ljava/lang/Exception; {:try_start_e7 .. :try_end_e9} :catch_13b
    .catchall {:try_start_e7 .. :try_end_e9} :catchall_134
    ...
    :try_start_10a
    invoke-static {v11, v12, v3, v1}, Lorg/apache/xerces/dom/events/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁣⁣⁣⁣⁣⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁠⁤⁠⁣⁤⁠⁠⁣([SIII)Ljava/lang/String;

    move-result-object v1
    :try_end_10e
    .catch Ljava/lang/Exception; {:try_start_10a .. :try_end_10e} :catch_12f
    .catchall {:try_start_10a .. :try_end_10e} :catchall_12a
    ...
    :try_end_115
    .catch Ljava/lang/Exception; {:try_start_10e .. :try_end_115} :catch_227
    .catchall {:try_start_10e .. :try_end_115} :catchall_220
    ...
    :try_start_167
    invoke-static {}, Landroid/s/m61$ۥ۟۟۟;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁤⁤⁣⁠⁠⁤⁠⁣()[S

    move-result-object v11
    :try_end_16b
    .catch Ljava/lang/Exception; {:try_start_167 .. :try_end_16b} :catch_227
    .catchall {:try_start_167 .. :try_end_16b} :catchall_220

    invoke-static/range {v19 .. v19}, Lorg/checkerframework/checker/propkey/qual/⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣⁠⁣⁣(Ljava/lang/Object;)I
    ...
    :try_end_182
    .catch Ljava/lang/Exception; {:try_start_17e .. :try_end_182} :catch_227
    .catchall {:try_start_17e .. :try_end_182} :catchall_220
    ...
    :try_start_1cd
    invoke-static {v6, v7, v0, v8}, Lsun/misc/⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁣⁣⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁣⁠⁣⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_1d0
    .catch Ljava/lang/Exception; {:try_start_1cd .. :try_end_1d0} :catch_227
    .catchall {:try_start_1cd .. :try_end_1d0} :catchall_220
    ...
    move-result v14
    :try_end_1ee
    .catch Ljava/lang/Exception; {:try_start_1e6 .. :try_end_1ee} :catch_227
    .catchall {:try_start_1e6 .. :try_end_1ee} :catchall_220
    ...
    new-instance v1, Landroid/s/m61$ۥ۟۟۟$ۥ;
    :try_end_20d
    .catch Ljava/lang/Exception; {:try_start_203 .. :try_end_20d} :catch_227
    .catchall {:try_start_203 .. :try_end_20d} :catchall_220

    move-object/from16 v3, p0

    :try_start_20f
    invoke-direct {v1, v3}, Landroid/s/m61$ۥ۟۟۟$ۥ;-><init>(Landroid/s/m61$ۥ۟۟۟;)V
    :try_end_212
    .catch Ljava/lang/Exception; {:try_start_20f .. :try_end_212} :catch_21e
    .catchall {:try_start_20f .. :try_end_212} :catchall_21c
    ...
    :goto_216
    invoke-static/range {v20 .. v20}, Lplayer/normal/np/listener/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁣⁠⁠⁣(Ljava/lang/Object;)I
    ...
    move-result-object v0
    :try_end_2b9
    .catch Ljava/lang/Exception; {:try_start_2b5 .. :try_end_2b9} :catch_2d7
    .catchall {:try_start_2b5 .. :try_end_2b9} :catchall_2c1

    const-string v22, "ۢۥۤ"
    ...
    .sparse-switch
        0xdc26 -> :sswitch_2ae
        0x1aa6ff -> :sswitch_297
        0x1aa740 -> :sswitch_27b
        0x1aa7fb -> :sswitch_252
        0x1aaae3 -> :sswitch_248
        0x1aab1d -> :sswitch_230
        0x1aaec6 -> :sswitch_22d
        0x1ab301 -> :sswitch_1ff
        0x1ab362 -> :sswitch_1e2
        0x1ab626 -> :sswitch_1be
        0x1ab680 -> :sswitch_1a7
        0x1ab6a6 -> :sswitch_230
        0x1ab6dc -> :sswitch_192
        0x1ab9ea -> :sswitch_17a
        0x1aba5f -> :sswitch_171
        0x1abac4 -> :sswitch_163
        0x1abae2 -> :sswitch_140
        0x1abe86 -> :sswitch_e7
        0x1ac165 -> :sswitch_c6
        0x1ac166 -> :sswitch_c5
        0x1ac18a -> :sswitch_ad
        0x1ac1e4 -> :sswitch_1a7
        0x1ac8cd -> :sswitch_82
        0x1ac925 -> :sswitch_72
        0x1ac9a1 -> :sswitch_52
        0x1ac9c6 -> :sswitch_34
