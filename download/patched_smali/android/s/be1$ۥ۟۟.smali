...
.class public Landroid/s/be1$ۥ۟۟;
...
.field public final ۥ۟۟:Landroid/s/be1;
...
.method public constructor <init>(Landroid/s/be1;Ljava/util/List;I)V
    .registers 5

    iput-object p1, p0, Landroid/s/be1$ۥ۟۟;->ۥ۟۟:Landroid/s/be1;

    iput-object p2, p0, Landroid/s/be1$ۥ۟۟;->ۥ:Ljava/util/List;

    iput p3, p0, Landroid/s/be1$ۥ۟۟;->ۥ۟:I
    ...
    :sswitch_3f
    const-string p2, "0YTmazfrfcTAPgo5SIz"
...
.method public ۥ۟()Ljava/util/Set;
    ...
    new-instance v0, Landroid/s/be1$ۥ۟۟$ۥ;

    invoke-direct {v0, p0}, Landroid/s/be1$ۥ۟۟$ۥ;-><init>(Landroid/s/be1$ۥ۟۟;)V
