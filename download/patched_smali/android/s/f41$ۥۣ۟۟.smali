...
.class public Landroid/s/f41$ۥۣ۟۟;
...
.method public constructor <init>(Landroid/s/f41;)V
    ...
    iput-object p1, p0, Landroid/s/f41$ۥۣ۟۟;->ۥۡ۟ۥ:Landroid/s/f41;
    ...
    :sswitch_41
    const-string v0, "0xToBm4yLhLgTAUz9hzQvUR3M"
...
.method public run()V
    ...
    const-string v10, "ۣۢۤ"

    const-string v11, "۠ۥۨ"
    ...
    :try_end_1e
    .catch Ljava/lang/Exception; {:try_start_1a .. :try_end_1e} :catch_d7
    ...
    invoke-static {v8}, Landroid2/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤;->⁠⁣⁤⁣⁤⁠⁠⁠⁣⁠⁠⁠(Ljava/lang/Object;)I
    ...
    :sswitch_4d
    :try_start_4d
    invoke-static {p0}, Lorg/checkerframework/checker/optional/qual/⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠;->⁣⁣⁣⁣⁣⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)Landroid/s/f41;
    ...
    move-result-object v1
    :try_end_55
    .catch Ljava/lang/Exception; {:try_start_4d .. :try_end_55} :catch_d7
    ...
    :sswitch_6e
    :try_start_6e
    new-instance v1, Landroid/s/f41$ۥۣ۟۟$ۥ;

    invoke-direct {v1, p0, v5}, Landroid/s/f41$ۥۣ۟۟$ۥ;-><init>(Landroid/s/f41$ۥۣ۟۟;Landroid/s/f5;)V
    :try_end_73
    .catch Ljava/lang/Exception; {:try_start_6e .. :try_end_73} :catch_d7
    ...
    invoke-static {v1}, Lsun1/security/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁣⁤⁠⁠⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Landroid/content/Context;

    move-result-object v1

    check-cast v1, Landroid/app/Activity;
    :try_end_89
    .catch Ljava/lang/Exception; {:try_start_7f .. :try_end_89} :catch_d7
    ...
    invoke-static {v7}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/op4rewriters/checker/⁠⁠⁠⁣⁣⁠⁠⁣⁤⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁣⁤⁤⁠⁤⁤(Ljava/lang/Object;)Landroid/s/ua1;
    ...
    :try_end_c3
    .catch Ljava/lang/Exception; {:try_start_ae .. :try_end_c3} :catch_d7
