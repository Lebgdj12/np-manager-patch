...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/cc1;->ۥ۟۟ۤ(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Landroid/s/cc1$ۥ;->ۥۡ۟ۥ:Ljava/lang/String;

    iput-object p2, p0, Landroid/s/cc1$ۥ;->ۥۡ۟ۦ:Ljava/lang/String;

    iput-object p3, p0, Landroid/s/cc1$ۥ;->ۥۡ۟ۧ:Landroid/content/Context;

    iput-object p4, p0, Landroid/s/cc1$ۥ;->ۥۡ۟ۨ:Ljava/lang/String;
    ...
    :sswitch_44
    const-string p2, "fVrNi3MGuhCLTH"
    ...
    :cond_5e
    :goto_5e
    invoke-static {p4}, Lorg/benf/cfr/reader/bytecode/analysis/parse/statement/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠⁤⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)I
...
.method public run()V
    ...
    const-string v13, "ۡ۟ۦ"

    const-string v14, "۠ۦ۠"
    ...
    invoke-static/range {p0 .. p0}, Lorg/dom4j/jaxb/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁠⁠⁠⁣⁣⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v10

    invoke-static {v0, v7, v9, v10}, Lnp/apkzlib/zip/compress/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_36
    .catchall {:try_start_23 .. :try_end_36} :catchall_b9
    ...
    invoke-static {v0, v2}, Lorg/jaxen/expr/iter/⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣⁠⁤⁣⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁠⁠⁣⁣(Ljava/lang/Object;Ljava/lang/Object;)[B

    move-result-object v3
    :try_end_5d
    .catch Ljava/lang/Exception; {:try_start_55 .. :try_end_5d} :catch_be
    .catchall {:try_start_55 .. :try_end_5d} :catchall_b9
    ...
    :try_end_83
    .catch Ljava/lang/Exception; {:try_start_7f .. :try_end_83} :catch_be
    .catchall {:try_start_7f .. :try_end_83} :catchall_b9
    ...
    :sswitch_99
    :try_start_99
    new-instance v0, Landroid/s/cc1$ۥ$ۥ;
    :try_end_9b
    .catch Ljava/lang/Exception; {:try_start_99 .. :try_end_9b} :catch_be
    .catchall {:try_start_99 .. :try_end_9b} :catchall_b9

    move-object/from16 v9, p0

    :try_start_9d
    invoke-direct {v0, v9}, Landroid/s/cc1$ۥ$ۥ;-><init>(Landroid/s/cc1$ۥ;)V
    :try_end_a0
    .catch Ljava/lang/Exception; {:try_start_9d .. :try_end_a0} :catch_157
    .catchall {:try_start_9d .. :try_end_a0} :catchall_141
    ...
    :try_start_137
    invoke-static {v2, v3, v4}, Lorg/jetbrains/annotations/⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_13a
    .catch Ljava/lang/Exception; {:try_start_137 .. :try_end_13a} :catch_157
    .catchall {:try_start_137 .. :try_end_13a} :catchall_141
    ...
    .sparse-switch
        0xdc41 -> :sswitch_16c
        0x1aa763 -> :sswitch_135
        0x1aa77d -> :sswitch_125
        0x1aa7c0 -> :sswitch_113
        0x1aab25 -> :sswitch_106
        0x1aab83 -> :sswitch_fe
        0x1aab9a -> :sswitch_fb
        0x1aae88 -> :sswitch_e8
        0x1aaf20 -> :sswitch_cf
        ...
        0x1ab264 -> :sswitch_99
        0x1ab269 -> :sswitch_7f
        0x1ab361 -> :sswitch_125
        0x1aba68 -> :sswitch_72
        0x1abac1 -> :sswitch_55
        0x1ac149 -> :sswitch_44
        0x1ac510 -> :sswitch_43
        0x1ac54b -> :sswitch_16c
        0x1ac98b -> :sswitch_23
    .end sparse-switch
.end method
