...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/g61;->ۥ(Ljava/lang/String;)V
.end annotation
...
.field public final ۥۡ۟ۦ:Landroid/s/g61;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/g61$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/g61;Ljava/lang/String;)V
    .registers 5

    iput-object p1, p0, Landroid/s/g61$ۥ;->ۥۡ۟ۦ:Landroid/s/g61;

    iput-object p2, p0, Landroid/s/g61$ۥ;->ۥۡ۟ۥ:Ljava/lang/String;
    ...
    :sswitch_14
    const-string p2, "Tyfa081qe"

    invoke-static {p2}, Lorg/benf/cfr/reader/util/annotation/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠⁤⁠⁤⁣;->⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤(Ljava/lang/String;)Ljava/lang/String;
    ...
    :sswitch_3f
    sget-object p2, Lorg/benf/cfr/reader/util/bytestream/⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁠⁣⁣:[S
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁣()[S
    ...
    :sswitch_3e
    sget-object v4, Landroid/s/g61$ۥ;->short:[S
...
.method public run()V
    ...
    const-string v18, "ۣۤۨ"

    const-string v19, "ۣۥ۠"

    const-string v20, "ۣۧۤ"

    const-string v21, "ۨ۠ۢ"

    const-string v22, "ۦۣۤ"

    const-string v23, "۠ۥۧ"

    const-string v24, "ۣۡۦ"
    ...
    :sswitch_33
    sget-object v0, Lorg/dom4j/rule/pattern/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁣⁣⁤⁠⁠⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠:[S
    ...
    :sswitch_48
    :try_start_48
    invoke-static {}, Landroid/s/g61$ۥ;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁣()[S

    move-result-object v0
    :try_end_4c
    .catch Ljava/lang/Exception; {:try_start_48 .. :try_end_4c} :catch_55
    .catchall {:try_start_48 .. :try_end_4c} :catchall_93
    ...
    :sswitch_6e
    :try_start_6e
    invoke-static/range {p0 .. p0}, Lorg/apache/xerces/impl/dv/xs/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁣⁠⁠⁠(Ljava/lang/Object;)Landroid/s/g61;

    move-result-object v0

    invoke-static {v0}, Lorg/apache/xerces/parsers/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/content/Context;
    ...
    :try_end_7d
    .catchall {:try_start_6e .. :try_end_7d} :catchall_93
    ...
    :try_end_c3
    .catch Ljava/lang/Exception; {:try_start_c1 .. :try_end_c3} :catch_107
    .catchall {:try_start_c1 .. :try_end_c3} :catchall_103
    ...
    :try_start_e4
    invoke-static {v11, v12, v3, v9}, Lnp/hook/⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁠⁣⁣;->⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣⁣⁠⁠⁤⁠⁣([SIII)Ljava/lang/String;

    move-result-object v3
    :try_end_e8
    .catch Ljava/lang/Exception; {:try_start_e4 .. :try_end_e8} :catch_101
    .catchall {:try_start_e4 .. :try_end_e8} :catchall_ff
    ...
    :try_end_ef
    .catch Ljava/lang/Exception; {:try_start_e8 .. :try_end_ef} :catch_13b
    .catchall {:try_start_e8 .. :try_end_ef} :catchall_135
    ...
    invoke-static {v0}, Lorg/benf/cfr/reader/bytecode/analysis/parse/expression/rewriteinterface/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁠⁣⁣⁠⁠⁣⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)Landroid/s/ua1;
    ...
    move-result-object v0
    :try_end_122
    .catch Ljava/lang/Exception; {:try_start_10f .. :try_end_122} :catch_13b
    .catchall {:try_start_10f .. :try_end_122} :catchall_135
    ...
    new-instance v3, Landroid/s/g61$ۥ$ۥ;
    :try_end_156
    .catch Ljava/lang/Exception; {:try_start_150 .. :try_end_156} :catch_187
    .catchall {:try_start_150 .. :try_end_156} :catchall_181

    move-object/from16 v9, p0

    :try_start_158
    invoke-direct {v3, v9}, Landroid/s/g61$ۥ$ۥ;-><init>(Landroid/s/g61$ۥ;)V
    :try_end_15b
    .catch Ljava/lang/Exception; {:try_start_158 .. :try_end_15b} :catch_17f
    .catchall {:try_start_158 .. :try_end_15b} :catchall_17d
    ...
    move-result v14
    :try_end_19c
    .catch Ljava/lang/Exception; {:try_start_194 .. :try_end_19c} :catch_24e
    .catchall {:try_start_194 .. :try_end_19c} :catchall_238
    ...
    :try_end_1b3
    .catch Ljava/lang/Exception; {:try_start_1a7 .. :try_end_1b3} :catch_24e
    .catchall {:try_start_1a7 .. :try_end_1b3} :catchall_238
    ...
    :try_start_205
    invoke-static {v5, v6, v3, v7}, Lsun/misc/⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁣⁣⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁣⁠⁣⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_208
    .catch Ljava/lang/Exception; {:try_start_205 .. :try_end_208} :catch_24e
    .catchall {:try_start_205 .. :try_end_208} :catchall_238
    ...
    move-result v13
    :try_end_226
    .catch Ljava/lang/Exception; {:try_start_21e .. :try_end_226} :catch_24e
    .catchall {:try_start_21e .. :try_end_226} :catchall_238
    ...
    :goto_2fb
    invoke-static/range {v18 .. v18}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁤⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁤⁤⁠⁤⁣(Ljava/lang/Object;)I
    ...
    .sparse-switch
        ...
        0xdbe2 -> :sswitch_300
        0xdcfb -> :sswitch_2e4
        0x1aab82 -> :sswitch_2e1
        0x1aaebf -> :sswitch_2c5
        0x1aaede -> :sswitch_2b2
        0x1aaeff -> :sswitch_27d
        0x1aaf06 -> :sswitch_264
        0x1aaf7c -> :sswitch_323
        0x1ab2fd -> :sswitch_217
        0x1ab625 -> :sswitch_1fe
        0x1ab644 -> :sswitch_1e6
        0x1ab648 -> :sswitch_1c5
        0x1ab6be -> :sswitch_1a0
        0x1ab722 -> :sswitch_18d
        0x1abadf -> :sswitch_14c
        0x1abda8 -> :sswitch_141
        0x1abe5e -> :sswitch_10b
        0x1abe84 -> :sswitch_c1
        0x1ac18b -> :sswitch_b8
        0x1ac1c7 -> :sswitch_9a
        0x1ac223 -> :sswitch_141
        0x1ac5a6 -> :sswitch_6e
        0x1ac5e4 -> :sswitch_5c
        0x1ac8ea -> :sswitch_5b
        0x1ac945 -> :sswitch_48
