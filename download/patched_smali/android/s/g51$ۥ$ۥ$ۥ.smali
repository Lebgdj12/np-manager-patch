...
.class public Landroid/s/g51$ۥ$ۥ$ۥ;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/g51$ۥ$ۥ;->run()V
.end annotation
...
.field public final ۥۡ۟ۦ:Landroid/s/g51$ۥ$ۥ;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/g51$ۥ$ۥ$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/g51$ۥ$ۥ;Landroid/s/f5;)V
    .registers 7

    iput-object p1, p0, Landroid/s/g51$ۥ$ۥ$ۥ;->ۥۡ۟ۦ:Landroid/s/g51$ۥ$ۥ;

    iput-object p2, p0, Landroid/s/g51$ۥ$ۥ$ۥ;->ۥۡ۟ۥ:Landroid/s/f5;
    ...
    :sswitch_32
    sget-object p2, Lplayer/normal/np/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁠⁣⁣⁠⁠⁣:[S
    ...
    :sswitch_5d
    const-string p2, "28uc"

    invoke-static {p2}, Lorg/apache/commons/logging/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁣⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁣⁣⁤⁠⁠⁣(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁣⁣⁣⁣⁣⁠()[S
    ...
    :sswitch_61
    sget-object v4, Landroid/s/g51$ۥ$ۥ$ۥ;->short:[S
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    const-string v21, "ۢۧۦ"

    const-string v22, "ۦۡۨ"

    const-string v23, "ۦۧ۠"

    const-string v24, "۠ۦۧ"
    ...
    :sswitch_51
    :try_start_51
    invoke-static/range {p0 .. p0}, Lorg/bouncycastle/jce/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁠⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁠⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/s/f5;

    move-result-object v6
    :try_end_55
    .catch Ljava/lang/Exception; {:try_start_51 .. :try_end_55} :catch_245
    ...
    invoke-static {}, Landroid/s/g51$ۥ$ۥ$ۥ;->⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁣⁣⁣⁣⁣⁠()[S

    move-result-object v5
    :try_end_8e
    .catch Ljava/lang/Exception; {:try_start_83 .. :try_end_8e} :catch_245
    ...
    :sswitch_a7
    :try_start_a7
    invoke-static/range {p0 .. p0}, Lorg/jaxen/function/ext/⁤⁤⁠⁤⁤⁤⁤⁠⁤⁣⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)Landroid/s/g51$ۥ$ۥ;

    move-result-object v0

    invoke-static {v0}, Lorg/jf/dexlib2/iface/reference/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁠⁠⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)Landroid/s/g51$ۥ;
    ...
    :try_end_b8
    .catch Ljava/lang/Exception; {:try_start_a7 .. :try_end_b8} :catch_245
    ...
    move-result v13
    :try_end_f1
    .catch Ljava/lang/Exception; {:try_start_e9 .. :try_end_f1} :catch_245
    ...
    invoke-static {v3}, Lorg/jf/dexlib2/iface/reference/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁠⁠⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)Landroid/s/g51$ۥ;

    move-result-object v3

    invoke-static {v3}, Lorg/apache/commons/lang3/text/translate/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁠⁣⁤⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁤⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Landroid/s/ua1;
    ...
    :try_end_157
    .catch Ljava/lang/Exception; {:try_start_142 .. :try_end_157} :catch_245
    ...
    invoke-static {v9, v0, v12}, Lorg/eclipse/tm4e/core/internal/parser/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Landroid/s/g51$ۥ$ۥ$ۥ;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁤⁠⁤⁤(Ljava/lang/Object;)I

    move-result v16
    :try_end_179
    .catch Ljava/lang/Exception; {:try_start_169 .. :try_end_179} :catch_245
    ...
    :sswitch_1a3
    :try_start_1a3
    invoke-static {v7}, Lorg/benf/cfr/reader/bytecode/analysis/structured/statement/placeholder/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0
    :try_end_1a7
    .catch Ljava/lang/Exception; {:try_start_1a3 .. :try_end_1a7} :catch_245
    ...
    :try_start_203
    invoke-static {v6}, Lorg/apache/commons/lang3/tuple/⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁠⁣⁣;->⁠⁠⁠⁣⁣⁣⁤⁠⁤⁤(Ljava/lang/Object;)[B
    ...
    :try_end_20b
    .catch Ljava/lang/Exception; {:try_start_203 .. :try_end_20b} :catch_245
    ...
    :try_end_236
    .catch Ljava/lang/Exception; {:try_start_22a .. :try_end_236} :catch_245
    ...
    :try_start_266
    invoke-static {v5, v1, v0, v3}, Lorg/jaxen/expr/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁣⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠⁣⁤⁣⁠⁣⁤⁣([SIII)Ljava/lang/String;
    ...
    move-result v14
    :try_end_285
    .catch Ljava/lang/Exception; {:try_start_27d .. :try_end_285} :catch_29a
    ...
    invoke-static {v3}, Lj$/util/concurrent/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁠⁣⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    .sparse-switch
        0xdbe5 -> :sswitch_27a
        0xdc25 -> :sswitch_24a
        0x1aa705 -> :sswitch_22a
        0x1aa721 -> :sswitch_201
        0x1aa7f7 -> :sswitch_1ea
        0x1aab9b -> :sswitch_21c
        0x1aaba1 -> :sswitch_1cd
        0x1aaea4 -> :sswitch_1be
        0x1aaf06 -> :sswitch_1a3
        0x1aaf5d -> :sswitch_18b
        0x1aaf99 -> :sswitch_171
        0x1aaf9f -> :sswitch_169
        0x1ab324 -> :sswitch_142
        0x1ab33c -> :sswitch_13a
        0x1ab341 -> :sswitch_124
        0x1ab343 -> :sswitch_117
        0x1ab35d -> :sswitch_106
        0x1ab641 -> :sswitch_105
        0x1ab684 -> :sswitch_e8
        0x1abdcb -> :sswitch_d7
        0x1abdea -> :sswitch_c9
        0x1ac18d -> :sswitch_a7
