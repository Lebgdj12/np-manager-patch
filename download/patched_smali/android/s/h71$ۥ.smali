...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/h71;->ۥ(Ljava/lang/String;Ljava/lang/String;II)V
.end annotation
...
.field public final ۥۡ۠:Landroid/s/h71;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/h71$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/h71;Ljava/lang/String;Ljava/lang/String;II)V
    .registers 6

    iput-object p1, p0, Landroid/s/h71$ۥ;->ۥۡ۠:Landroid/s/h71;

    iput-object p2, p0, Landroid/s/h71$ۥ;->ۥۡ۟ۥ:Ljava/lang/String;

    iput-object p3, p0, Landroid/s/h71$ۥ;->ۥۡ۟ۦ:Ljava/lang/String;

    iput p4, p0, Landroid/s/h71$ۥ;->ۥۡ۟ۧ:I

    iput p5, p0, Landroid/s/h71$ۥ;->ۥۡ۟ۨ:I
    ...
    :cond_49
    invoke-static {p5}, Lokhttp3/internal/connection/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)I
    ...
    :sswitch_4e
    const-string p2, "6df8nLI0EDErgcc"

    invoke-static {p2}, Lorg/benf/cfr/reader/entities/bootstrap/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁠⁣⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5f
    invoke-static {p4}, Lorg/checkerframework/common/value/qual/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁣⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)I
    ...
    :cond_74
    :goto_74
    invoke-static {p5}, Lokhttp3/internal/http1/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣⁠⁣⁤⁣⁤⁣;->⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁤⁤⁠⁤⁤(Ljava/lang/Object;)I
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁠⁠⁠⁣⁣⁣()[S
    ...
    :sswitch_32
    sget-object v4, Landroid/s/h71$ۥ;->short:[S
...
.method public run()V
    ...
    const-string v10, "ۢ۠۠"

    const-string v19, "ۤۥۣ"

    const-string v11, "ۣۡۤ"

    const-string v12, "ۥ۟ۤ"

    const-string v13, "ۣۨۨ"

    const/4 v14, 0x1

    const-string v20, "ۦ۟ۥ"
    ...
    move-result v16
    :try_end_39
    .catch Ljava/lang/Exception; {:try_start_31 .. :try_end_39} :catch_211
    .catchall {:try_start_31 .. :try_end_39} :catchall_1f8
    ...
    :sswitch_47
    :try_start_47
    invoke-static/range {p0 .. p0}, Lorg/benf/cfr/reader/api/⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤⁤⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Landroid/s/h71;
    ...
    :try_end_56
    .catchall {:try_start_47 .. :try_end_56} :catchall_1f8
    ...
    invoke-static {v0}, Ljavax/xml/validation/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁠⁤⁣⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;)Ljava/io/File;
    ...
    move-result-object v0
    :try_end_cb
    .catch Ljava/lang/Exception; {:try_start_bf .. :try_end_cb} :catch_211
    .catchall {:try_start_bf .. :try_end_cb} :catchall_1f8
    ...
    invoke-static/range {p0 .. p0}, Lorg/apache/xmlgraphics/ps/dsc/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁤⁤⁠⁤⁤;->⁣⁣⁤⁤⁣⁠⁤⁠⁤⁠(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v11

    invoke-static/range {p0 .. p0}, Lorg/jaxen/function/ext/⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁤⁠⁤⁠;->⁠⁤⁣⁠⁤⁣⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v12

    invoke-static/range {p0 .. p0}, Ljavax/xml/namespace/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁣⁠⁤⁣⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁠⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)I

    move-result v13

    invoke-static/range {p0 .. p0}, Ldifflib/⁤⁤⁠⁤⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠;->⁠⁠⁠⁣⁣⁤⁣⁤⁠⁠⁤(Ljava/lang/Object;)I

    move-result v14

    move-object v10, v15

    invoke-static/range {v9 .. v14}, Lorg/checkerframework/checker/units/qual/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁣⁠⁣⁤⁤⁤⁤⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;II)V
    :try_end_10c
    .catch Ljava/lang/Exception; {:try_start_ec .. :try_end_10c} :catch_211
    .catchall {:try_start_ec .. :try_end_10c} :catchall_1f8
    ...
    :goto_13f
    invoke-static {v11}, Lorg/apache/xerces/xni/grammars/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁤⁠⁤⁣⁣⁣⁤⁤⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)I
    ...
    move-result v17
    :try_end_14d
    .catch Ljava/lang/Exception; {:try_start_145 .. :try_end_14d} :catch_211
    .catchall {:try_start_145 .. :try_end_14d} :catchall_1f8
    ...
    :sswitch_171
    :try_start_171
    invoke-static {}, Landroid/s/h71$ۥ;->⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁠⁠⁠⁣⁣⁣()[S

    move-result-object v4
    :try_end_175
    .catch Ljava/lang/Exception; {:try_start_171 .. :try_end_175} :catch_211
    .catchall {:try_start_171 .. :try_end_175} :catchall_1f8
    ...
    :try_start_1dc
    invoke-static {v4, v3, v0, v9}, Lorg/antlr/runtime/⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁣⁣⁣⁣⁤⁤([SIII)Ljava/lang/String;
    ...
    :try_end_1e4
    .catch Ljava/lang/Exception; {:try_start_1dc .. :try_end_1e4} :catch_211
    .catchall {:try_start_1dc .. :try_end_1e4} :catchall_1f8
    ...
    :sswitch_data_22a
    .sparse-switch
        0x1aa703 -> :sswitch_1c4
        0x1aa721 -> :sswitch_1ad
        0x1aa763 -> :sswitch_19b
        0x1aa7dc -> :sswitch_187
        0x1aab40 -> :sswitch_171
        0x1aaf20 -> :sswitch_166
        0x1ab262 -> :sswitch_145
        0x1ab265 -> :sswitch_122
        0x1ab286 -> :sswitch_112
        0x1ab605 -> :sswitch_ec
        0x1ab6c3 -> :sswitch_187
        0x1ab6c5 -> :sswitch_dc
        0x1ab71a -> :sswitch_d6
        0x1ab721 -> :sswitch_d5
        0x1ab723 -> :sswitch_bf
