...
.class public Landroid/s/g51$ۥ$ۥ;
...
# instance fields
.field public final ۥۡ۟ۥ:Landroid/s/g51$ۥ;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/g51$ۥ$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/g51$ۥ;)V
    .registers 5

    iput-object p1, p0, Landroid/s/g51$ۥ$ۥ;->ۥۡ۟ۥ:Landroid/s/g51$ۥ;
    ...
    :sswitch_12
    const-string v0, "J1zCBO4OM2ZwRpwwa"

    invoke-static {v0}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/op4rewriters/checker/⁠⁠⁠⁣⁣⁠⁠⁣⁤⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣()[S
    ...
    :sswitch_3c
    sget-object v4, Landroid/s/g51$ۥ$ۥ;->short:[S
...
.method public run()V
    ...
    const-string v30, "ۤۡۢ"

    const-string v31, "ۡ۟۟"

    const-string v32, "ۤۡ۟"

    const-string v33, "ۦۧۡ"

    const-string v34, "۟ۢۨ"

    const-string v35, "ۣ۟۠"

    const/16 v36, 0x1

    const-string v37, "ۣۦۣ"

    sparse-switch v0, :sswitch_data_466
    ...
    invoke-static {v0}, Landroid/s/g51$ۥ$ۥ;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)I

    move-result v19
    :try_end_52
    .catch Ljava/lang/Exception; {:try_start_4a .. :try_end_52} :catch_eb
    .catchall {:try_start_4a .. :try_end_52} :catchall_e2
    ...
    const-string v0, "pAdu8R0KrydlwO1a8PHr6gY"
    ...
    invoke-static/range {p0 .. p0}, Lorg/jf/dexlib2/iface/reference/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁠⁠⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)Landroid/s/g51$ۥ;

    move-result-object v29

    invoke-static/range {v29 .. v29}, Lorg/apache/commons/lang3/text/translate/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁠⁣⁤⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁤⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Landroid/s/ua1;

    move-result-object v29

    invoke-static/range {v29 .. v29}, Lorg/bouncycastle/jcajce/provider/asymmetric/dstu/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣⁣⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v0, v3}, Ljava/io/File;-><init>(Ljava/lang/String;)V
    :try_end_9e
    .catch Ljava/lang/Exception; {:try_start_8d .. :try_end_9e} :catch_eb
    .catchall {:try_start_8d .. :try_end_9e} :catchall_e2
    ...
    invoke-static/range {v25 .. v25}, Lnp/x2a/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    move-result v24
    :try_end_bf
    .catch Ljava/lang/Exception; {:try_start_b7 .. :try_end_bf} :catch_eb
    .catchall {:try_start_b7 .. :try_end_bf} :catchall_e2
    ...
    :sswitch_d6
    :try_start_d6
    invoke-static/range {v16 .. v16}, Lorg/dom4j/dom/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁣⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v7
    :try_end_da
    .catch Ljava/lang/Exception; {:try_start_d6 .. :try_end_da} :catch_eb
    .catchall {:try_start_d6 .. :try_end_da} :catchall_e2
    ...
    :try_start_128
    invoke-static {v15, v7, v0, v3}, Lorg/benf/cfr/reader/state/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁣⁣⁣⁣⁣⁤⁤([SIII)Ljava/lang/String;

    move-result-object v0

    new-instance v3, Landroid/s/g51$ۥ$ۥ$ۥ;
    :try_end_12e
    .catch Ljava/lang/Exception; {:try_start_128 .. :try_end_12e} :catch_13e
    .catchall {:try_start_128 .. :try_end_12e} :catchall_139

    move-object/from16 v7, p0

    :try_start_130
    invoke-direct {v3, v7, v2}, Landroid/s/g51$ۥ$ۥ$ۥ;-><init>(Landroid/s/g51$ۥ$ۥ;Landroid/s/f5;)V
    :try_end_133
    .catch Ljava/lang/Exception; {:try_start_130 .. :try_end_133} :catch_370
    .catchall {:try_start_130 .. :try_end_133} :catchall_36b
    ...
    move-result v22
    :try_end_152
    .catch Ljava/lang/Exception; {:try_start_14a .. :try_end_152} :catch_370
    .catchall {:try_start_14a .. :try_end_152} :catchall_36b
    ...
    invoke-static/range {v27 .. v27}, Lokhttp3/internal/ws/⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v0}, Lj$/util/concurrent/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁠⁣⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    :try_end_1c3
    .catchall {:try_start_1b4 .. :try_end_1c3} :catchall_36b
    ...
    :try_start_1f2
    invoke-static {v8, v9, v10, v11, v12}, Lorg/dom4j/datatype/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤;->⁣⁤⁤⁣⁤⁤⁤⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_1f5
    .catch Ljava/lang/Exception; {:try_start_1f2 .. :try_end_1f5} :catch_370
    .catchall {:try_start_1f2 .. :try_end_1f5} :catchall_36b
    ...
    :cond_201
    invoke-static/range {v35 .. v35}, Lplayer/normal/np/util/apk/lspatch/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁠⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v0}, Lorg/apache/commons/lang3/text/translate/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁠⁣⁤⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁤⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Landroid/s/ua1;

    move-result-object v0

    invoke-static {v0}, Lsun1/security/x509/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Landroid/s/f5;

    move-result-object v0
    :try_end_217
    .catch Ljava/lang/Exception; {:try_start_20b .. :try_end_217} :catch_370
    .catchall {:try_start_20b .. :try_end_217} :catchall_36b
    ...
    :try_end_258
    .catch Ljava/lang/Exception; {:try_start_250 .. :try_end_258} :catch_370
    .catchall {:try_start_250 .. :try_end_258} :catchall_36b
    ...
    :try_end_2a3
    .catch Ljava/lang/Exception; {:try_start_29f .. :try_end_2a3} :catch_370
    .catchall {:try_start_29f .. :try_end_2a3} :catchall_36b
    ...
    :cond_30f
    invoke-static/range {v37 .. v37}, Lorg/benf/cfr/reader/bytecode/analysis/parse/wildcard/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁠⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)I
    ...
    :try_start_351
    invoke-static {}, Landroid/s/g51$ۥ$ۥ;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁣()[S

    move-result-object v15
    :try_end_355
    .catch Ljava/lang/Exception; {:try_start_351 .. :try_end_355} :catch_370
    .catchall {:try_start_351 .. :try_end_355} :catchall_36b
    ...
    move-result-object v0
    :try_end_380
    .catch Ljava/lang/Exception; {:try_start_37c .. :try_end_380} :catch_370
    .catchall {:try_start_37c .. :try_end_380} :catchall_36b

    const-string v33, "ۥ۠ۧ"

    move-object v13, v0

    :goto_383
    invoke-static/range {v33 .. v33}, Lorg/benf/cfr/reader/bytecode/analysis/opgraph/op2rewriters/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁠⁤⁠⁤⁣(Ljava/lang/Object;)I
    ...
    move-result v23
    :try_end_3f0
    .catch Ljava/lang/Exception; {:try_start_3e8 .. :try_end_3f0} :catch_3f6
    .catchall {:try_start_3e8 .. :try_end_3f0} :catchall_3f3

    const-string v31, "ۦۦ۟"
    ...
    move-result-object v0
    :try_end_41e
    .catch Ljava/lang/Exception; {:try_start_41a .. :try_end_41e} :catch_3f6
    .catchall {:try_start_41a .. :try_end_41e} :catchall_3f3
    ...
    .sparse-switch
        ...
        0xdcf7 -> :sswitch_3fa
        0xdcfd -> :sswitch_3e3
        0x1aa723 -> :sswitch_3bb
        0x1aa743 -> :sswitch_3a4
        0x1aa765 -> :sswitch_3a1
        0x1aa77c -> :sswitch_389
        0x1aa780 -> :sswitch_376
        0x1aa81e -> :sswitch_34d
        0x1aaac3 -> :sswitch_336
        0x1aab5e -> :sswitch_318
        0x1aae81 -> :sswitch_3fa
        0x1aaf5f -> :sswitch_300
        0x1ab268 -> :sswitch_2da
        0x1ab2a0 -> :sswitch_2d3
        0x1ab323 -> :sswitch_2b4
        0x1ab67f -> :sswitch_292
        0x1ab6a0 -> :sswitch_269
        0x1ab6e0 -> :sswitch_24c
        0x1ab9e7 -> :sswitch_228
        0x1aba02 -> :sswitch_207
        0x1aba05 -> :sswitch_1ee
        0x1abaa1 -> :sswitch_1dc
        0x1abadd -> :sswitch_1c5
        0x1abae4 -> :sswitch_1b0
        0x1abd89 -> :sswitch_1a7
        0x1abdac -> :sswitch_191
        0x1abe65 -> :sswitch_183
        0x1abe7f -> :sswitch_173
        0x1ac147 -> :sswitch_15e
        0x1ac14b -> :sswitch_146
        0x1ac184 -> :sswitch_143
        0x1ac21f -> :sswitch_10b
        0x1ac240 -> :sswitch_f5
        0x1ac246 -> :sswitch_d6
        0x1ac5e9 -> :sswitch_b7
        0x1ac601 -> :sswitch_8d
        0x1ac623 -> :sswitch_83
        0x1ac929 -> :sswitch_6a
        0x1ac92d -> :sswitch_3a4
        0x1ac944 -> :sswitch_4a
        0x1ac9e7 -> :sswitch_15e
    .end sparse-switch
.end method
