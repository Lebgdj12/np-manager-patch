...
.class public Landroid/s/sm0;
.super Landroid/s/xl0;

# interfaces
.implements Landroid/s/pj0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/sm0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public constructor <init>(Lorg/jf/dexlib2/Opcode;ILorg/jf/dexlib2/iface/reference/Reference;)V
    ...
    iput p2, p0, Landroid/s/sm0;->ۥ۟۟۟:I
    ...
    iput-object p1, p0, Landroid/s/sm0;->ۥ۟۟۠:Landroid/s/on0;

    return-void
.end method

.method public static ۥ۟ۡۥ(Landroid/s/pj0;)Landroid/s/sm0;
    .registers 4

    .line 1
    instance-of v0, p0, Landroid/s/sm0;

    if-eqz v0, :cond_7

    .line 2
    check-cast p0, Landroid/s/sm0;

    return-object p0

    .line 3
    :cond_7
    new-instance v0, Landroid/s/sm0;
    ...
    invoke-direct {v0, v1, v2, p0}, Landroid/s/sm0;-><init>(Lorg/jf/dexlib2/Opcode;ILorg/jf/dexlib2/iface/reference/Reference;)V
...
.method public bridge synthetic ۥ۟۠ۢ()Lorg/jf/dexlib2/iface/reference/Reference;
    ...
    .line 1
    invoke-virtual {p0}, Landroid/s/sm0;->ۥ۟ۡۤ()Landroid/s/on0;
...
.method public ۥ۟۠ۧ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/sm0;->ۥ۟۟۟:I
...
.method public ۥ۟ۡۡ()Lorg/jf/dexlib2/Format;
    ...
    .line 1
    sget-object v0, Landroid/s/sm0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public ۥ۟ۡۤ()Landroid/s/on0;
    ...
    .line 1
    iget-object v0, p0, Landroid/s/sm0;->ۥ۟۟۠:Landroid/s/on0;
