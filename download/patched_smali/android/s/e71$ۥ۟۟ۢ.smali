...
.class public Landroid/s/e71$ۥ۟۟ۢ;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/e71$ۥ۟۟ۢ;->short:[S
...
.method public constructor <init>(Landroid/s/e71;)V
    ...
    iput-object p1, p0, Landroid/s/e71$ۥ۟۟ۢ;->ۥۡ۟ۥ:Landroid/s/e71;
    ...
    :sswitch_66
    const-string v0, "79oKidYBNhgTPmsLvH008lLZ3c"
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁤⁠⁤⁤()[S
    ...
    :sswitch_61
    sget-object v4, Landroid/s/e71$ۥ۟۟ۢ;->short:[S
...
.method public run()V
    ...
    const-string v17, "ۧۡۧ"

    const-string v18, "ۢۢ۟"

    const-string v19, "ۥۧۦ"

    const-string v20, "ۥۡ۠"

    const-string v21, "ۨۤۢ"

    const-string v22, "ۡۡۤ"

    const-string v23, "۠ۧۢ"

    const-string v24, "ۧۤۧ"

    const/16 v25, 0x1

    const-string v26, "ۢ۠ۧ"
    ...
    :sswitch_34
    :try_start_34
    invoke-static {}, Landroid/s/e71$ۥ۟۟ۢ;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁤⁠⁤⁤()[S

    move-result-object v4
    :try_end_38
    .catch Ljava/lang/Exception; {:try_start_34 .. :try_end_38} :catch_20a
    ...
    invoke-static/range {p0 .. p0}, Lscut/carson_ho/diy_view/⁣⁤⁠⁠⁠⁤⁠⁤⁠⁣⁤⁤⁣⁤⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁤⁣⁠⁤⁣⁣⁤⁠⁠⁠(Ljava/lang/Object;)Landroid/s/e71;
    ...
    :try_end_9a
    .catchall {:try_start_8b .. :try_end_9a} :catchall_1f2
    ...
    move-result v12
    :try_end_ae
    .catch Ljava/lang/Exception; {:try_start_a6 .. :try_end_ae} :catch_20a
    .catchall {:try_start_a6 .. :try_end_ae} :catchall_1f2
    ...
    :try_end_100
    .catch Ljava/lang/Exception; {:try_start_f2 .. :try_end_100} :catch_20a
    .catchall {:try_start_f2 .. :try_end_100} :catchall_1f2
    ...
    :try_end_144
    .catch Ljava/lang/Exception; {:try_start_13c .. :try_end_144} :catch_20a
    .catchall {:try_start_13c .. :try_end_144} :catchall_1f2
    ...
    move-result v11
    :try_end_15e
    .catch Ljava/lang/Exception; {:try_start_156 .. :try_end_15e} :catch_20a
    .catchall {:try_start_156 .. :try_end_15e} :catchall_1f2
    ...
    :sswitch_1a6
    :try_start_1a6
    invoke-static {v5, v6, v7}, Lorg/bouncycastle/jcajce/provider/asymmetric/gost/⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁠⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_1a9
    .catch Ljava/lang/Exception; {:try_start_1a6 .. :try_end_1a9} :catch_20a
    .catchall {:try_start_1a6 .. :try_end_1a9} :catchall_1f2
    ...
    invoke-static/range {v26 .. v26}, Lorg/apache/xerces/jaxp/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁣⁠⁠⁤⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)I
    ...
    :try_start_1d7
    invoke-static {v4, v3, v0, v14}, Lorg/apache/batik/util/resources/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁠⁤⁣⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁤⁤⁠⁤⁣([SIII)Ljava/lang/String;
    ...
    new-instance v14, Landroid/s/e71$ۥ۟۟ۢ$ۥ;
    :try_end_1e1
    .catch Ljava/lang/Exception; {:try_start_1d7 .. :try_end_1e1} :catch_20a
    .catchall {:try_start_1d7 .. :try_end_1e1} :catchall_1f2

    move-object/from16 v3, p0

    :try_start_1e3
    invoke-direct {v14, v3}, Landroid/s/e71$ۥ۟۟ۢ$ۥ;-><init>(Landroid/s/e71$ۥ۟۟ۢ;)V
    :try_end_1e6
    .catch Ljava/lang/Exception; {:try_start_1e3 .. :try_end_1e6} :catch_1f0
    .catchall {:try_start_1e3 .. :try_end_1e6} :catchall_1ee
    ...
    .sparse-switch
        ...
        0xdc25 -> :sswitch_21d
        0xdc63 -> :sswitch_1be
        0x1aaae4 -> :sswitch_1a6
        0x1aabbb -> :sswitch_1a5
        0x1aae87 -> :sswitch_192
        0x1aaec4 -> :sswitch_16f
        0x1aaee3 -> :sswitch_156
        0x1ab269 -> :sswitch_13c
        0x1ab29f -> :sswitch_11e
        0x1ab2e1 -> :sswitch_11a
        0x1abaa0 -> :sswitch_192
        0x1abdc4 -> :sswitch_119
        0x1abde6 -> :sswitch_f2
        0x1abe44 -> :sswitch_e2
        0x1abe82 -> :sswitch_ce
        0x1abe84 -> :sswitch_ba
