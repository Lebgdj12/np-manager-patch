...
.class public Landroid/s/im0;
.super Landroid/s/xl0;

# interfaces
.implements Landroid/s/fj0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/im0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
...
.method public constructor <init>(Lorg/jf/dexlib2/Opcode;II)V
    ...
    iput p1, p0, Landroid/s/im0;->ۥ۟۟۟:I

    .line 3
    invoke-static {p3}, Landroid/s/np0;->ۥ۟۠ۡ(I)I

    move-result p1

    iput p1, p0, Landroid/s/im0;->ۥ۟۟۠:I

    return-void
.end method

.method public static ۥ۟ۡۤ(Landroid/s/fj0;)Landroid/s/im0;
    .registers 4

    .line 1
    instance-of v0, p0, Landroid/s/im0;

    if-eqz v0, :cond_7

    .line 2
    check-cast p0, Landroid/s/im0;

    return-object p0

    .line 3
    :cond_7
    new-instance v0, Landroid/s/im0;
    ...
    invoke-direct {v0, v1, v2, p0}, Landroid/s/im0;-><init>(Lorg/jf/dexlib2/Opcode;II)V
...
.method public ۥ۟۟ۤ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/im0;->ۥ۟۟۠:I
...
.method public ۥ۟۠ۧ()I
    ...
    .line 1
    iget v0, p0, Landroid/s/im0;->ۥ۟۟۟:I
...
.method public ۥ۟ۡۡ()Lorg/jf/dexlib2/Format;
    ...
    .line 1
    sget-object v0, Landroid/s/im0;->ۥ۟۟:Lorg/jf/dexlib2/Format;
