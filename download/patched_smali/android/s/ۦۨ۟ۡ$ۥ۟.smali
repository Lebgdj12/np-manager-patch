...
.class public Landroid/s/ۦۨ۟ۡ$ۥ۟;
.super Landroid/s/ۦۨ۟ۡ$ۥ۟۟;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/s/ۦۨ۟ۡ;
.end annotation
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Landroid/s/ۦۨ۟ۡ$ۥ۟۟;-><init>()V
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/exception/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁠⁤⁣⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁠⁤⁣⁠⁤⁤(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/s/ۦۨ۟ۡ$ۥ۟;->ۥ۟۟:Ljava/util/List;
...
.method public static ۥ۟۟۟(Landroid/s/r1;)Landroid/s/ۦۨ۟ۡ$ۥ۟;
    .registers 16
    ...
    :sswitch_2e
    invoke-static {v2}, Lsun/misc/⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    new-instance v10, Landroid/s/ۦۨ۟ۡ$ۥ;

    invoke-direct {v10, v7, v4}, Landroid/s/ۦۨ۟ۡ$ۥ;-><init>(ILandroid/s/ۦۨ۟ۡ$ۥ۟۟۟;)V

    invoke-static {v1, v10}, Lorg/eclipse/tm4e/languageconfiguration/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :sswitch_4b
    invoke-static {p0}, Lorg/w3c/dom/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁤⁤⁠⁤⁠(Ljava/lang/Object;)I

    move-result v1

    iput v1, v2, Landroid/s/ۦۨ۟ۡ$ۥ۟;->ۥ:I
    ...
    new-instance v1, Landroid/s/ۦۨ۟ۡ$ۥ۟;

    invoke-direct {v1}, Landroid/s/ۦۨ۟ۡ$ۥ۟;-><init>()V
    ...
    iput v1, v2, Landroid/s/ۦۨ۟ۡ$ۥ۟;->ۥ۟:I
    ...
    :sswitch_c0
    invoke-static {p0}, Lorg/apache/xerces/dom/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;)Landroid/s/ۦۨ۟ۡ$ۥ۟۟۟;
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    invoke-static {p0}, Lorg/bouncycastle/pqc/jcajce/provider/gmss/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁠⁣⁤⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Landroid/s/ۦۨ۟ۡ$ۥ۟;
...
.method public bridge synthetic ۥ()Landroid/s/ۦۨ۟ۡ$ۥ۟۟;
    .registers 2
...
.method public ۥ۟(Landroid/s/s1;)V
    .registers 15
    ...
    invoke-static {p1, v1}, Lorg/checkerframework/checker/optional/qual/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁠⁣⁣⁤⁤⁣⁠;->⁤⁤⁠⁤⁤⁤⁠⁤⁠⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;I)V
    ...
    invoke-static {v1, p1}, Lorg/eclipse/tm4e/languageconfiguration/internal/utils/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤;->⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p0}, Lorg/benf/cfr/reader/util/output/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁣⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁠⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)I
    ...
    :sswitch_b0
    const-string v1, "eMSwIM23qqpQZuXQ8j"
    ...
    :sswitch_e7
    invoke-static {p0}, Lsun/misc/⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁤⁤⁠⁤⁠⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_104
    invoke-static {v8}, Lorg/apache/xmlgraphics/ps/dsc/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁤⁤⁠⁤⁤;->⁣⁤⁣⁠⁣⁤⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)I
    ...
    :cond_112
    :goto_112
    invoke-static {v9}, Lorg/dom4j/swing/⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)I
    ...
    .sparse-switch
        0xdc65 -> :sswitch_146
        0x1aaae7 -> :sswitch_137
        0x1aabd9 -> :sswitch_11e
        0x1ab2a8 -> :sswitch_10a
        0x1ab341 -> :sswitch_f2
        0x1ab625 -> :sswitch_137
        0x1ab647 -> :sswitch_e7
        0x1ab6a6 -> :sswitch_cf
        0x1ababf -> :sswitch_ce
        0x1abae3 -> :sswitch_b0
...
.method public ۥ۟۟()Landroid/s/ۦۨ۟ۡ$ۥ۟;
    .registers 12
    ...
    invoke-static {v4}, Lsun1/security/provider/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁣⁤⁤⁣⁤⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;)Landroid/s/ۦۨ۟ۡ$ۥ;
    ...
    new-instance v2, Landroid/s/ۦۨ۟ۡ$ۥ۟;

    invoke-direct {v2}, Landroid/s/ۦۨ۟ۡ$ۥ۟;-><init>()V
    ...
    check-cast v4, Landroid/s/ۦۨ۟ۡ$ۥ;
