...
.class public Landroid/s/b41$ۥۣ۟۟;
...
.method public constructor <init>(Landroid/s/b41;)V
    ...
    iput-object p1, p0, Landroid/s/b41$ۥۣ۟۟;->ۥۡ۟ۥ:Landroid/s/b41;
    ...
    :sswitch_4f
    const-string v0, "irDnxBFcWjDyxFZn8A"
...
.method public run()V
    ...
    :sswitch_22
    :try_start_22
    invoke-static/range {p0 .. p0}, Lorg/eclipse/tm4e/core/internal/grammar/parser/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁠⁠⁤⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)Landroid/s/b41;
    ...
    :try_end_2c
    .catch Ljava/lang/Exception; {:try_start_22 .. :try_end_2c} :catch_82
    ...
    :sswitch_6f
    :try_start_6f
    invoke-static {v4}, Lokhttp3/internal/io/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁤⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣⁠⁠⁠(Ljava/lang/Object;)Landroid/s/f5;

    move-result-object v5
    :try_end_73
    .catch Ljava/lang/Exception; {:try_start_6f .. :try_end_73} :catch_82
    ...
    :sswitch_9a
    :try_start_9a
    new-instance v1, Landroid/s/b41$ۥۣ۟۟$ۥ;
    :try_end_9c
    .catch Ljava/lang/Exception; {:try_start_9a .. :try_end_9c} :catch_ae

    move-object/from16 v15, p0

    :try_start_9e
    invoke-direct {v1, v15, v5}, Landroid/s/b41$ۥۣ۟۟$ۥ;-><init>(Landroid/s/b41$ۥۣ۟۟;Landroid/s/f5;)V
    :try_end_a1
    .catch Ljava/lang/Exception; {:try_start_9e .. :try_end_a1} :catch_179
    ...
    invoke-static {v1}, Ldifflib/myers/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)Landroid/content/Context;

    move-result-object v1
    :try_end_bc
    .catch Ljava/lang/Exception; {:try_start_b4 .. :try_end_bc} :catch_179
    ...
    const-string v1, "gfOFqqPSyEJvWQca"
    ...
    :try_end_13b
    .catch Ljava/lang/Exception; {:try_start_138 .. :try_end_13b} :catch_179
    ...
    invoke-static {v14}, Lsun/misc/⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)I
    ...
    invoke-static {v10}, Lsun1/security/provider/certpath/⁤⁠⁤⁤⁤⁠⁤⁠⁤⁤⁠⁤⁠;->⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Landroid/s/ua1;

    move-result-object v10

    invoke-static {v10}, Lorg/eclipse/tm4e/languageconfiguration/⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁠⁣⁣;->⁤⁠⁤⁣⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Landroid/s/lc1;

    move-result-object v10

    invoke-static {v10}, Landroid/file/system/⁣⁣⁣⁣⁣⁠⁠⁣⁣⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v10

    invoke-direct {v1, v10}, Ljava/io/File;-><init>(Ljava/lang/String;)V
    :try_end_165
    .catch Ljava/lang/Exception; {:try_start_150 .. :try_end_165} :catch_179
    ...
    .sparse-switch
        0xdc20 -> :sswitch_14e
        0xdc7b -> :sswitch_136
        0x1aa79a -> :sswitch_10e
        0x1aa79f -> :sswitch_10b
        0x1aa7de -> :sswitch_ed
        0x1aa7e0 -> :sswitch_d4
        0x1aaae5 -> :sswitch_d0
        0x1aaf9e -> :sswitch_b2
