...
.method public constructor <init>(Landroid/s/hi;)V
    ...
    iput-object p1, p0, Landroid/s/wl;->ۥۡ۟ۥ:Landroid/s/hi;

    return-void
.end method

.method public constructor <init>(Ljava/math/BigInteger;Landroid/s/dj;Landroid/s/uh;)V
    .registers 8
...
.method public constructor <init>(Ljava/math/BigInteger;Landroid/s/uh;)V
    .registers 4

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0, p2}, Landroid/s/wl;-><init>(Ljava/math/BigInteger;Landroid/s/dj;Landroid/s/uh;)V
...
.method public ۥ۟۟()Landroid/s/gi;
    ...
    iget-object v0, p0, Landroid/s/wl;->ۥۡ۟ۥ:Landroid/s/hi;
...
.method public final ۥ۟۟ۢ(I)Landroid/s/gi;
    .registers 5
...
.method public ۥۣ۟۟()Landroid/s/dj;
    .registers 2

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Landroid/s/wl;->ۥ۟۟ۢ(I)Landroid/s/gi;
