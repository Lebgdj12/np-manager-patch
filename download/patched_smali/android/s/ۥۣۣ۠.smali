...
.method public constructor <init>(Landroid/s/ۥ۠۟ۥ;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/s/ۥۣۣ۠;->ۥ:Landroid/s/ۥ۠۟ۥ;
...
.method public bridge synthetic ۥ(Ljava/lang/Object;Ljava/io/File;Landroid/s/ۥ۟ۥۣ;)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroid/s/ۥۣۣ۠;->ۥ۟۟(Ljava/io/InputStream;Ljava/io/File;Landroid/s/ۥ۟ۥۣ;)Z
...
.method public ۥ۟۟(Ljava/io/InputStream;Ljava/io/File;Landroid/s/ۥ۟ۥۣ;)Z
    .registers 7
    ...
    .line 1
    iget-object p3, p0, Landroid/s/ۥۣۣ۠;->ۥ:Landroid/s/ۥ۠۟ۥ;

    const-class v0, [B

    const/high16 v1, 0x10000

    invoke-interface {p3, v1, v0}, Landroid/s/ۥ۠۟ۥ;->ۥ۟(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    :cond_39
    :goto_39
    iget-object p1, p0, Landroid/s/ۥۣۣ۠;->ۥ:Landroid/s/ۥ۠۟ۥ;

    invoke-interface {p1, p3}, Landroid/s/ۥ۠۟ۥ;->put(Ljava/lang/Object;)V
    ...
    :catch_44
    :cond_44
    iget-object p2, p0, Landroid/s/ۥۣۣ۠;->ۥ:Landroid/s/ۥ۠۟ۥ;

    invoke-interface {p2, p3}, Landroid/s/ۥ۠۟ۥ;->put(Ljava/lang/Object;)V
