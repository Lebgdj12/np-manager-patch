...
.class public Landroid/s/we1$ۥ۟۟;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/we1;->ۥ۟(Landroid/content/Context;Z)V
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Landroid/s/we1$ۥ۟۟;->ۥۡ۟ۥ:Landroid/content/Context;

    iput-boolean p2, p0, Landroid/s/we1$ۥ۟۟;->ۥۡ۟ۦ:Z

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const-string p1, "ۣۨۢ"

    invoke-static {p1}, Lorg/xml/sax/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣⁣⁣⁤⁤⁣⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁣⁣⁣⁤⁠⁠⁠(Ljava/lang/Object;)I
    ...
    :sswitch_14
    const-string p2, "ww6ncCLEsKJeHkCfDe4z81eYVwDn3"
...
.method public run()V
    ...
    :cond_16
    sget-object v1, Lorg/benf/cfr/reader/util/lambda/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁣⁠⁠⁤⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠⁠⁣⁣:[S

    new-instance v1, Landroid/s/p51;

    invoke-static {p0}, Lorg/eclipse/tm4e/core/internal/parser/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁤⁠⁤⁣⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁠⁤⁤⁠⁤⁠(Ljava/lang/Object;)Landroid/content/Context;

    move-result-object v2

    invoke-static {p0}, Lorg/benf/cfr/reader/bytecode/analysis/parse/utils/scope/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁤⁠⁤⁣⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁠⁠⁣⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;)Z

    move-result v3

    invoke-direct {v1, v2, v3}, Landroid/s/p51;-><init>(Landroid/content/Context;Z)V
