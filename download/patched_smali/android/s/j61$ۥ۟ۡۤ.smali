...
.class public Landroid/s/j61$ۥ۟ۡۤ;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/j61;->ۥۣ۟ۧ(Landroid/widget/CheckBox;)V
.end annotation
...
# instance fields
.field public final ۥۡ۟ۥ:Landroid/widget/CheckBox;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/j61$ۥ۟ۡۤ;->short:[S
...
.method public constructor <init>(Landroid/s/j61;Landroid/widget/CheckBox;)V
    .registers 6

    iput-object p1, p0, Landroid/s/j61$ۥ۟ۡۤ;->ۥۡ۟ۦ:Landroid/s/j61;

    iput-object p2, p0, Landroid/s/j61$ۥ۟ۡۤ;->ۥۡ۟ۥ:Landroid/widget/CheckBox;
    ...
    :sswitch_14
    sget-object p2, Lorg/bouncycastle/jcajce/provider/symmetric/util/⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁣⁣⁣⁣⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣:[S
    ...
    :sswitch_28
    const-string p2, "z1NNijPf6vWtBWzHN"
    ...
    :goto_56
    invoke-static {p2}, Lorg/bouncycastle/jce/interfaces/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁣⁤⁠⁠⁣(Ljava/lang/Object;)I
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁠⁤⁤⁠⁤⁣()[S
    ...
    :sswitch_97
    sget-object v3, Landroid/s/j61$ۥ۟ۡۤ;->short:[S
...
.method public run()V
    ...
    const-string v24, "ۧ۟ۢ"

    const-string v25, "ۦۣۤ"

    const-string v26, "ۥۦ۟"

    const/16 v27, 0x1

    const-string v28, "ۥۤۡ"

    const-string v29, "ۣ۠۠"

    const-string v30, "ۣۢۨ"

    const-string v31, "۟ۨ۟"
    ...
    move-result v18
    :try_end_52
    .catch Ljava/lang/Exception; {:try_start_4a .. :try_end_52} :catch_c0
    .catchall {:try_start_4a .. :try_end_52} :catchall_131
    ...
    :sswitch_86
    :try_start_86
    invoke-static {v11}, Lorg/jf/util/jcommander/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁤⁠⁤⁤(Ljava/lang/Object;)V
    :try_end_89
    .catchall {:try_start_86 .. :try_end_89} :catchall_131
    ...
    :try_end_a4
    .catch Ljava/lang/Exception; {:try_start_9f .. :try_end_a4} :catch_c0
    .catchall {:try_start_9f .. :try_end_a4} :catchall_131
    ...
    invoke-static {v10}, Lorg/bouncycastle/asn1/eac/⁠⁣⁤⁣⁤⁣⁣⁤⁠⁠⁤;->⁣⁣⁣⁣⁣⁠⁠⁣⁣⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)I
    ...
    :try_end_f4
    .catch Ljava/lang/Exception; {:try_start_f2 .. :try_end_f4} :catch_138
    .catchall {:try_start_f2 .. :try_end_f4} :catchall_131
    ...
    :try_start_115
    invoke-static {v14, v3, v15, v1}, Lorg/benf/cfr/reader/bytecode/analysis/parse/rewriters/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁣⁠⁠⁤⁠⁣([SIII)Ljava/lang/String;

    move-result-object v1
    :try_end_119
    .catch Ljava/lang/Exception; {:try_start_115 .. :try_end_119} :catch_12b
    .catchall {:try_start_115 .. :try_end_119} :catchall_126
    ...
    :try_end_120
    .catch Ljava/lang/Exception; {:try_start_119 .. :try_end_120} :catch_29d
    .catchall {:try_start_119 .. :try_end_120} :catchall_298
    ...
    invoke-static/range {p0 .. p0}, Lsun/security/util/⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁠;->⁤⁠⁤⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)Landroid/s/j61;
    ...
    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V
    :try_end_197
    .catch Ljava/lang/Exception; {:try_start_186 .. :try_end_197} :catch_29d
    .catchall {:try_start_186 .. :try_end_197} :catchall_298
    ...
    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V
    :try_end_1c5
    .catch Ljava/lang/Exception; {:try_start_1b4 .. :try_end_1c5} :catch_29d
    .catchall {:try_start_1b4 .. :try_end_1c5} :catchall_298
    ...
    :try_end_213
    .catch Ljava/lang/Exception; {:try_start_207 .. :try_end_213} :catch_29d
    .catchall {:try_start_207 .. :try_end_213} :catchall_298
    ...
    :try_end_260
    .catchall {:try_start_251 .. :try_end_260} :catchall_298
    ...
    :try_start_269
    invoke-static {v7, v8}, LK/⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁠⁠⁠⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;

    move-result-object v0
    :try_end_26d
    .catch Ljava/lang/Exception; {:try_start_269 .. :try_end_26d} :catch_29d
    .catchall {:try_start_269 .. :try_end_26d} :catchall_298
    ...
    :cond_27d
    :goto_27d
    invoke-static/range {v22 .. v22}, Lorg/apache/xerces/impl/xs/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)I
    ...
    :try_start_287
    invoke-static {}, Landroid/s/j61$ۥ۟ۡۤ;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁠⁤⁤⁠⁤⁣()[S

    move-result-object v14
    :try_end_28b
    .catch Ljava/lang/Exception; {:try_start_287 .. :try_end_28b} :catch_29d
    .catchall {:try_start_287 .. :try_end_28b} :catchall_298
    ...
    :goto_2b1
    invoke-static/range {v28 .. v28}, Lorg/apache/wml/dom/⁠⁣⁤⁣⁤⁠⁣⁠⁠⁤⁠⁠⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁠⁠⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)I
    ...
    :try_start_2bd
    invoke-static {v5, v1, v6}, Lorg/apache/batik/css/engine/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁤⁣⁤⁤⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;
    :try_end_2c0
    .catch Ljava/lang/Exception; {:try_start_2bd .. :try_end_2c0} :catch_379
    .catchall {:try_start_2bd .. :try_end_2c0} :catchall_376
    ...
    invoke-static/range {v29 .. v29}, Lorg/apache/xerces/impl/⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;)I
    ...
    invoke-static/range {p0 .. p0}, Lorg/bouncycastle/asn1/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁣⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)Landroid/widget/CheckBox;
    ...
    new-instance v0, Landroid/s/ۦۨۢۤ;

    invoke-direct {v0}, Landroid/s/ۦۨۢۤ;-><init>()V
    :try_end_341
    .catch Ljava/lang/Exception; {:try_start_326 .. :try_end_341} :catch_379
    .catchall {:try_start_326 .. :try_end_341} :catchall_376
    ...
    move-result v17
    :try_end_3a7
    .catch Ljava/lang/Exception; {:try_start_39f .. :try_end_3a7} :catch_3ba
    .catchall {:try_start_39f .. :try_end_3a7} :catchall_3b1
    ...
    .sparse-switch
        ...
        0xdca2 -> :sswitch_3d3
        0xdcdd -> :sswitch_37d
        0x1aa702 -> :sswitch_32c
        0x1aa780 -> :sswitch_320
        0x1aa79a -> :sswitch_317
        0x1aa79e -> :sswitch_304
        0x1aa7a2 -> :sswitch_2e2
        0x1aa816 -> :sswitch_2c8
        0x1aaac7 -> :sswitch_2b7
        0x1aaae3 -> :sswitch_2a3
        0x1aaf7a -> :sswitch_283
        0x1ab2a8 -> :sswitch_265
        0x1ab2c6 -> :sswitch_24d
        0x1ab2fd -> :sswitch_227
        0x1ab35d -> :sswitch_203
        0x1ab6a1 -> :sswitch_1ef
        0x1aba25 -> :sswitch_1d9
        0x1aba46 -> :sswitch_1b0
        0x1ababd -> :sswitch_1a5
        0x1abda9 -> :sswitch_182
        0x1abe03 -> :sswitch_164
        0x1abe22 -> :sswitch_140
        0x1abe5e -> :sswitch_13f
        0x1abe67 -> :sswitch_f2
        0x1abea3 -> :sswitch_dc
        0x1ac187 -> :sswitch_c8
        0x1ac1c7 -> :sswitch_9f
        0x1ac50a -> :sswitch_86
        0x1ac58a -> :sswitch_37d
        0x1ac607 -> :sswitch_6d
        0x1ac622 -> :sswitch_4a
        0x1ac8ec -> :sswitch_42
        0x1ac92e -> :sswitch_41
