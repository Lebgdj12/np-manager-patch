...
.class public Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ$ۥ;
.super Ljava/lang/Object;

# interfaces
.implements Landroid/s/ۦۣۨ$ۥ۟۟۟;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ;->onClick(Landroid/content/DialogInterface;I)V
.end annotation
...
# instance fields
.field public final ۥ:Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ;
...
.method public constructor <init>(Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ;)V
    .registers 5

    iput-object p1, p0, Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ$ۥ;->ۥ:Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ;
    ...
    :sswitch_12
    const-string v0, "WqVQ0omeuiAf4st7CDKT6dOP"
...
.method public ۥ()V
    ...
    invoke-static {p0}, Lorg/eclipse/tm4e/core/internal/matcher/⁤⁠⁤⁤⁠⁠⁠⁤⁤⁠⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣(Ljava/lang/Object;)Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ;

    move-result-object v1

    invoke-static {v1}, Lorg/jcodings/transcode/⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤⁣⁤⁤⁣⁤⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/content/Context;

    move-result-object v1

    check-cast v1, Landroid/app/Activity;

    new-instance v2, Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ$ۥ$ۥ;

    invoke-direct {v2, p0}, Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ$ۥ$ۥ;-><init>(Landroid/s/ۦۣۨ۟$ۥ۟۟ۢ$ۥ;)V
