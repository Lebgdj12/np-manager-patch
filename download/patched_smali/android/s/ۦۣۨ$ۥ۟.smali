...
.class public Landroid/s/ۦۣۨ$ۥ۟;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/ۦۣۨ;->ۥ۟۟ۤ(Landroidx/appcompat/app/AlertDialog;Landroid/s/ۦۣۨ$ۥ۟۟۟;)V
.end annotation
...
# instance fields
.field public final ۥۡ۟ۥ:Landroid/s/ۦۣۨ$ۥ۟۟۟;

.field public final ۥۡ۟ۦ:Landroidx/appcompat/app/AlertDialog;

.field public final ۥۡ۟ۧ:Landroid/s/ۦۣۨ;
...
.method public constructor <init>(Landroid/s/ۦۣۨ;Landroid/s/ۦۣۨ$ۥ۟۟۟;Landroidx/appcompat/app/AlertDialog;)V
    .registers 5

    iput-object p1, p0, Landroid/s/ۦۣۨ$ۥ۟;->ۥۡ۟ۧ:Landroid/s/ۦۣۨ;

    iput-object p2, p0, Landroid/s/ۦۣۨ$ۥ۟;->ۥۡ۟ۥ:Landroid/s/ۦۣۨ$ۥ۟۟۟;

    iput-object p3, p0, Landroid/s/ۦۣۨ$ۥ۟;->ۥۡ۟ۦ:Landroidx/appcompat/app/AlertDialog;
    ...
    invoke-static {p2}, Lorg/bouncycastle/crypto/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁣⁣⁣⁣⁣⁣⁤;->⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)I
...
.method public run()V
    ...
    :sswitch_35
    :try_start_35
    invoke-static/range {p0 .. p0}, Lorg/objectweb/asm/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁤⁣⁠⁤⁤⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Landroid/s/ۦۣۨ;
    ...
    :try_end_3f
    .catchall {:try_start_35 .. :try_end_3f} :catchall_12f
    ...
    invoke-static/range {p0 .. p0}, Lorg/apache/commons/io/filefilter/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/s/ۦۣۨ$ۥ۟۟۟;

    move-result-object v6

    invoke-static {v0, v6}, Lj$/util/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_9d
    .catch Ljava/lang/Exception; {:try_start_92 .. :try_end_9d} :catch_ab
    .catchall {:try_start_92 .. :try_end_9d} :catchall_12f
    ...
    :sswitch_110
    :try_start_110
    new-instance v0, Landroid/s/ۦۣۨ$ۥ۟$ۥ;
    :try_end_112
    .catchall {:try_start_110 .. :try_end_112} :catchall_12f

    move-object/from16 v7, p0

    :try_start_114
    invoke-direct {v0, v7}, Landroid/s/ۦۣۨ$ۥ۟$ۥ;-><init>(Landroid/s/ۦۣۨ$ۥ۟;)V
    :try_end_117
    .catchall {:try_start_114 .. :try_end_117} :catchall_1d5
    ...
    :try_end_139
    .catchall {:try_start_136 .. :try_end_139} :catchall_1d5
    ...
    :try_end_184
    .catchall {:try_start_181 .. :try_end_184} :catchall_1d5
    ...
    :try_end_1be
    .catchall {:try_start_1af .. :try_end_1be} :catchall_1d5
    ...
    :sswitch_data_1ec
    .sparse-switch
        0x1aa75f -> :sswitch_1ad
        0x1aaac5 -> :sswitch_197
        0x1aaac6 -> :sswitch_17f
        0x1aaae1 -> :sswitch_16f
        0x1aab3c -> :sswitch_165
        0x1aab41 -> :sswitch_14d
        0x1aaee0 -> :sswitch_134
        0x1aaf5b -> :sswitch_110
        0x1aaf7d -> :sswitch_197
        0x1aaf80 -> :sswitch_100
        0x1aaf9c -> :sswitch_f0
        0x1ab242 -> :sswitch_ea
        0x1ab644 -> :sswitch_d7
        0x1ab6a2 -> :sswitch_d6
        0x1aba82 -> :sswitch_16f
        0x1abdac -> :sswitch_c2
        0x1ac1a7 -> :sswitch_92
        0x1ac508 -> :sswitch_91
        0x1ac5aa -> :sswitch_79
