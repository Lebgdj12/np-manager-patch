...
.class public Landroid/s/be0$ۥ۟۟ۡ$ۥ۟;
.super Landroid/s/rg0;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/be0$ۥ۟۟ۡ;->ۥ۟۟ۦ()Ljava/util/Iterator;
.end annotation
...
.method public constructor <init>(Landroid/s/be0$ۥ۟۟ۡ;Landroid/s/ie0;II)V
    ...
    .line 1
    iput-object p1, p0, Landroid/s/be0$ۥ۟۟ۡ$ۥ۟;->ۥۡ۠:Landroid/s/be0$ۥ۟۟ۡ;
...
.method public bridge synthetic next()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Landroid/s/be0$ۥ۟۟ۡ$ۥ۟;->ۥ۟۟()Ljava/lang/Integer;
...
.method public bridge synthetic ۥ۟(Landroid/s/je0;I)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroid/s/be0$ۥ۟۟ۡ$ۥ۟;->ۥ۟۟۟(Landroid/s/je0;I)Ljava/lang/Integer;
...
.method public ۥ۟۟()Ljava/lang/Integer;
    ...
    iget-object v1, p0, Landroid/s/be0$ۥ۟۟ۡ$ۥ۟;->ۥۡ۠:Landroid/s/be0$ۥ۟۟ۡ;
    ...
    .line 2
    iget-object v0, p0, Landroid/s/be0$ۥ۟۟ۡ$ۥ۟;->ۥۡ۠:Landroid/s/be0$ۥ۟۟ۡ;

    invoke-virtual {p0}, Landroid/s/rg0;->ۥ()I

    move-result v1

    invoke-static {v0, v1}, Landroid/s/be0$ۥ۟۟ۡ;->ۥ۟۟(Landroid/s/be0$ۥ۟۟ۡ;I)I
