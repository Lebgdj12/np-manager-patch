...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/d61;->ۥ(Lplayer/normal/np/fragMent/DialogAddDialog$ۥ۟۟ۡ;)V
.end annotation
...
# instance fields
.field public final ۥۡ۟ۥ:Lplayer/normal/np/fragMent/DialogAddDialog$ۥ۟۟ۡ;

.field public final ۥۡ۟ۦ:Landroid/s/d61;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/s/d61$ۥ;->short:[S
...
.method public constructor <init>(Landroid/s/d61;Lplayer/normal/np/fragMent/DialogAddDialog$ۥ۟۟ۡ;)V
    .registers 5

    iput-object p1, p0, Landroid/s/d61$ۥ;->ۥۡ۟ۦ:Landroid/s/d61;

    iput-object p2, p0, Landroid/s/d61$ۥ;->ۥۡ۟ۥ:Lplayer/normal/np/fragMent/DialogAddDialog$ۥ۟۟ۡ;
    ...
    :sswitch_4f
    const-string p2, "JvD6VRmamaGimfD4Ze4rqaTMKIUkQ"
    ...
    invoke-static {p2}, Lorg/bouncycastle/x509/util/⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)I
...
.method public static ⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁤⁣⁠⁣⁤⁣()[S
    ...
    :sswitch_18
    sget-object v4, Landroid/s/d61$ۥ;->short:[S
...
.method public run()V
    ...
    const-string v22, "ۥۤۡ"

    const-string v23, "ۣۣۡ"

    const-string v24, "ۧۡۤ"
    ...
    :sswitch_47
    :try_start_47
    invoke-static/range {p0 .. p0}, Lsjm/xuitls/db/sqlite/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁠⁠⁤⁠⁣;->⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁤(Ljava/lang/Object;)Landroid/s/d61;

    move-result-object v0

    invoke-static {v0}, Lorg/joni/constants/internal/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁠⁣⁣⁣⁣⁣⁣⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁠⁣⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    const-string v0, "agmxc4DI13J4w80TRB192WZVrYxUw"
    ...
    invoke-virtual {v0, v12, v13}, Ljava/io/PrintStream;->println(D)V
    ...
    new-instance v3, Landroid/s/d61$ۥ$ۥ;
    :try_end_10b
    .catch Ljava/lang/Exception; {:try_start_105 .. :try_end_10b} :catch_139
    .catchall {:try_start_105 .. :try_end_10b} :catchall_132
    ...
    :try_start_10f
    invoke-direct {v3, v1}, Landroid/s/d61$ۥ$ۥ;-><init>(Landroid/s/d61$ۥ;)V
    :try_end_112
    .catch Ljava/lang/Exception; {:try_start_10f .. :try_end_112} :catch_1bd
    .catchall {:try_start_10f .. :try_end_112} :catchall_1b7
    ...
    :try_start_15f
    invoke-static/range {p0 .. p0}, Lsjm/xuitls/db/sqlite/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;)Lplayer/normal/np/fragMent/DialogAddDialog$ۥ۟۟ۡ;

    move-result-object v0

    invoke-static {v0}, Ljavax/xml/stream/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁣⁣⁠⁣⁣;->⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)V

    invoke-static/range {p0 .. p0}, Lsjm/xuitls/db/sqlite/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁠⁠⁤⁠⁣;->⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁤⁤⁠⁤⁤(Ljava/lang/Object;)Landroid/s/d61;

    move-result-object v0

    invoke-static {v0}, Lorg/apache/xerces/impl/msg/⁤⁤⁠⁤⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Landroid/s/ua1;
    ...
    move-result-object v0
    :try_end_172
    .catch Ljava/lang/Exception; {:try_start_15f .. :try_end_172} :catch_1bd
    .catchall {:try_start_15f .. :try_end_172} :catchall_1b7
    ...
    :goto_17c
    invoke-static/range {v19 .. v19}, Lorg/jaxen/dom/html/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)I
    ...
    :try_start_19a
    invoke-static {}, Landroid/s/d61$ۥ;->⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁤⁣⁠⁣⁤⁣()[S

    move-result-object v0
    :try_end_19e
    .catch Ljava/lang/Exception; {:try_start_19a .. :try_end_19e} :catch_1bd
    .catchall {:try_start_19a .. :try_end_19e} :catchall_1b7
    ...
    :goto_1a7
    invoke-static/range {v20 .. v20}, Lorg/checkerframework/checker/formatter/qual/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁠⁤⁠⁤⁠⁤⁤(Ljava/lang/Object;)I
    ...
    :try_end_1c9
    .catch Ljava/lang/Exception; {:try_start_1c7 .. :try_end_1c9} :catch_20f
    .catchall {:try_start_1c7 .. :try_end_1c9} :catchall_20a
    ...
    :try_start_1e8
    invoke-static {v10, v7, v3, v1}, Lsun1/security/action/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁣⁣⁤⁣⁠⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠([SIII)Ljava/lang/String;

    move-result-object v1

    invoke-static {v9, v1}, Lplayer/normal/np/fragMent/dex/⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁣⁣⁣⁣⁤⁤;->⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V
    :try_end_1f3
    .catch Ljava/lang/Exception; {:try_start_1e8 .. :try_end_1f3} :catch_28c
    .catchall {:try_start_1e8 .. :try_end_1f3} :catchall_288
    ...
    :goto_224
    invoke-static/range {v27 .. v27}, Lorg/xml/sax/helpers/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁣⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;)I
    ...
    move-result v15
    :try_end_250
    .catch Ljava/lang/Exception; {:try_start_248 .. :try_end_250} :catch_28c
    .catchall {:try_start_248 .. :try_end_250} :catchall_288
    ...
    :try_end_281
    .catch Ljava/lang/Exception; {:try_start_275 .. :try_end_281} :catch_28c
    .catchall {:try_start_275 .. :try_end_281} :catchall_288
    ...
    :try_start_2a9
    invoke-static {v4, v5, v1, v6}, Lsun/misc/⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁠⁣⁣⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁣⁠⁣⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2ac
    .catch Ljava/lang/Exception; {:try_start_2a9 .. :try_end_2ac} :catch_2d3
    .catchall {:try_start_2a9 .. :try_end_2ac} :catchall_2bf
    ...
    move-result v14
    :try_end_2be
    .catch Ljava/lang/Exception; {:try_start_2b6 .. :try_end_2be} :catch_2d3
    .catchall {:try_start_2b6 .. :try_end_2be} :catchall_2bf
    ...
    :cond_2cc
    const-string v16, "ۨۧۤ"

    :goto_2ce
    invoke-static/range {v16 .. v16}, Lorg/benf/cfr/reader/bytecode/analysis/structured/statement/placeholder/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)I
    ...
    .sparse-switch
        ...
        0x1aa816 -> :sswitch_243
        0x1aab00 -> :sswitch_229
        0x1aab7d -> :sswitch_214
        0x1aae85 -> :sswitch_1c3
        0x1aaee4 -> :sswitch_196
        0x1ab2a6 -> :sswitch_290
        0x1ab2c6 -> :sswitch_184
        0x1ab2e6 -> :sswitch_15b
        0x1ab645 -> :sswitch_158
        0x1aba08 -> :sswitch_140
