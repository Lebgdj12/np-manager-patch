...
.class public Landroid/s/e71$ۥ۟۠;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/s/e71;->ۥ۟ۢۨ(Ljava/io/File;)V
.end annotation
...
.field public final ۥۡ۟ۦ:Landroid/s/e71;
...
.method public constructor <init>(Landroid/s/e71;Ljava/io/File;)V
    .registers 5

    iput-object p1, p0, Landroid/s/e71$ۥ۟۠;->ۥۡ۟ۦ:Landroid/s/e71;

    iput-object p2, p0, Landroid/s/e71$ۥ۟۠;->ۥۡ۟ۥ:Ljava/io/File;
    ...
    :sswitch_14
    sget-object p2, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁤⁠⁤⁣⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁣⁣⁤⁤⁣⁠:[S
    ...
    :goto_5f
    invoke-static {p2}, Lorg/apache/xerces/dom/events/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁤⁤⁠⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)I
...
.method public run()V
    ...
    const-string v11, "۟ۦ۟"

    const-string v17, "ۨۨۥ"
    ...
    :sswitch_28
    :try_start_28
    invoke-static/range {p0 .. p0}, Lorg/apache/xerces/dom3/as/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁠⁠⁣⁣⁣⁠⁤⁣⁠⁤⁤;->⁠⁠⁠⁣⁣⁤⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Landroid/s/e71;
    ...
    :try_end_37
    .catchall {:try_start_28 .. :try_end_37} :catchall_1cd
    ...
    :sswitch_4d
    :try_start_4d
    new-instance v0, Landroid/s/e71$ۥ۟۠$ۥ;
    ...
    invoke-direct/range {v6 .. v11}, Landroid/s/e71$ۥ۟۠$ۥ;-><init>(Landroid/s/e71$ۥ۟۠;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_59
    .catch Ljava/lang/Exception; {:try_start_4d .. :try_end_59} :catch_1e5
    ...
    :sswitch_bd
    :try_start_bd
    invoke-static/range {p0 .. p0}, Lorg/checkerframework/checker/propkey/qual/⁠⁤⁣⁠⁤⁣⁠⁣⁤⁣⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁤⁠⁤⁠(Ljava/lang/Object;)Ljava/io/File;

    move-result-object v0

    invoke-static {v0}, Lplayer/normal/np/fragMent/arsc/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁤⁤⁣⁠⁣⁠⁠⁤⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v14
    :try_end_c5
    .catch Ljava/lang/Exception; {:try_start_bd .. :try_end_c5} :catch_1e5
    .catchall {:try_start_bd .. :try_end_c5} :catchall_1cd
    ...
    invoke-static {v10}, Ljavax/xml/stream/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)I
    ...
    :try_end_105
    .catch Ljava/lang/Exception; {:try_start_fd .. :try_end_105} :catch_1e5
    .catchall {:try_start_fd .. :try_end_105} :catchall_1cd
    ...
    :try_end_11a
    .catch Ljava/lang/Exception; {:try_start_117 .. :try_end_11a} :catch_1e5
    .catchall {:try_start_117 .. :try_end_11a} :catchall_1cd
    ...
    invoke-static {v0}, Lorg/apache/xmlgraphics/image/loader/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁠⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v13
    :try_end_13b
    .catch Ljava/lang/Exception; {:try_start_12f .. :try_end_13b} :catch_1e5
    .catchall {:try_start_12f .. :try_end_13b} :catchall_1cd
    ...
    :sswitch_14d
    const-string v0, "oh6bxQHgl7atYaMXkaTSoe5VcA"
    ...
    :cond_174
    :goto_174
    invoke-static/range {v19 .. v19}, Lorg/jf/dexlib2/analysis/⁤⁠⁤⁤⁤⁠⁤⁣⁠⁣⁣⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    invoke-static {v0}, Lnp/annotation/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁣⁠⁣⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁣⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0
    :try_end_18b
    .catch Ljava/lang/Exception; {:try_start_183 .. :try_end_18b} :catch_1e5
    .catchall {:try_start_183 .. :try_end_18b} :catchall_1cd
    ...
    invoke-static {v6}, Lnp/guard/flat/structure/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁣⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Landroid/os/Looper;

    move-result-object v6

    invoke-direct {v0, v6}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V
    :try_end_1b3
    .catch Ljava/lang/Exception; {:try_start_1a2 .. :try_end_1b3} :catch_1e5
    .catchall {:try_start_1a2 .. :try_end_1b3} :catchall_1cd
    ...
    .sparse-switch
        0xdbe2 -> :sswitch_1a2
        0xdc3f -> :sswitch_183
        0x1aa7a3 -> :sswitch_17b
        0x1aa7d8 -> :sswitch_17a
        0x1aab04 -> :sswitch_16c
        0x1aab20 -> :sswitch_14d
        0x1aab44 -> :sswitch_17b
        0x1aab80 -> :sswitch_14a
        0x1aaea1 -> :sswitch_12f
        0x1ab2a2 -> :sswitch_117
        0x1ab2fc -> :sswitch_fd
        0x1ab341 -> :sswitch_f0
        0x1ab6a6 -> :sswitch_dc
        0x1ab6dc -> :sswitch_bd
