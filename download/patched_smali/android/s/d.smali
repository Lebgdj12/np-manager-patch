...
.field public ۥ۟:Landroid/s/p;

.field public ۥ۟۟:Landroid/s/a0;
...
.method public constructor <init>(Landroid/s/ۥۥ۟ۨ;Landroid/s/p;Landroid/s/a0;)V
    .registers 8
    ...
    :sswitch_3b
    const-string v1, "KNHzqZh3BuLNNuLRiW6RiHY9"
    ...
    :sswitch_47
    iput-object p2, p0, Landroid/s/d;->ۥ۟:Landroid/s/p;
    ...
    iput-object p1, p0, Landroid/s/d;->ۥ:Landroid/s/ۥۥ۟ۨ;
    ...
    :sswitch_6e
    iput-object p3, p0, Landroid/s/d;->ۥ۟۟:Landroid/s/a0;
...
.method public ۥ()Z
    ...
    invoke-static {p0}, Lorg/apache/xerces/xpointer/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Landroid/s/ۥۥ۟ۨ;

    move-result-object v1

    invoke-static {v1}, Lnp/org/cf/simplify/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁠;->⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :try_end_55
    .catch Ljava/lang/Exception; {:try_start_52 .. :try_end_55} :catch_b1
    ...
    invoke-static {v1}, Lorg/jaxen/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁠⁤⁣⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁣⁤⁠⁠⁤(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :sswitch_89
    :try_start_89
    new-instance v2, Landroid/s/g;

    invoke-static {p0}, Lorg/apache/xerces/xpointer/⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Landroid/s/ۥۥ۟ۨ;

    move-result-object v1

    invoke-static {p0}, Landroid/myview/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁣⁠⁣⁤⁠⁠⁣⁤⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;)Landroid/s/p;

    move-result-object v3

    invoke-static {p0}, Lorg/xml/sax/helpers/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁣⁤⁠⁠⁠;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁤⁤⁠⁤⁤(Ljava/lang/Object;)Landroid/s/a0;

    move-result-object v4

    invoke-direct {v2, v1, v3, v4}, Landroid/s/g;-><init>(Landroid/s/ۥۥ۟ۨ;Landroid/s/p;Landroid/s/a0;)V
    :try_end_9a
    .catch Ljava/lang/Exception; {:try_start_89 .. :try_end_9a} :catch_b1
