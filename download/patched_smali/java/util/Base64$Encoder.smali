...
.field public static final RFC2045:Ljava/util/Base64$Encoder;

.field public static final RFC4648:Ljava/util/Base64$Encoder;

.field public static final RFC4648_URLSAFE:Ljava/util/Base64$Encoder;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Ljava/util/Base64$Encoder;->RFC4648:Ljava/util/Base64$Encoder;

    .line 5
    new-instance v1, Ljava/util/Base64$Encoder;

    invoke-direct {v1, v5, v3, v4, v5}, Ljava/util/Base64$Encoder;-><init>(Z[BIZ)V

    sput-object v1, Ljava/util/Base64$Encoder;->RFC4648_URLSAFE:Ljava/util/Base64$Encoder;
    ...
    invoke-direct {v1, v2, v0, v3, v5}, Ljava/util/Base64$Encoder;-><init>(Z[BIZ)V

    sput-object v1, Ljava/util/Base64$Encoder;->RFC2045:Ljava/util/Base64$Encoder;
...
.method public synthetic constructor <init>(Z[BIZLjava/util/Base64$1;)V
    .registers 6
...
.method private encode0([BII[B)I
    ...
    .line 12
    iget v6, p0, Ljava/util/Base64$Encoder;->linemax:I
    ...
    .line 13
    iget-object p2, p0, Ljava/util/Base64$Encoder;->newline:[B
    ...
    .line 18
    iget-boolean p1, p0, Ljava/util/Base64$Encoder;->doPadding:Z
...
.method public encode([B[B)I
    ...
    invoke-direct {p0, p1, v0, v1, p2}, Ljava/util/Base64$Encoder;->encode0([BII[B)I
...
.method public encode(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 15
    invoke-direct {p0, v2, v3, v4, v1}, Ljava/util/Base64$Encoder;->encode0([BII[B)I
    ...
    .line 19
    invoke-direct {p0, v3, p1, v2, v1}, Ljava/util/Base64$Encoder;->encode0([BII[B)I
