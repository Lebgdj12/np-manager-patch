...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lkotlin/text/CharDirectionality$ۥ;
    }
.end annotation
...
.field public static final Companion:Lkotlin/text/CharDirectionality$ۥ;
...
.field private static final directionalityMap$delegate:Landroid/s/ۦۥۣ۠;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/s/ۦۥۣ۠<",
            "Ljava/util/Map<",
...
.method public static constructor <clinit>()V
    ...
    invoke-static {}, Lkotlin/text/CharDirectionality;->ۥ()[Lkotlin/text/CharDirectionality;

    move-result-object v0

    sput-object v0, Lkotlin/text/CharDirectionality;->$VALUES:[Lkotlin/text/CharDirectionality;

    new-instance v0, Lkotlin/text/CharDirectionality$ۥ;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lkotlin/text/CharDirectionality$ۥ;-><init>(Landroid/s/ۦۦۣ;)V

    sput-object v0, Lkotlin/text/CharDirectionality;->Companion:Lkotlin/text/CharDirectionality$ۥ;
    ...
    invoke-static {v0}, Landroid/s/ۦۥۣۡ;->ۥ(Landroid/s/ۦۦ۟ۥ;)Landroid/s/ۦۥۣ۠;

    move-result-object v0

    sput-object v0, Lkotlin/text/CharDirectionality;->directionalityMap$delegate:Landroid/s/ۦۥۣ۠;
...
.method public static final synthetic access$getDirectionalityMap$delegate$cp()Landroid/s/ۦۥۣ۠;
    .registers 1

    .line 1
    sget-object v0, Lkotlin/text/CharDirectionality;->directionalityMap$delegate:Landroid/s/ۦۥۣ۠;
...
.method public static final synthetic ۥ()[Lkotlin/text/CharDirectionality;
    .registers 3
