...
.field public final synthetic $this_runningFold:Landroid/s/ۦۦۦۨ;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/s/ۦۦۦۨ<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Ljava/lang/Object;Landroid/s/ۦۦۦۨ;Landroid/s/ۦۦۡ;Landroid/s/ۦۥۣۨ;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;",
    ...
    iput-object p2, p0, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->$this_runningFold:Landroid/s/ۦۦۦۨ;

    iput-object p3, p0, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->$operation:Landroid/s/ۦۦۡ;
...
.method public final create(Ljava/lang/Object;Landroid/s/ۦۥۣۨ;)Landroid/s/ۦۥۣۨ;
    ...
    iget-object v2, p0, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->$this_runningFold:Landroid/s/ۦۦۦۨ;

    iget-object v3, p0, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->$operation:Landroid/s/ۦۦۡ;

    invoke-direct {v0, v1, v2, v3, p2}, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;-><init>(Ljava/lang/Object;Landroid/s/ۦۦۦۨ;Landroid/s/ۦۦۡ;Landroid/s/ۦۥۣۨ;)V
...
.method public final invoke(Landroid/s/ۦۦۧ۟;Landroid/s/ۦۥۣۨ;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->create(Ljava/lang/Object;Landroid/s/ۦۥۣۨ;)Landroid/s/ۦۥۣۨ;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->invoke(Landroid/s/ۦۦۧ۟;Landroid/s/ۦۥۣۨ;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 6
    iget-object v3, p0, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->$this_runningFold:Landroid/s/ۦۦۦۨ;

    invoke-interface {v3}, Landroid/s/ۦۦۦۨ;->iterator()Ljava/util/Iterator;
    ...
    .line 7
    iget-object v6, v3, Lkotlin/sequences/SequencesKt___SequencesKt$runningFold$1;->$operation:Landroid/s/ۦۦۡ;

    invoke-interface {v6, p1, v5}, Landroid/s/ۦۦۡ;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v4, p1, v3}, Landroid/s/ۦۦۧ۟;->ۥ(Ljava/lang/Object;Landroid/s/ۦۥۣۨ;)Ljava/lang/Object;
