...
.method public static ⁠⁣⁤⁣⁤⁠⁤⁠⁤⁣⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Landroid/webkit/WebView;
    ...
    check-cast p0, Lplayer/normal/np/activity/FlowActivity;

    invoke-static {p0}, Lplayer/normal/np/activity/FlowActivity;->access$000(Lplayer/normal/np/activity/FlowActivity;)Landroid/webkit/WebView;
...
.method public static ⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {p0, p1}, Landroid/s/va1;->ۥ۟۟ۡ(Landroid/s/ua1;Landroid/s/ua1;)Z
...
.method public static ⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-static {p0}, Landroid/s/s41;->ۥۣ۟۠(Landroid/s/s41;)Landroid/content/Context;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁠⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Landroid/s/m31;->ۥۣ۟ۡ()V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/s/j31;->ۥ۟(Landroid/content/Context;)V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)V
    ...
    check-cast p0, Landroid/s/i61$ۥ۟۟ۢ;

    invoke-interface/range {p0 .. p0}, Landroid/s/i61$ۥ۟۟ۢ;->onStart()V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    check-cast p0, Landroid/s/kc1$ۥ۟۟;

    check-cast p1, Landroid/s/lc1;

    check-cast p2, Landroid/s/lc1;

    invoke-virtual {p0, p1, p2}, Landroid/s/kc1$ۥ۟۟;->ۥ(Landroid/s/lc1;Landroid/s/lc1;)I
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/s/tb1;->ۥ۟۟ۦ(Landroid/content/Context;)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁣⁤⁠⁠⁤(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0}, Landroid/s/ic1;->ۥ()I
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)Landroid/widget/TextView;
    ...
    iget-object v1, p0, Landroid/s/g51;->ۥ۟۠:Landroid/widget/TextView;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁣⁤⁤⁣⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Ljava/lang/String;
    ...
    check-cast p0, Landroid/s/ۦۨۦۧ$ۥ;

    iget-object v1, p0, Landroid/s/ۦۨۦۧ$ۥ;->ۥ۟۟۟:Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Ljava/io/File;
    ...
    iget-object v1, p0, Lplayer/normal/np/activity/NPManActivity$ۥ۟;->ۥۡ۟ۥ:Ljava/io/File;
...
.method public static ⁤⁠⁤⁠⁣⁤⁠⁠⁠(Ljava/lang/Object;)Landroid/webkit/JsResult;
    ...
    check-cast p0, Landroid/s/ha1$ۥ۟$ۥ۟۟۟;

    iget-object v1, p0, Landroid/s/ha1$ۥ۟$ۥ۟۟۟;->ۥۡ۟ۥ:Landroid/webkit/JsResult;
...
.method public static ⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁣⁠⁠⁠(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/s/f5;->ۥ۟۠:Ljava/lang/String;
