...
.class public Lorg/apache/commons/io/monitor/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁤⁤⁠⁤⁣;
...
.method public static ⁠⁠⁠⁣⁣⁣⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;)Landroid/webkit/JsPromptResult;
    ...
    check-cast p0, Landroid/s/z91$ۥ۟$ۥ۟۟ۢ;

    iget-object v1, p0, Landroid/s/z91$ۥ۟$ۥ۟۟ۢ;->ۥۡ۟ۥ:Landroid/webkit/JsPromptResult;
...
.method public static ⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣(Ljava/lang/Object;)Landroid/widget/EditText;
    ...
    iget-object v1, p0, Lplayer/normal/np/fragMent/DialogFlowConfig;->ۥ۟۠۠:Landroid/widget/EditText;
...
.method public static ⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Landroid/s/ۦۣۨ;->ۥۣ۟۟()Landroid/view/View;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;Z)V
    ...
    invoke-virtual {p0, p1}, Lplayer/normal/np/fragMent/DialogFlowConfig;->ۥ۟ۦۨ(Z)V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {p0, p1}, Landroid/s/p7;->ۥ۟۟۟(Landroid/s/be0;Ljava/lang/String;)Z
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Landroid/s/ۦۨ۟۠;->ۥ۟۟ۥ([C)Ljava/lang/String;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)I
    ...
    iget v1, p0, Landroid/s/m31;->ۥ۟۠ۤ:I
...
.method public static ⁣⁣⁣⁣⁣⁤⁠⁣⁤⁣⁤⁠()I
    ...
    sget v0, Lplayer/normal/np/fragMent/FloatWindow;->ۥۡ۟ۧ:I
...
.method public static ⁣⁣⁣⁣⁤⁤⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)[Landroid/s/lc1;
    ...
    iget-object v1, p0, Lplayer/normal/np/activity/NPMainActivity$ۥۣ۟ۨ;->ۥۡ۟ۦ:[Landroid/s/lc1;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)Landroid/content/Context;
    ...
    check-cast p0, Landroid/s/db1$ۥ۟۟;

    iget-object v1, p0, Landroid/s/db1$ۥ۟۟;->ۥۡ۟ۥ:Landroid/content/Context;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁤⁤⁠⁤⁠()Ljava/lang/String;
    ...
    sget-object v0, Landroid/s/ۦۨۦ;->ۥ۟۟ۨ:Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁤⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)Landroid/widget/CheckBox;
    ...
    invoke-static {p0}, Lplayer/normal/np/fragMent/DialogSetting;->ۥ۟۠ۥ(Lplayer/normal/np/fragMent/DialogSetting;)Landroid/widget/CheckBox;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁤⁤⁣⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)V
    ...
    invoke-static {p0}, Landroid/s/ie1;->ۥ(Landroid/s/ie1;)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁣⁤⁠⁤⁤(Ljava/lang/Object;I)Landroid/content/Intent;
    .registers 3
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-static {p0}, Landroid/s/e41;->ۥۣ۟۠(Landroid/s/e41;)Landroid/content/Context;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁣⁠⁣⁣(Ljava/lang/Object;)Z
    ...
    check-cast p0, Landroid/s/kc1$ۥ۟۟۟;

    iget-boolean v1, p0, Landroid/s/kc1$ۥ۟۟۟;->ۥۡ۟ۥ:Z
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)Ljava/util/List;
    ...
    check-cast p0, Lcom/tencent/mm/NPProguardDictMap;

    invoke-virtual {p0}, Lcom/tencent/mm/NPProguardDictMap;->getFinalResNames()Ljava/util/List;
...
.method public static ⁤⁠⁤⁤⁠⁣⁣⁠⁠⁣⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/Object;)F
    ...
    check-cast p0, Landroid/s/ۥۣۧۦ;

    invoke-virtual {p0}, Landroid/s/ۥۣۧۦ;->ۥ۠ۤۧ()F
