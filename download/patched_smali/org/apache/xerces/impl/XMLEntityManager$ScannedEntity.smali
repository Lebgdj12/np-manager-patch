...
.field public externallySpecifiedEncoding:Z

.field private fByteBuffer:[B

.field private fCharacterBuffer:Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;
...
# direct methods
.method public constructor <init>(Lorg/apache/xerces/impl/XMLEntityManager;Ljava/lang/String;Lorg/apache/xerces/xni/XMLResourceIdentifier;Ljava/io/InputStream;Ljava/io/Reader;[BLjava/lang/String;ZZZ)V
    .registers 12
    ...
    iput-boolean p2, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->externallySpecifiedEncoding:Z

    const-string p2, "1.0"

    iput-object p2, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->xmlVersion:Ljava/lang/String;
    ...
    iput-object p7, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->encoding:Ljava/lang/String;

    iput-boolean p8, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->literal:Z

    iput-boolean p9, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->mayReadChunks:Z

    iput-boolean p10, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->isExternal:Z

    invoke-static {p1}, Lorg/apache/xerces/impl/XMLEntityManager;->access$200(Lorg/apache/xerces/impl/XMLEntityManager;)Lorg/apache/xerces/impl/XMLEntityManager$CharacterBufferPool;

    move-result-object p1

    invoke-virtual {p1, p10}, Lorg/apache/xerces/impl/XMLEntityManager$CharacterBufferPool;->getBuffer(Z)Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->fCharacterBuffer:Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;

    invoke-static {p1}, Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;->access$300(Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;)[C

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->ch:[C

    iput-object p6, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->fByteBuffer:[B

    return-void
.end method

.method public static synthetic access$000(Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;)Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;
    .registers 1

    iget-object p0, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->fCharacterBuffer:Lorg/apache/xerces/impl/XMLEntityManager$CharacterBuffer;

    return-object p0
.end method

.method public static synthetic access$100(Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;)[B
    .registers 1

    iget-object p0, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->fByteBuffer:[B
...
.method public getCharacterOffset()I
    ...
    iget v0, v1, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->baseCharOffset:I

    iget v2, v1, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->position:I

    iget v1, v1, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->startPosition:I
...
.method public getXMLVersion()Ljava/lang/String;
    ...
    iget-object v0, v1, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->xmlVersion:Ljava/lang/String;
...
.method public isEncodingExternallySpecified()Z
    ...
    iget-boolean v0, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->externallySpecifiedEncoding:Z
...
.method public setEncodingExternallySpecified(Z)V
    ...
    iput-boolean p1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->externallySpecifiedEncoding:Z
...
.method public setReader(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    iget-object v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->fByteBuffer:[B

    invoke-static {v0, v1}, Lorg/apache/xerces/impl/XMLEntityManager;->access$402(Lorg/apache/xerces/impl/XMLEntityManager;[B)[B
    ...
    iget-object p1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->this$0:Lorg/apache/xerces/impl/XMLEntityManager;

    invoke-static {p1}, Lorg/apache/xerces/impl/XMLEntityManager;->access$400(Lorg/apache/xerces/impl/XMLEntityManager;)[B

    move-result-object p1

    iput-object p1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->fByteBuffer:[B
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$Entity;->name:Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->ch:[C
    ...
    iget v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->position:I
    ...
    iget v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->count:I
    ...
    iget v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->baseCharOffset:I
    ...
    iget v1, p0, Lorg/apache/xerces/impl/XMLEntityManager$ScannedEntity;->startPosition:I
