...
.method public static ⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/List;
    ...
    check-cast p0, Landroid/s/y61;

    check-cast p1, Ljava/util/List;

    invoke-virtual {p0, p1}, Landroid/s/y61;->ۥ۟۠ۧ(Ljava/util/List;)Ljava/util/List;
...
.method public static ⁣⁣⁣⁣⁣⁠⁣⁤⁤⁣⁤⁤⁤⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Landroid/s/a41;->ۥ۟ۡ()V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroid/s/aa1;->ۥ۟۠(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-static {p0}, Landroid/s/b51;->ۥ۟۠ۢ(Landroid/s/b51;)Landroid/content/Context;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁠⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1, p2}, Landroid/s/ۦۧ۠ۥ;->ۥ(Ljava/io/File;Ljava/io/File;Ljava/io/File;)V
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁤⁤⁣⁠⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Landroid/s/i7;->ۥ۟(Ljava/lang/String;)Z
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁣⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    ...
    check-cast p0, Lplayer/normal/np/util/apk/fancy/DexEditor$1;

    invoke-virtual {p0, p1}, Lplayer/normal/np/util/apk/fancy/DexEditor$1;->get(Ljava/lang/Object;)Ljava/lang/String;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣⁤⁤⁠⁤⁠(Ljava/lang/Object;)Landroid/content/Context;
    ...
    invoke-static {p0}, Landroid/s/f51;->ۥ۟۠(Landroid/s/f51;)Landroid/content/Context;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    check-cast p0, Lplayer/normal/np/fragMent/AddAndSubView$ۥ۟۟;

    check-cast p1, Ljava/lang/Number;

    invoke-interface {p0, p1}, Lplayer/normal/np/fragMent/AddAndSubView$ۥ۟۟;->ۥ(Ljava/lang/Number;)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁠⁠⁣⁣⁣⁤⁠⁤⁣(Ljava/lang/Object;)Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/s/g;->ۥ۟ۡ۠:Ljava/util/List;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁠(Ljava/lang/Object;)Landroid/widget/EditText;
    ...
    iget-object v1, p0, Lplayer/normal/np/fragMent/DialogPdfDeletePages;->ۥ۟۟۠:Landroid/widget/EditText;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁤⁠⁣⁣⁠⁠⁣⁠⁣⁣⁠⁠⁣()[C
    ...
    sget-object v0, Landroid/s/b3;->ۥ:[C
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁤⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;)Lio/github/rosemoe/sora/widget/CodeEditor;
    ...
    check-cast p0, Landroid/s/cc1$ۥ۟۟۟;

    iget-object v1, p0, Landroid/s/cc1$ۥ۟۟۟;->ۥۡ۟ۥ:Lio/github/rosemoe/sora/widget/CodeEditor;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁣⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;I)V
    ...
    check-cast p0, Landroid/s/u5;

    invoke-virtual {p0, p1}, Landroid/s/u5;->ۥ۟۟۠(I)V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lplayer/normal/np/fragMent/dex/DexStringsFragment;->loadData()V
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁠⁤⁤⁠⁠⁠⁠⁣⁣(Ljava/lang/Object;)Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/s/ۦۨۥۥ;->ۥ۟:Ljava/util/List;
...
.method public static ⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁤⁠⁣⁣⁠⁠⁣()Ljava/lang/String;
    ...
    sget-object v0, Landroid/s/u3;->ۥ۟:Ljava/lang/String;
...
.method public static ⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁣⁣⁤⁠⁠⁤(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lnp/autoSign/preference/GenKeystorePreference$ۥ;->ۥ۟۟ۥ:Ljava/lang/String;
