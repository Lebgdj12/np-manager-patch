...
.field public transient ۥۡ۟ۥ:Ljava/math/BigInteger;

.field public transient ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;

.field public transient ۥۡ۟ۧ:Landroid/s/to;

.field public transient ۥۡ۟ۨ:Landroid/s/dj;

.field public transient ۥۡ۠:Landroid/s/ro;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۠:Landroid/s/ro;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Landroid/s/co;Landroid/s/to;)V
    .registers 4
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۠:Landroid/s/ro;
...
.method public constructor <init>(Ljava/lang/String;Landroid/s/co;Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;Landroid/s/ep;Landroid/s/to;)V
    .registers 6
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۠:Landroid/s/ro;
...
.method public constructor <init>(Ljava/lang/String;Landroid/s/co;Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;Ljava/security/spec/ECParameterSpec;Landroid/s/to;)V
    .registers 6
...
.method public constructor <init>(Ljava/lang/String;Landroid/s/fp;Landroid/s/to;)V
    .registers 4
...
.method public constructor <init>(Ljava/lang/String;Ljava/security/spec/ECPrivateKeySpec;Landroid/s/to;)V
    .registers 5
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Ljava/security/spec/ECPrivateKeySpec;->getParams()Ljava/security/spec/ECParameterSpec;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۧ:Landroid/s/to;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;)V
    ...
    iget-object p1, p2, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;

    iget-object p1, p2, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;
    ...
    iget-object p1, p2, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۠:Landroid/s/ro;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۠:Landroid/s/ro;

    iget-object p1, p2, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۨ:Landroid/s/dj;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۨ:Landroid/s/dj;

    iget-object p1, p2, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۧ:Landroid/s/to;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۧ:Landroid/s/to;

    return-void
.end method

.method public constructor <init>(Ljava/security/interfaces/ECPrivateKey;Landroid/s/to;)V
    .registers 4
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۧ:Landroid/s/to;
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-static {p1}, Landroid/s/rl;->ۥ۟۟ۡ(Ljava/lang/Object;)Landroid/s/rl;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥ۟(Landroid/s/rl;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥ()Landroid/s/ep;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥ()Landroid/s/ep;
...
.method public getBagAttribute(Landroid/s/ci;)Landroid/s/uh;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۠:Landroid/s/ro;
...
.method public getD()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;
    ...
    :goto_69
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۨ:Landroid/s/dj;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۨ:Landroid/s/dj;

    invoke-direct {v0, v2, v3, v1}, Landroid/s/vl;-><init>(Ljava/math/BigInteger;Landroid/s/dj;Landroid/s/bi;)V
    ...
    invoke-direct {v0, v2, v1}, Landroid/s/vl;-><init>(Ljava/math/BigInteger;Landroid/s/bi;)V
    ...
    invoke-virtual {v0}, Landroid/s/vl;->ۥ۟۟()Landroid/s/gi;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;
...
.method public ۥ()Landroid/s/ep;
    ...
    :cond_b
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۧ:Landroid/s/to;
...
.method public final ۥ۟(Landroid/s/rl;)V
    ...
    invoke-static {v0}, Landroid/s/hn;->ۥ۟۟ۡ(Ljava/lang/Object;)Landroid/s/hn;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;
    ...
    :goto_e9
    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۦ:Ljava/security/spec/ECParameterSpec;
    ...
    :cond_fe
    invoke-static {p1}, Landroid/s/vl;->ۥ۟۟ۡ(Ljava/lang/Object;)Landroid/s/vl;

    move-result-object p1

    invoke-virtual {p1}, Landroid/s/vl;->ۥ۟۟ۢ()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPrivateKey;->ۥۡ۟ۥ:Ljava/math/BigInteger;

    invoke-virtual {p1}, Landroid/s/vl;->ۥ۟۟ۤ()Landroid/s/dj;
