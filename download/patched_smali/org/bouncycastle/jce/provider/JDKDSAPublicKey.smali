...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JDKDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_2} :catch_4b
    ...
    sget-object v3, Landroid/s/pn;->ۥ۠ۧۧ:Landroid/s/ci;

    invoke-direct {v2, v3}, Landroid/s/om;-><init>(Landroid/s/ci;)V
    ...
    invoke-direct {v0, v2, v3}, Landroid/s/xm;-><init>(Landroid/s/om;Landroid/s/uh;)V
    ...
    sget-object v4, Landroid/s/pn;->ۥ۠ۧۧ:Landroid/s/ci;

    new-instance v5, Landroid/s/rm;
    ...
    invoke-direct {v5, v0, v6, v7}, Landroid/s/rm;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v3, v4, v5}, Landroid/s/om;-><init>(Landroid/s/ci;Landroid/s/uh;)V

    new-instance v0, Landroid/s/mj;

    iget-object v4, p0, Lorg/bouncycastle/jce/provider/JDKDSAPublicKey;->y:Ljava/math/BigInteger;

    invoke-direct {v0, v4}, Landroid/s/mj;-><init>(Ljava/math/BigInteger;)V

    invoke-direct {v2, v3, v0}, Landroid/s/xm;-><init>(Landroid/s/om;Landroid/s/uh;)V

    invoke-virtual {v2, v1}, Landroid/s/bi;->ۥ۟۟۠(Ljava/lang/String;)[B

    move-result-object v0
    :try_end_4a
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_4a} :catch_4b
