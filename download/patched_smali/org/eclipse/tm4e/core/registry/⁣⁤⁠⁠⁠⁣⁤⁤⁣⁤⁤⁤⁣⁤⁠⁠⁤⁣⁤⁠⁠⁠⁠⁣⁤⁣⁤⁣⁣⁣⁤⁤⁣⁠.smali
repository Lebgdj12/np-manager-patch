...
.method public static ⁠⁣⁣⁠⁠⁣⁤⁠⁤⁠(Ljava/lang/Object;)I
    ...
    invoke-static {p0}, Lcom/android/dx/command/dexer/Main;->main([Ljava/lang/String;)I
...
.method public static ⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁣⁣⁤⁣⁠⁣⁤⁠(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroid/s/be0;->getSuperclass()Ljava/lang/String;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Landroid/widget/LinearLayout;
    ...
    invoke-static {p0}, Landroid/s/ۦۣۨ;->ۥ۟۟۠(Landroid/s/ۦۣۨ;)Landroid/widget/LinearLayout;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)Landroid/content/Context;
    ...
    iget-object v1, p0, Landroid/s/z31;->ۥ:Landroid/content/Context;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁠⁠⁤⁣⁠⁤⁤(Ljava/lang/Object;)Landroid/s/h61;
    ...
    check-cast p0, Landroid/s/h61$ۥ۟۟ۨ;

    iget-object v1, p0, Landroid/s/h61$ۥ۟۟ۨ;->ۥ:Landroid/s/h61;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁣(Ljava/lang/Object;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Landroid/s/ۦۣۨ۠;->ۥۣ۟۟()Landroid/view/View;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Landroid/widget/EditText;
    ...
    invoke-static {p0}, Landroid/s/k41;->ۥ۟۠ۥ(Landroid/s/k41;)Landroid/widget/EditText;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁣⁤⁤⁣⁤⁤⁤⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroid/s/ۦۣۣۨ;->ۥ(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁤⁠⁣⁣(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroid/s/rb1;->ۥ۟(Ljava/lang/String;)Ljava/lang/String;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)[B
    ...
    invoke-virtual {p0, p1}, Landroid/s/tb1;->ۥ۟۟ۧ(Ljava/util/Map;)[B
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;)Lplayer/normal/np/adapter/AppAdapter;
    ...
    invoke-virtual {p0}, Lplayer/normal/np/fragMent/AppListFragment;->getAppAdapter()Lplayer/normal/np/adapter/AppAdapter;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁣⁣⁣⁣⁣⁣⁠(Ljava/lang/Object;)Ljava/io/File;
    ...
    invoke-virtual {p0}, Landroid/s/ae1;->ۥ۟۟۟()Ljava/io/File;
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁠⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Landroid/s/i0;->ۥ۟۠ۡ(Ljava/util/Map;)I
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)[B
    ...
    invoke-static {p0}, Landroid/s/w2;->ۥ۟۟ۡ(Landroid/s/xp0;)[B
...
.method public static ⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁤⁤⁤⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;ZLjava/lang/Object;)V
    .registers 6
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lplayer/normal/np/util/FileList;->ۥ(Landroid/s/lc1;Ljava/util/List;Lplayer/normal/np/adapter/FileAdapter;ZLjava/util/concurrent/ExecutorService;)V
...
.method public static ⁤⁤⁠⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroid/s/w81;->ۥ۟۠(Ljava/lang/String;)Z
