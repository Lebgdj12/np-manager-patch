...
.class public Lnp/obscuring/NPDexEditor$ۥ;
.super Landroid/s/dp0;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lnp/obscuring/NPDexEditor;->ۥۣ۟۟()Landroid/s/dp0;
.end annotation
...
# instance fields
.field public final ۥ:Lnp/obscuring/NPDexEditor;
...
.method public constructor <init>(Lnp/obscuring/NPDexEditor;)V
    .registers 6

    iput-object p1, p0, Lnp/obscuring/NPDexEditor$ۥ;->ۥ:Lnp/obscuring/NPDexEditor;
    ...
    :sswitch_32
    const-string v0, "wuWiFYMAJAC"

    invoke-static {v0}, Lplayer/normal/np/util/apk/fancy/⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁣⁤⁣⁠⁣⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁣⁣⁣⁣⁤⁣⁤⁤⁣⁤⁤⁤(Ljava/lang/String;)Ljava/lang/String;
...
.method public ۥ۟۟(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥ;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥ;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۟ۡ(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥۣ۟۟;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥۣ۟۟;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۟ۤ(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۟ۥ(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟ۡ;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟ۡ;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۟ۦ(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟۠;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟۠;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۟ۧ(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟۟;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟۟;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۠(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    new-instance v0, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟;

    invoke-direct {v0, p0, p1}, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟;-><init>(Lnp/obscuring/NPDexEditor$ۥ;Landroid/s/fp0;)V
...
.method public ۥ۟۠۠(Landroid/s/fp0;)Landroid/s/cp0;
    ...
    :cond_11
    sget-object p1, Lorg/apache/xerces/impl/dv/xs/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁣⁤⁤⁣⁠⁠⁤⁣⁠⁤⁤:[S

    new-instance p1, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟ۢ;

    invoke-direct {p1, p0}, Lnp/obscuring/NPDexEditor$ۥ$ۥ۟۟ۢ;-><init>(Lnp/obscuring/NPDexEditor$ۥ;)V
...
.method public ۥ۟۠ۡ(I)I
    ...
    :sswitch_5e
    invoke-static {p0}, Lorg/checkerframework/checker/optional/qual/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁤⁤⁠⁤⁠;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁣⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Lnp/obscuring/NPDexEditor;

    move-result-object v1

    invoke-static {v1}, Lorg/benf/cfr/reader/bytecode/analysis/structured/statement/⁣⁣⁣⁣⁣⁠⁠⁣⁣⁠⁠⁣⁠⁠⁠⁣⁣⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁤⁠⁤⁤⁣⁤⁣⁠⁣⁤⁠⁣⁤⁣⁠⁣⁤⁤(Ljava/lang/Object;)Z
...
.method public ۥ۟۠ۢ(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, LXI/CA/XI/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣⁤⁠⁤⁤;->⁠⁣⁣⁠⁠⁣⁣⁠⁠⁤⁠⁠(Ljava/lang/Object;)Ljava/util/Map;
...
.method public ۥۣ۟۠(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {v1}, Lsun/security/x509/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁠⁣⁣⁠⁠⁣⁣⁤⁠⁠⁣(Ljava/lang/Object;)Z
    ...
    :sswitch_83
    invoke-static {v4, v3}, Lorg/benf/cfr/reader/bytecode/analysis/parse/utils/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁠⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v1}, Lorg/greenrobot/eventbus/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁤⁣⁠⁤⁤⁤⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)Ljava/util/List;
    ...
    :sswitch_data_16e
    .sparse-switch
        0x1ab2c5 -> :sswitch_155
        0x1ab301 -> :sswitch_13c
        0x1ab62a -> :sswitch_10e
        0x1ab647 -> :sswitch_fa
        0x1ab664 -> :sswitch_b8
        0x1ab6a6 -> :sswitch_b7
        0x1ab71a -> :sswitch_e3
        0x1aba0a -> :sswitch_128
        0x1aba46 -> :sswitch_a6
        0x1aba49 -> :sswitch_98
        0x1abd8d -> :sswitch_98
        0x1abda7 -> :sswitch_83
