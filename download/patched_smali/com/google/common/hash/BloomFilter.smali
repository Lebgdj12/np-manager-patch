...
# instance fields
.field private final bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;
...
# direct methods
.method public constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$ۥ;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-static {v0, v1, p2}, Landroid/s/ۥۢۧۧ;->ۥ۟۟ۢ(ZLjava/lang/String;I)V
    ...
    check-cast p1, Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    iput-object p1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;
...
.method public synthetic constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$ۥ;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;Lcom/google/common/hash/BloomFilter$ۥ;)V
    .registers 6

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$ۥ;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
...
.method public static create(Lcom/google/common/hash/Funnel;JD)Lcom/google/common/hash/BloomFilter;
    ...
    invoke-static/range {v0 .. v5}, Lcom/google/common/hash/BloomFilter;->ۥ۟۟ۡ(Lcom/google/common/hash/Funnel;JDLcom/google/common/hash/BloomFilter$Strategy;)Lcom/google/common/hash/BloomFilter;
...
.method public static readFrom(Ljava/io/InputStream;Lcom/google/common/hash/Funnel;)Lcom/google/common/hash/BloomFilter;
    ...
    invoke-static {v2}, Landroid/s/ۥۣۧۥ;->ۥ۟۟(B)I
    ...
    .line 8
    new-instance v4, Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    int-to-long v5, v0

    const-wide/16 v7, 0x40

    invoke-static {v5, v6, v7, v8}, Lcom/google/common/math/LongMath;->ۥ(JJ)J

    move-result-wide v5

    invoke-direct {v4, v5, v6}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;-><init>(J)V
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ۟۟ۡ(IJ)V
    ...
    invoke-direct {v1, v4, v2, p1, v3}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$ۥ;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    :try_end_44
...
.method public static synthetic ۥ(Lcom/google/common/hash/BloomFilter;)Lcom/google/common/hash/BloomFilterStrategies$ۥ;
    .registers 1

    .line 1
    iget-object p0, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    return-object p0
.end method

.method public static synthetic ۥ۟(Lcom/google/common/hash/BloomFilter;)I
    .registers 1
...
.method public static synthetic ۥ۟۟(Lcom/google/common/hash/BloomFilter;)Lcom/google/common/hash/Funnel;
    .registers 1
...
.method public static synthetic ۥ۟۟۟(Lcom/google/common/hash/BloomFilter;)Lcom/google/common/hash/BloomFilter$Strategy;
    .registers 1
...
.method public static ۥ۟۟ۡ(Lcom/google/common/hash/Funnel;JDLcom/google/common/hash/BloomFilter$Strategy;)Lcom/google/common/hash/BloomFilter;
    .registers 12
    ...
    invoke-static {v2, v5, v3}, Landroid/s/ۥۢۧۧ;->ۥ۟۟ۧ(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v2, v1}, Landroid/s/ۥۢۧۧ;->ۥ۟۟ۧ(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    .line 6
    :cond_3d
    invoke-static {p1, p2, p3, p4}, Lcom/google/common/hash/BloomFilter;->ۥ۟۟ۢ(JD)J

    move-result-wide p3

    .line 7
    invoke-static {p1, p2, p3, p4}, Lcom/google/common/hash/BloomFilter;->ۥۣ۟۟(JJ)I
    ...
    new-instance v0, Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    invoke-direct {v0, p3, p4}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;-><init>(J)V

    invoke-direct {p2, v0, p1, p0, p5}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$ۥ;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    :try_end_4f
...
.method public static ۥ۟۟ۢ(JD)J
    .registers 7
    .annotation build Lcom/google/common/annotations/VisibleForTesting;
    .end annotation
...
.method public static ۥۣ۟۟(JJ)I
    .registers 4
    .annotation build Lcom/google/common/annotations/VisibleForTesting;
    .end annotation
...
.method public approximateElementCount()J
    ...
    .line 1
    iget-object v0, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    invoke-virtual {v0}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ۟()J

    move-result-wide v0

    .line 2
    iget-object v2, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    invoke-virtual {v2}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ()J
    ...
    .line 4
    invoke-static {v2, v3, v0}, Landroid/s/ۥۣۦۥ;->ۥ۟۟(DLjava/math/RoundingMode;)J
...
.method public copy()Lcom/google/common/hash/BloomFilter;
    ...
    iget-object v1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    invoke-virtual {v1}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ۟۟()Lcom/google/common/hash/BloomFilterStrategies$ۥ;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$ۥ;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    .line 5
    invoke-virtual {v1, v3}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->equals(Ljava/lang/Object;)Z
...
.method public expectedFpp()D
    ...
    invoke-virtual {v0}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ()J

    move-result-wide v0

    long-to-double v0, v0

    invoke-virtual {p0}, Lcom/google/common/hash/BloomFilter;->ۥ۟۟۠()J
...
.method public isCompatible(Lcom/google/common/hash/BloomFilter;)Z
    ...
    invoke-virtual {p1}, Lcom/google/common/hash/BloomFilter;->ۥ۟۟۠()J
...
.method public mightContain(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    invoke-interface {v0, p1, v1, v2, v3}, Lcom/google/common/hash/BloomFilter$Strategy;->mightContain(Ljava/lang/Object;Lcom/google/common/hash/Funnel;ILcom/google/common/hash/BloomFilterStrategies$ۥ;)Z
...
.method public put(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, p1, v1, v2, v3}, Lcom/google/common/hash/BloomFilter$Strategy;->put(Ljava/lang/Object;Lcom/google/common/hash/Funnel;ILcom/google/common/hash/BloomFilterStrategies$ۥ;)Z
...
.method public putAll(Lcom/google/common/hash/BloomFilter;)V
    ...
    invoke-static {v4, v5, v2, v3}, Landroid/s/ۥۢۧۧ;->ۥۣ۟۟(ZLjava/lang/String;II)V
    ...
    .line 7
    invoke-static/range {v7 .. v12}, Landroid/s/ۥۢۧۧ;->ۥ۟۟ۥ(ZLjava/lang/String;JJ)V
    ...
    .line 10
    invoke-static {v0, v3, v1, v2}, Landroid/s/ۥۢۧۧ;->ۥ۟۟ۨ(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, p1, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    invoke-virtual {v0, p1}, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ۟۟۠(Lcom/google/common/hash/BloomFilterStrategies$ۥ;)V
...
.method public writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-static {v1, v2}, Lcom/google/common/primitives/SignedBytes;->ۥ(J)B
    ...
    invoke-static {v1, v2}, Landroid/s/ۥۣۧۥ;->ۥ(J)B
    ...
    .line 4
    iget-object p1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$ۥ;

    iget-object p1, p1, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ:Ljava/util/concurrent/atomic/AtomicLongArray;
    ...
    iget-object v1, v1, Lcom/google/common/hash/BloomFilterStrategies$ۥ;->ۥ:Ljava/util/concurrent/atomic/AtomicLongArray;
