...
.method public static constructor <clinit>()V
    ...
    .line 5
    invoke-static {}, Lcom/google/common/reflect/Types$JavaVersion;->ۥ()[Lcom/google/common/reflect/Types$JavaVersion;
    ...
    .line 7
    new-instance v0, Lcom/google/common/reflect/Types$JavaVersion$ۥ;

    invoke-direct {v0}, Lcom/google/common/reflect/Types$JavaVersion$ۥ;-><init>()V

    invoke-virtual {v0}, Landroid/s/ۥۣۨ۟;->ۥ()Ljava/lang/reflect/Type;
    ...
    .line 12
    :cond_53
    new-instance v2, Lcom/google/common/reflect/Types$JavaVersion$ۥ۟;

    invoke-direct {v2}, Lcom/google/common/reflect/Types$JavaVersion$ۥ۟;-><init>()V

    invoke-virtual {v2}, Landroid/s/ۥۣۨ۟;->ۥ()Ljava/lang/reflect/Type;
...
.method public synthetic constructor <init>(Ljava/lang/String;ILcom/google/common/reflect/Types$ۥ;)V
    .registers 4
...
.method public static synthetic ۥ()[Lcom/google/common/reflect/Types$JavaVersion;
    .registers 3
...
.method public abstract ۥ۟۟(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
.end method

.method public ۥ۟۟ۤ(Ljava/lang/reflect/Type;)Ljava/lang/String;
    .registers 2

    .line 1
    invoke-static {p1}, Lcom/google/common/reflect/Types;->ۥۣ۟۠(Ljava/lang/reflect/Type;)Ljava/lang/String;
...
.method public final ۥ۟۟ۥ([Ljava/lang/reflect/Type;)Lcom/google/common/collect/ImmutableList;
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 3
    invoke-virtual {p0, v3}, Lcom/google/common/reflect/Types$JavaVersion;->ۥ۟۟ۨ(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
...
.method public abstract ۥ۟۟ۨ(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
.end method
