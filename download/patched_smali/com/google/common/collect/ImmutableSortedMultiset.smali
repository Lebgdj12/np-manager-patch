...
# instance fields
.field public transient ۥۡ۟ۨ:Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method public static copyOf(Ljava/util/Comparator;Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-static {p0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset;->ۥۣ۟۟(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    .line 13
    :cond_25
    new-instance v0, Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;

    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {v0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;->ۥ۟۠۟(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;
...
.method public static copyOf(Ljava/util/Comparator;Ljava/util/Iterator;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;->ۥ۟۠۠(Ljava/util/Iterator;)Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;
...
.method public static copyOfSorted(Landroid/s/ۥۣۤ۟;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 1
    invoke-interface {p0}, Landroid/s/ۥۣۤ۟;->comparator()Ljava/util/Comparator;

    move-result-object v0

    invoke-interface {p0}, Landroid/s/ۥۣۤ۟;->entrySet()Ljava/util/Set;

    move-result-object p0

    invoke-static {p0}, Lcom/google/common/collect/Lists;->ۥ۟۟ۥ(Ljava/lang/Iterable;)Ljava/util/ArrayList;

    move-result-object p0

    .line 2
    invoke-static {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset;->ۥۣ۟۟(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method public static naturalOrder()Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    invoke-direct {v0, v1}, Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;-><init>(Ljava/util/Comparator;)V
...
.method public static of()Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    .line 1
    sget-object v0, Lcom/google/common/collect/RegularImmutableSortedMultiset;->ۥۡ۠۟:Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method public static varargs of(Ljava/lang/Comparable;Ljava/lang/Comparable;Ljava/lang/Comparable;Ljava/lang/Comparable;Ljava/lang/Comparable;Ljava/lang/Comparable;[Ljava/lang/Comparable;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    .line 10
    invoke-static {v0}, Lcom/google/common/collect/Lists;->ۥ۟۟ۨ(I)Ljava/util/ArrayList;
...
.method public static orderedBy(Ljava/util/Comparator;)Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static reverseOrder()Lcom/google/common/collect/ImmutableSortedMultiset$ۥ;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
...
.method public static ۥۣ۟۟(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .registers 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 2
    invoke-static {p0}, Lcom/google/common/collect/ImmutableSortedMultiset;->ۥ۟۟ۤ(Ljava/util/Comparator;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-direct {v0, v1}, Lcom/google/common/collect/ImmutableList$ۥ;-><init>(I)V
    ...
    check-cast v5, Landroid/s/ۥۣۢۧ$ۥ;

    .line 6
    invoke-interface {v5}, Landroid/s/ۥۣۢۧ$ۥ;->getElement()Ljava/lang/Object;

    move-result-object v6

    invoke-virtual {v0, v6}, Lcom/google/common/collect/ImmutableList$ۥ;->ۥ۟۟ۤ(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$ۥ;
    ...
    invoke-interface {v5}, Landroid/s/ۥۣۢۧ$ۥ;->getCount()I
...
.method public static ۥ۟۟ۤ(Ljava/util/Comparator;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 2
    sget-object p0, Lcom/google/common/collect/RegularImmutableSortedMultiset;->ۥۡ۠۟:Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method public descendingMultiset()Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    .line 2
    iget-object v0, p0, Lcom/google/common/collect/ImmutableSortedMultiset;->ۥۡ۟ۨ:Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    :goto_20
    iput-object v0, p0, Lcom/google/common/collect/ImmutableSortedMultiset;->ۥۡ۟ۨ:Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method public abstract synthetic firstEntry()Landroid/s/ۥۣۢۧ$ۥ;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Landroid/s/ۥۣۢۧ$ۥ<",
...
.method public bridge synthetic headMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Landroid/s/ۥۣۤ۟;
    .registers 3
...
.method public abstract synthetic lastEntry()Landroid/s/ۥۣۢۧ$ۥ;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Landroid/s/ۥۣۢۧ$ۥ<",
...
.method public final pollFirstEntry()Landroid/s/ۥۣۢۧ$ۥ;
    .registers 2
...
.method public final pollLastEntry()Landroid/s/ۥۣۢۧ$ۥ;
    .registers 2
    .annotation build Lcom/google/errorprone/annotations/CanIgnoreReturnValue;
    .end annotation
...
.method public bridge synthetic tailMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Landroid/s/ۥۣۤ۟;
    .registers 3
...
.method public writeReplace()Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset$SerializedForm;-><init>(Landroid/s/ۥۣۤ۟;)V
