...
.method public static constructor <clinit>()V
    ...
    .line 9
    invoke-static {}, Lcom/google/common/cache/LocalCache$EntryFactory;->ۥ()[Lcom/google/common/cache/LocalCache$EntryFactory;
...
.method public synthetic constructor <init>(Ljava/lang/String;ILcom/google/common/cache/LocalCache$ۥ;)V
    .registers 4
...
.method public static synthetic ۥ()[Lcom/google/common/cache/LocalCache$EntryFactory;
    .registers 3
...
.method public static ۥ۟۟ۥ(Lcom/google/common/cache/LocalCache$Strength;ZZ)Lcom/google/common/cache/LocalCache$EntryFactory;
    .registers 5
...
# virtual methods
.method public ۥ۟(Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2, v0, v1}, Landroid/s/ۥۣ۟۟;->setAccessTime(J)V
    ...
    invoke-static {v0, p2}, Lcom/google/common/cache/LocalCache;->ۥ۟۟(Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)V
    ...
    invoke-static {p2, v0}, Lcom/google/common/cache/LocalCache;->ۥ۟۟(Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)V
...
.method public ۥ۟۟(Lcom/google/common/cache/LocalCache$Segment;Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)Landroid/s/ۥۣ۟۟;
    ...
    .line 1
    invoke-interface {p2}, Landroid/s/ۥۣ۟۟;->getKey()Ljava/lang/Object;

    move-result-object v0

    invoke-interface {p2}, Landroid/s/ۥۣ۟۟;->getHash()I

    move-result p2

    invoke-virtual {p0, p1, v0, p2, p3}, Lcom/google/common/cache/LocalCache$EntryFactory;->ۥ۟۟ۨ(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILandroid/s/ۥۣ۟۟;)Landroid/s/ۥۣ۟۟;
...
.method public ۥ۟۟ۤ(Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2, v0, v1}, Landroid/s/ۥۣ۟۟;->setWriteTime(J)V
    ...
    invoke-static {v0, p2}, Lcom/google/common/cache/LocalCache;->ۥ۟۟۟(Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)V
    ...
    invoke-static {p2, v0}, Lcom/google/common/cache/LocalCache;->ۥ۟۟۟(Landroid/s/ۥۣ۟۟;Landroid/s/ۥۣ۟۟;)V
...
.method public abstract ۥ۟۟ۨ(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILandroid/s/ۥۣ۟۟;)Landroid/s/ۥۣ۟۟;
