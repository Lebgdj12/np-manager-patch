...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/material/chip/ChipDrawable$ۥ;
    }
.end annotation
...
.field private hideMotionSpec:Landroid/s/ۥۡۥۦ;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field private showMotionSpec:Landroid/s/ۥۡۥۦ;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field private final textDrawableHelper:Landroid/s/ۥۢ۟ۢ;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 13
    new-instance p2, Landroid/s/ۥۢ۟ۢ;

    invoke-direct {p2, p0}, Landroid/s/ۥۢ۟ۢ;-><init>(Landroid/s/ۥۢ۟ۢ$ۥ۟;)V

    iput-object p2, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Landroid/s/ۥۢ۟ۢ;
    ...
    .line 15
    invoke-virtual {p2}, Landroid/s/ۥۢ۟ۢ;->ۥ۟۟۠()Landroid/text/TextPaint;
    ...
    .line 20
    sget-boolean p1, Landroid/s/ۥۢۡۥ;->ۥ:Z
...
.method private calculateTextCenterFromBaseline()F
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Landroid/s/ۥۢ۟ۢ;
...
.method public static createFromResource(Landroid/content/Context;I)Lcom/google/android/material/chip/ChipDrawable;
    ...
    .line 1
    invoke-static {p0, p1, v0}, Landroid/s/ۥۡۨ۠;->ۥ(Landroid/content/Context;ILjava/lang/CharSequence;)Landroid/util/AttributeSet;
...
.method private drawCloseIcon(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    .line 7
    sget-boolean v1, Landroid/s/ۥۢۡۥ;->ۥ:Z
...
.method private drawText(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    .line 4
    iget-object p2, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Landroid/s/ۥۢ۟ۢ;

    invoke-virtual {p2}, Landroid/s/ۥۢ۟ۢ;->ۥ۟۟۟()Landroid/s/ۥۢۡۢ;
    ...
    invoke-virtual {p2, v1}, Landroid/s/ۥۢ۟ۢ;->ۥ۟۟ۥ(Landroid/content/Context;)V
    ...
    invoke-virtual {p2, v0}, Landroid/s/ۥۢ۟ۢ;->ۥ۟۟ۡ(Ljava/lang/String;)F
    ...
    .line 15
    iget-object v2, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Landroid/s/ۥۢ۟ۢ;
...
.method private static isStateful(Landroid/s/ۥۢۡۢ;)Z
    .registers 1
    .param p0  # Landroid/s/ۥۢۡۢ;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 12
    iget-object p0, p0, Landroid/s/ۥۢۡۢ;->ۥ:Landroid/content/res/ColorStateList;
...
.method private loadFromAttributes(Landroid/util/AttributeSet;II)V
    ...
    .line 5
    invoke-static {p3, p2, v0}, Landroid/s/ۥۢۡۡ;->ۥ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 14
    invoke-static {p3, p2, v1}, Landroid/s/ۥۢۡۡ;->ۥ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 20
    invoke-static {p3, p2, v1}, Landroid/s/ۥۢۡۡ;->ۥ۟۟ۡ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/s/ۥۢۡۢ;
    ...
    iget v2, p3, Landroid/s/ۥۢۡۢ;->ۥ۟۠:F
    ...
    .line 22
    iput v1, p3, Landroid/s/ۥۢۡۢ;->ۥ۟۠:F

    .line 23
    invoke-virtual {p0, p3}, Lcom/google/android/material/chip/ChipDrawable;->setTextAppearance(Landroid/s/ۥۢۡۢ;)V
    ...
    invoke-static {v1, p2, v2}, Landroid/s/ۥۢۡۡ;->ۥ۟۟۟(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 35
    invoke-static {v2, p2, v1}, Landroid/s/ۥۢۡۡ;->ۥ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 44
    invoke-static {v1, p2, v2}, Landroid/s/ۥۢۡۡ;->ۥ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2, p3}, Landroid/s/ۥۢۡۡ;->ۥ۟۟۟(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 55
    invoke-static {p3, p2, p1}, Landroid/s/ۥۢۡۡ;->ۥ(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2, p3}, Landroid/s/ۥۡۥۦ;->ۥ۟۟(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/s/ۥۡۥۦ;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/ChipDrawable;->setShowMotionSpec(Landroid/s/ۥۡۥۦ;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/ChipDrawable;->setHideMotionSpec(Landroid/s/ۥۡۥۦ;)V
...
.method private onStateChange([I[I)Z
    ...
    .line 15
    :cond_34
    invoke-static {v1, v3}, Landroid/s/ۥۡۦۨ;->ۥ۟۟ۡ(II)I
    ...
    .line 30
    :cond_87
    iget-object v1, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Landroid/s/ۥۢ۟ۢ;

    .line 31
    invoke-virtual {v1}, Landroid/s/ۥۢ۟ۢ;->ۥ۟۟۟()Landroid/s/ۥۢۡۢ;
    ...
    iget-object v1, v1, Landroid/s/ۥۢۡۢ;->ۥ:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0, v3}, Landroid/s/ۥۡۨ۠;->ۥ۟۟(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private updateCompatRippleColor()V
    ...
    .line 2
    invoke-static {v0}, Landroid/s/ۥۢۡۥ;->ۥ۟۟۟(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private updateFrameworkCloseIconRipple()V
    ...
    invoke-static {v1}, Landroid/s/ۥۢۡۥ;->ۥ۟۟۟(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 5
    invoke-static/range {v2 .. v7}, Landroid/s/ۥۡۦۤ;->ۥ(Landroid/graphics/Canvas;FFFFI)I
...
.method public getHideMotionSpec()Landroid/s/ۥۡۥۦ;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/chip/ChipDrawable;->hideMotionSpec:Landroid/s/ۥۡۥۦ;
...
.method public getIntrinsicWidth()I
    ...
    invoke-virtual {v1, v2}, Landroid/s/ۥۢ۟ۢ;->ۥ۟۟ۡ(Ljava/lang/String;)F
...
.method public getShowMotionSpec()Landroid/s/ۥۡۥۦ;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/chip/ChipDrawable;->showMotionSpec:Landroid/s/ۥۡۥۦ;
...
.method public getTextAppearance()Landroid/s/ۥۢۡۢ;
    .registers 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public isStateful()Z
    ...
    invoke-static {v0}, Lcom/google/android/material/chip/ChipDrawable;->isStateful(Landroid/s/ۥۢۡۢ;)Z
...
.method public onSizeChange()V
    ...
    check-cast v0, Lcom/google/android/material/chip/ChipDrawable$ۥ;

    if-eqz v0, :cond_d

    .line 2
    invoke-interface {v0}, Lcom/google/android/material/chip/ChipDrawable$ۥ;->onChipDrawableSizeChange()V
...
.method public setDelegate(Lcom/google/android/material/chip/ChipDrawable$ۥ;)V
    .registers 3
    .param p1  # Lcom/google/android/material/chip/ChipDrawable$ۥ;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
...
.method public setHideMotionSpec(Landroid/s/ۥۡۥۦ;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/material/chip/ChipDrawable;->hideMotionSpec:Landroid/s/ۥۡۥۦ;
...
.method public setShowMotionSpec(Landroid/s/ۥۡۥۦ;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/material/chip/ChipDrawable;->showMotionSpec:Landroid/s/ۥۡۥۦ;
...
.method public setText(Ljava/lang/CharSequence;)V
    ...
    .line 3
    iget-object p1, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Landroid/s/ۥۢ۟ۢ;
...
.method public setTextAppearance(Landroid/s/ۥۢۡۢ;)V
    .registers 4
    ...
    invoke-virtual {v0, p1, v1}, Landroid/s/ۥۢ۟ۢ;->ۥۣ۟۟(Landroid/s/ۥۢۡۢ;Landroid/content/Context;)V
...
.method public setTextAppearanceResource(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/chip/ChipDrawable;->setTextAppearance(Landroid/s/ۥۢۡۢ;)V
...
.method public setTextSize(F)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/android/material/chip/ChipDrawable;->getTextAppearance()Landroid/s/ۥۢۡۢ;
    ...
    .line 2
    iput p1, v0, Landroid/s/ۥۢۡۢ;->ۥ۟۠:F
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, v0, p1}, Landroid/s/ۥۡۨ۠;->ۥ۟۟(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
