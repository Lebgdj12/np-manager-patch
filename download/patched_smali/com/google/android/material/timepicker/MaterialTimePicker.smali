...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;
    }
.end annotation
...
# instance fields
.field private activePresenter:Landroid/s/ۥۢۥ۟;
...
.field private timePickerClockPresenter:Landroid/s/ۥۢۥ;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private timePickerTextInputPresenter:Landroid/s/ۥۢۥۡ;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public static synthetic access$700(Lcom/google/android/material/timepicker/MaterialTimePicker;)Ljava/util/Set;
    .registers 1
...
.method public static synthetic access$900(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)Lcom/google/android/material/timepicker/MaterialTimePicker;
    .registers 1

    .line 1
    invoke-static {p0}, Lcom/google/android/material/timepicker/MaterialTimePicker;->newInstance(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)Lcom/google/android/material/timepicker/MaterialTimePicker;
...
.method private initializeOrRetrieveActivePresenterForMode(I)Landroid/s/ۥۢۥ۟;
    .registers 4

    if-nez p1, :cond_12

    .line 1
    iget-object p1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->timePickerClockPresenter:Landroid/s/ۥۢۥ;

    if-nez p1, :cond_f

    new-instance p1, Landroid/s/ۥۢۥ;
    ...
    invoke-direct {p1, v0, v1}, Landroid/s/ۥۢۥ;-><init>(Lcom/google/android/material/timepicker/TimePickerView;Lcom/google/android/material/timepicker/TimeModel;)V

    :cond_f
    iput-object p1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->timePickerClockPresenter:Landroid/s/ۥۢۥ;

    return-object p1

    .line 2
    :cond_12
    iget-object p1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->timePickerTextInputPresenter:Landroid/s/ۥۢۥۡ;

    if-nez p1, :cond_21

    .line 3
    new-instance p1, Landroid/s/ۥۢۥۡ;

    iget-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->textInputView:Landroid/widget/LinearLayout;

    iget-object v1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->time:Lcom/google/android/material/timepicker/TimeModel;

    invoke-direct {p1, v0, v1}, Landroid/s/ۥۢۥۡ;-><init>(Landroid/widget/LinearLayout;Lcom/google/android/material/timepicker/TimeModel;)V

    iput-object p1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->timePickerTextInputPresenter:Landroid/s/ۥۢۥۡ;
...
.method private static newInstance(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)Lcom/google/android/material/timepicker/MaterialTimePicker;
    .registers 5
    .param p0  # Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;
    ...
    .line 3
    invoke-static {p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;->ۥ(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)Lcom/google/android/material/timepicker/TimeModel;
    ...
    .line 4
    invoke-static {p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;->ۥ۟(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)I
    ...
    .line 5
    invoke-static {p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;->ۥ۟۟(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)I
    ...
    .line 6
    invoke-static {p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;->ۥ۟۟۟(Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۠;)Ljava/lang/CharSequence;
...
.method private updateInputMode(Lcom/google/android/material/button/MaterialButton;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Landroid/s/ۥۢۥ۟;

    if-eqz v0, :cond_7

    .line 2
    invoke-interface {v0}, Landroid/s/ۥۢۥ۟;->ۥ۟۟۠()V

    .line 3
    :cond_7
    iget v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->inputMode:I

    invoke-direct {p0, v0}, Lcom/google/android/material/timepicker/MaterialTimePicker;->initializeOrRetrieveActivePresenterForMode(I)Landroid/s/ۥۢۥ۟;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Landroid/s/ۥۢۥ۟;

    .line 4
    invoke-interface {v0}, Landroid/s/ۥۢۥ۟;->show()V

    .line 5
    iget-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Landroid/s/ۥۢۥ۟;

    invoke-interface {v0}, Landroid/s/ۥۢۥ۟;->invalidate()V
...
.method public getHour()I
    ...
    iget v0, v0, Lcom/google/android/material/timepicker/TimeModel;->ۥۡ۟ۨ:I
...
.method public getTimePickerClockPresenter()Landroid/s/ۥۢۥ;
    .registers 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    .line 1
    iget-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->timePickerClockPresenter:Landroid/s/ۥۢۥ;
...
.method public final onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Landroid/s/ۥۢۡ۠;->ۥ(Landroid/content/Context;I)Landroid/util/TypedValue;
    ...
    .line 6
    invoke-static {p1, v1, v3}, Landroid/s/ۥۢۡ۠;->ۥ۟۟(Landroid/content/Context;ILjava/lang/String;)I
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 4
    new-instance p3, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ;

    invoke-direct {p3, p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ;-><init>(Lcom/google/android/material/timepicker/MaterialTimePicker;)V

    invoke-virtual {p2, p3}, Lcom/google/android/material/timepicker/TimePickerView;->setOnDoubleTapListener(Lcom/google/android/material/timepicker/TimePickerView$ۥ۟۟۠;)V
    ...
    .line 14
    new-instance p3, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟;

    invoke-direct {p3, p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟;-><init>(Lcom/google/android/material/timepicker/MaterialTimePicker;)V
    ...
    .line 16
    new-instance p3, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟;

    invoke-direct {p3, p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟;-><init>(Lcom/google/android/material/timepicker/MaterialTimePicker;)V
    ...
    new-instance p3, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۟;

    invoke-direct {p3, p0}, Lcom/google/android/material/timepicker/MaterialTimePicker$ۥ۟۟۟;-><init>(Lcom/google/android/material/timepicker/MaterialTimePicker;)V
