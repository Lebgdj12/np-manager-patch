...
.method public static parseReader(Landroid/s/ۥۣۣۤ;)Lcom/google/gson/JsonElement;
    .registers 7
    ...
    .line 9
    invoke-virtual {p0, v3}, Landroid/s/ۥۣۣۤ;->ۥ۟ۢ(Z)V

    .line 10
    :try_start_c
    invoke-static {p0}, Landroid/s/ۥۤۡۢ;->ۥ(Landroid/s/ۥۣۣۤ;)Lcom/google/gson/JsonElement;
    ...
    .line 11
    invoke-virtual {p0, v2}, Landroid/s/ۥۣۣۤ;->ۥ۟ۢ(Z)V
...
.method public static parseReader(Ljava/io/Reader;)Lcom/google/gson/JsonElement;
    ...
    invoke-direct {v0, p0}, Landroid/s/ۥۣۣۤ;-><init>(Ljava/io/Reader;)V

    .line 2
    invoke-static {v0}, Lcom/google/gson/JsonParser;->parseReader(Landroid/s/ۥۣۣۤ;)Lcom/google/gson/JsonElement;
    ...
    invoke-virtual {v0}, Landroid/s/ۥۣۣۤ;->ۥ۟ۡۤ()Lcom/google/gson/stream/JsonToken;
...
# virtual methods
.method public parse(Landroid/s/ۥۣۣۤ;)Lcom/google/gson/JsonElement;
    .registers 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    .line 3
    invoke-static {p1}, Lcom/google/gson/JsonParser;->parseReader(Landroid/s/ۥۣۣۤ;)Lcom/google/gson/JsonElement;
