...
.class public Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lplayer/normal/np/activity/ArscLanguageActivity;->loadData()V
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;->short:[S
...
.method public constructor <init>(Lplayer/normal/np/activity/ArscLanguageActivity;Landroid/content/Context;)V
    .registers 7

    iput-object p1, p0, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;->ۥۡ۟ۦ:Lplayer/normal/np/activity/ArscLanguageActivity;

    iput-object p2, p0, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;->ۥۡ۟ۥ:Landroid/content/Context;
...
.method public static ⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤()[S
    ...
    :sswitch_13
    sget-object v4, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;->short:[S
...
.method public run()V
    ...
    const-string v16, "ۣۣ۠"

    const-string v17, "ۤۨۧ"
    ...
    :sswitch_42
    :try_start_42
    invoke-static {v9, v10}, Lorg/bouncycastle/util/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁣⁤⁣⁠⁣⁤⁣⁣⁤⁠⁠⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁠⁣⁤⁣⁤⁣⁤⁠⁤⁤(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_45
    .catch Ljava/lang/Exception; {:try_start_42 .. :try_end_45} :catch_26b
    .catchall {:try_start_42 .. :try_end_45} :catchall_252
    ...
    :sswitch_7b
    :try_start_7b
    invoke-static {}, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁤⁠⁤⁤()[S

    move-result-object v4
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_7b .. :try_end_7f} :catch_26b
    ...
    :cond_8a
    :goto_8a
    const-string v17, "ۥۨ۟"

    :cond_8c
    invoke-static/range {v17 .. v17}, Lorg/apache/xmlgraphics/image/writer/⁤⁤⁠⁤⁤⁤⁠⁤⁠⁣⁣⁣⁣⁤⁤;->⁠⁣⁤⁣⁤⁠⁣⁤⁠⁠⁠⁤⁤⁠⁤⁣(Ljava/lang/Object;)I
    ...
    move-result v13
    :try_end_c8
    .catch Ljava/lang/Exception; {:try_start_c0 .. :try_end_c8} :catch_26b
    .catchall {:try_start_c0 .. :try_end_c8} :catchall_252
    ...
    :sswitch_d9
    :try_start_d9
    invoke-static/range {p0 .. p0}, Ljavax/xml/validation/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁣⁠⁤⁣⁠⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁠⁠⁠⁣⁣⁤⁠⁣⁤⁣⁤⁣(Ljava/lang/Object;)Lplayer/normal/np/activity/ArscLanguageActivity;
    ...
    invoke-static {v15}, Lorg/bouncycastle/jce/provider/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠;->⁠⁤⁣⁠⁤⁣⁠⁠⁠⁣⁣⁤(Ljava/lang/Object;)Ljava/io/File;

    move-result-object v15

    invoke-direct {v14, v15}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V
    :try_end_ee
    .catch Ljava/lang/Exception; {:try_start_d9 .. :try_end_ee} :catch_26b
    .catchall {:try_start_d9 .. :try_end_ee} :catchall_252
    ...
    :try_end_f8
    .catch Ljava/lang/Exception; {:try_start_f5 .. :try_end_f8} :catch_26b
    .catchall {:try_start_f5 .. :try_end_f8} :catchall_252
    ...
    invoke-static {v0}, Ljavax/xml/stream/events/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁣⁣⁤⁣⁠⁣⁤⁣;->⁠⁠⁠⁣⁣⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)Landroid/s/ۦۨۡۥ;
    ...
    move-result-object v0
    :try_end_126
    .catch Ljava/lang/Exception; {:try_start_110 .. :try_end_126} :catch_26b
    .catchall {:try_start_110 .. :try_end_126} :catchall_252
    ...
    :sswitch_129
    :try_start_129
    invoke-static/range {p0 .. p0}, Landroid2/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁤⁤⁠⁤⁤⁤⁤⁠⁤⁤⁠⁤⁣⁠⁤⁣(Ljava/lang/Object;)Landroid/content/Context;
    ...
    :try_end_134
    .catchall {:try_start_129 .. :try_end_134} :catchall_252

    invoke-static {}, Lokhttp3/internal/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁤⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠⁠⁣⁣()I

    invoke-static/range {v20 .. v20}, Lorg/jaxen/jdom/⁣⁣⁣⁣⁣⁠⁠⁣⁤⁣⁤⁣⁣⁤⁠⁠⁤;->⁣⁣⁣⁣⁣⁠⁠⁠⁣⁣⁤⁣⁠⁣⁤⁣(Ljava/lang/Object;)I
    ...
    :sswitch_13d
    :try_start_13d
    new-instance v0, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟$ۥ;
    :try_end_13f
    .catch Ljava/lang/Exception; {:try_start_13d .. :try_end_13f} :catch_150
    .catchall {:try_start_13d .. :try_end_13f} :catchall_14b

    move-object/from16 v15, p0

    :try_start_141
    invoke-direct {v0, v15}, Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟$ۥ;-><init>(Lplayer/normal/np/activity/ArscLanguageActivity$ۥۣ۟۟;)V
    :try_end_144
    .catch Ljava/lang/Exception; {:try_start_141 .. :try_end_144} :catch_26b
    .catchall {:try_start_141 .. :try_end_144} :catchall_252
    ...
    move-result v12
    :try_end_15f
    .catch Ljava/lang/Exception; {:try_start_157 .. :try_end_15f} :catch_26b
    .catchall {:try_start_157 .. :try_end_15f} :catchall_252
    ...
    :try_start_1b3
    invoke-static {v4, v3, v0, v14}, Lsun1/security/provider/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁤⁠⁤⁤⁣⁠⁠⁤⁠⁠⁤⁤⁠⁤⁤;->⁣⁣⁣⁣⁣⁠⁣⁠⁠⁤⁠⁠⁠⁠⁠⁣⁣⁣([SIII)Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lorg/apache/xerces/impl/msg/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁠⁣⁤⁣⁤⁠⁠⁣⁤⁣⁤⁠⁠⁠⁠⁣⁣⁤;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁣⁤⁣⁠⁣⁤⁣⁠⁣⁣⁠⁠⁣(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_1be
    .catch Ljava/lang/Exception; {:try_start_1b3 .. :try_end_1be} :catch_26b
    .catchall {:try_start_1b3 .. :try_end_1be} :catchall_252
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁠⁣⁤⁣⁤⁠⁣⁣⁤⁤⁣⁠⁠⁣⁤⁣⁤⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁠⁠⁠⁣⁣⁠(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v14}, Lorg/eclipse/tm4e/core/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁠⁠⁤⁠⁠⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁠⁣⁣⁣⁣⁤⁤⁣⁣⁣⁣⁣⁤(Ljava/lang/Object;)Landroid/s/ۦۧ۠ۦ;

    move-result-object v14

    invoke-static {v14}, Ldifflib/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁤⁠⁠⁠⁣⁤⁣⁠⁣⁤⁤⁣⁤⁠⁠⁣;->⁣⁣⁣⁣⁣⁠⁤⁠⁤⁤⁣⁣⁣⁣⁤⁤⁣⁤⁠⁠⁠⁣⁠⁠⁤⁠⁠⁣⁤⁠⁠⁤(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v14

    invoke-static {v0, v14}, Lorg/objectweb/asm/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁣⁣⁣⁣⁣⁠⁠⁤⁣⁠⁤⁤⁠⁠⁠;->⁤⁤⁠⁤⁤⁠⁠⁠⁣⁣⁠⁠⁠⁠⁣⁣⁣(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v14}, Lnp/guard/flat/structure/⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁤⁣⁣⁣⁣⁣⁠⁤⁤⁠⁤⁤⁤⁠⁤⁣;->⁣⁤⁠⁠⁠⁣⁤⁤⁣⁤⁤⁤⁣⁤⁠⁠⁣⁤⁠⁤⁣⁣⁣⁣⁣⁤⁤(Ljava/lang/Object;)Landroid/os/Looper;

    move-result-object v14

    invoke-direct {v0, v14}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V
    :try_end_214
    .catch Ljava/lang/Exception; {:try_start_1f0 .. :try_end_214} :catch_26b
    .catchall {:try_start_1f0 .. :try_end_214} :catchall_252
    ...
    :try_end_23b
    .catch Ljava/lang/Exception; {:try_start_230 .. :try_end_23b} :catch_26b
    .catchall {:try_start_230 .. :try_end_23b} :catchall_252
    ...
    .sparse-switch
        ...
        0xdc7e -> :sswitch_275
        0xdcbd -> :sswitch_230
        0x1aa7a3 -> :sswitch_221
        0x1aa7da -> :sswitch_1ee
        0x1aaf22 -> :sswitch_1dd
        0x1ab266 -> :sswitch_1ce
        0x1ab2a7 -> :sswitch_198
        0x1ab2de -> :sswitch_195
        0x1ab35d -> :sswitch_176
        0x1ab362 -> :sswitch_173
        0x1ab680 -> :sswitch_155
        0x1ab6c5 -> :sswitch_13d
        0x1aba08 -> :sswitch_129
        0x1abae3 -> :sswitch_110
        0x1abdc7 -> :sswitch_104
        0x1abde9 -> :sswitch_f5
        0x1abe85 -> :sswitch_d9
        0x1abe9c -> :sswitch_c0
        0x1ac186 -> :sswitch_ae
        0x1ac1a4 -> :sswitch_91
        0x1ac1a6 -> :sswitch_7b
        0x1ac549 -> :sswitch_28b
        0x1ac605 -> :sswitch_6e
        0x1ac624 -> :sswitch_51
        0x1ac96c -> :sswitch_42
        0x1ac986 -> :sswitch_2c
        0x1ac9a4 -> :sswitch_104
    .end sparse-switch
.end method
